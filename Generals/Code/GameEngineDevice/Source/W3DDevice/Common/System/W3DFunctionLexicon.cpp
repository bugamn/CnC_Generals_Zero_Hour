...
// /////////////////////////////////////////////////////////////////// Created:
// Colin Day, September 2001 Desc:       Function lexicon for w3d specific
// function pointers
///////////////////////////////////////////////////////////////////////////////////////////////////
...
static FunctionLexicon::TableEntry gameWinDrawTable[] = {
    ...
    {NAMEKEY_INVALID, "W3DGadgetPushButtonImageDraw",
    ...
    {NAMEKEY_INVALID, "W3DGadgetRadioButtonImageDraw",
    ...
    {NAMEKEY_INVALID, "W3DGadgetHorizontalSliderDraw",
     W3DGadgetHorizontalSliderDraw},
    {NAMEKEY_INVALID, "W3DGadgetHorizontalSliderImageDraw",
     W3DGadgetHorizontalSliderImageDraw},
    {NAMEKEY_INVALID, "W3DGadgetVerticalSliderDraw",
    ...
    {NAMEKEY_INVALID, "W3DMainMenuButtonDropShadowDraw",
    ...
    {NAMEKEY_INVALID, "W3DCommandBarBackgroundDraw",
    ...
    {NAMEKEY_INVALID, "W3DCommandBarForegroundDraw",
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
W3DFunctionLexicon::W3DFunctionLexicon(void) {}  // end W3DFunctionLexicon
