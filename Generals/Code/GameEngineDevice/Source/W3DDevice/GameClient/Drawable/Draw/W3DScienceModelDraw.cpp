...
// Desc: Draw module just like Model, except it only draws if the local player
// has the specified science
///////////////////////////////////////////////////////////////////////////////////////////////////
...
void W3DScienceModelDrawModuleData::buildFieldParse(MultiIniFieldParse& p) {
  ...
  static const FieldParse dataFieldParse[] = {
      {"RequiredScience", INI::parseScience, NULL,
       offsetof(W3DScienceModelDrawModuleData, m_requiredScience)},
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
W3DScienceModelDraw::W3DScienceModelDraw(Thing* thing,
...
void W3DScienceModelDraw::doDrawModule(const Matrix3D* transformMtx) {
  ...
  if (science == SCIENCE_INVALID) {
    DEBUG_ASSERTCRASH(science != SCIENCE_INVALID,
                      ("ScienceModelDraw has invalid science as condition."));
    setHidden(TRUE);
    return;
  }
