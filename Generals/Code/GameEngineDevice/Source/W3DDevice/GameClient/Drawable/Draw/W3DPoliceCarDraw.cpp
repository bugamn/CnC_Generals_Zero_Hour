...
// ///////////////////////////////////////////////////////////////////// Author:
// Colin Day, May 2001 Desc:   W3DPoliceCarDraw
///////////////////////////////////////////////////////////////////////////////////////////////////
...
W3DDynamicLight *W3DPoliceCarDraw::createDynamicLight(void) {
  ...
  if (light) {
    ...
    // even and uneven ground.  Diffuse lighting shows up ground unevenness,
    // which looks funny on a searchlight.  So  no diffuse.  jba.
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
W3DPoliceCarDraw::W3DPoliceCarDraw(Thing *thing, const ModuleData *moduleData)
...
void W3DPoliceCarDraw::doDrawModule(const Matrix3D *transformMtx) {
  ...
  if (policeCarRenderObj == NULL) return;
  ...
  if (m_light == NULL) m_light = createDynamicLight();
