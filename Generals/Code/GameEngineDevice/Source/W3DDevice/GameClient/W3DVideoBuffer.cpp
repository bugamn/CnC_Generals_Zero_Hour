...
W3DVideoBuffer::W3DVideoBuffer(VideoBuffer::Type format)
    : VideoBuffer(format), m_texture(NULL), m_surface(NULL) {}
...
Bool W3DVideoBuffer::allocate(UnsignedInt width, UnsignedInt height) {
  ...
  m_texture = MSGNEW("TextureClass") TextureClass(
      m_textureWidth, m_textureHeight, w3dFormat, TextureClass::MIP_LEVELS_1);
...
W3DVideoBuffer::~W3DVideoBuffer() { free(); }
...
Bool W3DVideoBuffer::valid(void) { return m_texture != NULL; }
