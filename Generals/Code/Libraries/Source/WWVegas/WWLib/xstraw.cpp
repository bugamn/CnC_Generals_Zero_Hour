 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * BufferStraw::Get -- Fetch data from the straw's buffer holding
 *tank.                      * FileStraw::Get -- Fetch data from the file. *
 ...
 *                                                                                             *
 *    This routine will copy the requested number of bytes from the buffer
 *holding tank (as    * set up by the straw's constructor) to the buffer
 *specified.                              *
 *                                                                                             *
 ...
 *                                                                                             *
 * OUTPUT:  Returns with the number of bytes copied to the buffer. If this is
 *less than        * requested, then it indicates that the data holding tank
 *buffer is exhausted.       *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
