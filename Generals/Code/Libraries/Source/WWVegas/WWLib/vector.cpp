 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * BooleanVectorClass::BooleanVectorClass -- Copy constructor for
 *boolean array.             * BooleanVectorClass::BooleanVectorClass --
 *Explicit data buffer constructor.               * BooleanVectorClass::Clear --
 *Resets boolean vector to empty state.                        *
 ...
 ** VectorClass<T>::Clear -- Frees and clears the vector. * VectorClass<T>::ID
 ...
 *                                                                                             *
 *    This is the constructor for a boolean array. This constructor takes the
 *memory pointer   * provided as assigns that as the array data pointer. *
 *                                                                                             *
 ...
 * OUTPUT:  none *
 *                                                                                             *
 * WARNINGS:   You must make sure that the memory specified is large enough to
 *contain the     * bits specified. *
 *                                                                                             *
 ...
 **
 *                                                                                             *
 *    This is the copy constructor for a boolean array. It is used to make a
 *duplicate of the  * boolean array. *
 *                                                                                             *
 ...
 * BooleanVectorClass::operator = -- Assignment operator. *
 *                                                                                             *
 *    This routine will make a copy of the specified boolean vector array. The
 *vector is       * copied into an already constructed existing vector. The
 *values from the existing vector  * are destroyed by this copy. *
 *                                                                                             *
 ...
 * BooleanVectorClass::operator == -- Comparison operator for boolean vector. *
 *                                                                                             *
 *    This is the comparison operator for a boolean vector class. Boolean
 *vectors are equal    * if the bit count and bit values are identical. *
 *                                                                                             *
 ...
 * BooleanVectorClass::Resize -- Resizes a boolean vector object. *
 *                                                                                             *
 *    This routine will resize the boolean vector object. An index value used
 *with a boolean   * vector must be less than the value specified in as the new
 *size.                         *
 *                                                                                             *
 ...
 *                                                                                             *
 * WARNINGS:   The boolean array might be reallocated or even deleted by this
 *routine.         *
 *                                                                                             *
 * HISTORY: * 07/18/1995 JLB : Created. *
 *=============================================================================================*/
 ...
 *                                                                                             *
 *    This routine will clear out the boolean array. This will free any
 *allocated memory and   * result in the boolean vector being unusable until the
 *Resize function is subsequently    * called. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 * OUTPUT:  none *
 *                                                                                             *
 * WARNINGS:   The boolean vector cannot be used until it is resized to a non
 *null condition.  *
 *                                                                                             *
 * HISTORY: * 07/18/1995 JLB : Created. *
 *=============================================================================================*/
 ...
 * BooleanVectorClass::Reset -- Clear all boolean values in array. *
 *                                                                                             *
 *    This is the preferred (and quick) method to clear the boolean array to a
 *false condition.*
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
 ...
 * BooleanVectorClass::Fixup -- Updates the boolean vector to a known state. *
 *                                                                                             *
 *    Use this routine to set the boolean value copy to match the appropriate
 *bit in the       * boolean array. The boolean array will be updated with any
 *changes from the last time     * a value was fetched from the boolean vector.
 *By using this update method, the boolean    * array can be treated as a normal
 *array even though the elements are composed of          * otherwise
 *inaccessible bits. *
 *                                                                                             *
 * INPUT:   index -- The index to set the new copy value to. If the index is -1,
 *then the      * previous value will be updated into the vector array, but no
 *new value    * will be fetched from it. *
 *                                                                                             *
 * OUTPUT:  none *
 *                                                                                             *
 * WARNINGS:   Always call this routine with "-1" if any direct manipulation of
 *the bit        * array is to occur. This ensures that the bit array is
 *accurate.                 *
 *                                                                                             *
 * HISTORY: * 07/18/1995 JLB : Created. *
 *=============================================================================================*/
  ...
  if (index != LastIndex) {
    ...
    */
    if (index != -1) {
      ...
      ((unsigned char &)Copy) =
          (unsigned char)Get_Bit((void *)&BitArray[0], index);
      //			((unsigned char&)Copy) =
      //Get_Bit((void*)&BitArray[0], index);
    }
