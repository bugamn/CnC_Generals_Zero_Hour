 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * strtrim -- Trim leading and trailing white space off of string.
 ** Read_Line -- Read a text line from the file. * Read_Line -- Reads a text
 *line from the straw object specified.                           *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *                                                                                             *
 *          eof   -- Reference to the EOF flag that will be set to true if the
 *source          * file has been exhausted. *
 *                                                                                             *
 ...
 *                                                                                             *
 * INPUT:   file  -- Reference to the straw object to fetch the line of text
 *from.             *
 *                                                                                             *
 ...
 *                                                                                             *
 *          eof   -- Reference to the EOF flag that will be set to true if the
 *source          * straw data has been exhausted. *
 *                                                                                             *
 * OUTPUT:  Returns with the number of characters stored into the buffer. *
 *                                                                                             *
 * WARNINGS:   none *
