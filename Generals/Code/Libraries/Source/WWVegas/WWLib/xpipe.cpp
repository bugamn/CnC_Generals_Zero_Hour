 ...
 *                                                                                             *
 *    The buffered pipe is a pipe terminator. That is, the data never flows onto
 *subsequent    * pipe chains. The data is stored into the buffer previously
 *submitted to the pipe.        * If the buffer is full, no more data is output
 *to the buffer.                             *
 *                                                                                             *
