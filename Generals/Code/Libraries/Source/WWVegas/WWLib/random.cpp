 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * RandomClass::RandomClass -- Constructor for the random number
 *class.                      * RandomClass::operator() -- Fetches the next
 *random number in the sequence.                * RandomClass::operator() --
...
R2 - Ok, but will repeat with short period. Huge spike at 300000 samples in 64
dimensions R3 - Strong bias from 2 dimensions up R4 - Ok Rand() - starts
breaking in 24 dimensions
*/

/***********************************************************************************************
 * RandomClass::RandomClass -- Constructor for the random number class. *
 *                                                                                             *
 *    This constructor can take an integer as a parameter. This allows the class
 *to be         * constructed by assigning an integer to an existing object. The
 *compiler creates a        * temporary with the constructor and then performs a
 ...
 *                                                                                             *
 * WARNINGS:   This routine modifies the seed value so that subsequent calls
 *will not return   * the same value. Take note that this routine only returns
 *15 bits of             * random number. *
 *                                                                                             *
 * HISTORY: * 02/27/1996 JLB : Created. *
 *=============================================================================================*/
 ...
 *                                                                                             *
 *    This function will return with a random number within the range specified.
 *This replaces * the functionality of IRandom() in the old library. *
 *                                                                                             *
 * INPUT:   minval   -- The minimum value to return from the function. *
 *                                                                                             *
 *          maxval   -- The maximum value to return from the function. *
 *                                                                                             *
 * OUTPUT:  Returns with a random number that falls between the minval and
 *maxval (inclusive). *
 *                                                                                             *
 * WARNINGS:   The range specified must fall within the maximum bit significance
 *of the        * random number algorithm (15 bits), otherwise the value
 *returned will be         * decidedly non-random. *
 *                                                                                             *
 * HISTORY: * 02/27/1996 JLB : Created. *
 *=============================================================================================*/
 ...
 * Random2Class::Random2Class -- Constructor for the random class. *
 *                                                                                             *
 *    This will initialize the random class object with the seed value
 *specified.              *
 *                                                                                             *
 * INPUT:   seed  -- The seed value used to scramble the random number
 *generator.              *
 *                                                                                             *
 * OUTPUT:  none *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 05/14/1997 JLB : Created. *
 *=============================================================================================*/
 ...
 * Random2Class::operator -- Randomizer function that returns value. *
 *                                                                                             *
 *    This is the random number generator function. It will generate a random
 ...
 * WARNINGS:   none *
 *                                                                                             *
 * HISTORY: * 05/20/1997 JLB : Created. *
 *=============================================================================================*/
 ...
 * Random2Class::operator -- Generates a random number between two values. *
 *                                                                                             *
 *    This routine will generate a random number between the two values
 *specified. It uses     * a method that will not bias the values in any way. *
 *                                                                                             *
 * INPUT:   minval   -- The minium return value (inclusive). *
 *                                                                                             *
 *          maxval   -- The maximum return value (inclusive). *
 *                                                                                             *
 * OUTPUT:  Returns with a random number that falls between the two values
 *(inclusive).        *
 *                                                                                             *
 * WARNINGS:   none *
 *                                                                                             *
...
int Random3Class::Mix1[20] = {
    0x0baa96887, 0x01e17d32c, 0x003bcdc3c, 0x00f33d1b2, 0x076a6491d,
    0x0c570d85d, 0x0e382b1e3, 0x078db4362, 0x07439a9d4, 0x09cea8ac5,
    0x089537c5c, 0x02588f55d, 0x0415b5e1d, 0x0216e3d95, 0x085c662e7,
    0x05e8ab368, 0x03ea5cc8c, 0x0d26a0f74, 0x0f3a9222b, 0x048aad7e4};

int Random3Class::Mix2[20] = {
    0x04b0f3b58, 0x0e874f0c3, 0x06955c5a6, 0x055a7ca46, 0x04d9a9d86,
    0x0fe28a195, 0x0b1ca7865, 0x06b235751, 0x09a997a61, 0x0aa6e95c8,
    0x0aaa98ee1, 0x05af9154c, 0x0fc8e2263, 0x0390f5e8c, 0x058ffd802,
    0x0ac0a5eba, 0x0ac4874f6, 0x0a9df0913, 0x086be4c74, 0x0ed2c123b};

/***********************************************************************************************
 * Random3Class::Random3Class -- Initializer for the random number generator. *
 *                                                                                             *
 *    This initializes the random number generator with the seed values
 *specified. Due to a    * peculiarity of the random number design, the second
 *seed value can be used to find the   * Nth random number generated by this
 *algorithm. The second seed is used as the Nth index  * value. *
 *                                                                                             *
 * INPUT:   seed1 -- The seed value to inialize the generator with. It is
 *suggest that some    * random value based on user input seed this value. *
 *                                                                                             *
 *          seed2 -- The auxiliary seed value. This adds randomness and thus
 *allows this       * algorithm to use a 64 bit seed. This second seed also
 *serves as an index  * into the algorithm such that the value passed as 'seed2'
 *is will prime    * the generator to return that Nth random number when it is
 *called.         *
 *                                                                                             *
 * OUTPUT:  none *
 *                                                                                             *
 * WARNINGS:   As with all random number generators. Randomness is only as
 *strong as the       * initial seed value. *
 *                                                                                             *
 * HISTORY: * 05/20/1997 JLB : Created. *
 *=============================================================================================*/
 ...
 * Random3Class::operator -- Random number generator function. *
 *                                                                                             *
 *    This routine generates a random number. The number returned is strongly
 *random and is    * nearly good enough for cryptography. *
 *                                                                                             *
 * INPUT:   none *
 *                                                                                             *
