 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * RLEEngine::Compress -- Compresses a sequence of bytes. *
 *   RLEEngine::Decompress -- Decompress a sequence of RLE compressed bytes. *
 *   RLEEngine::Line_Compress -- Compress a line of data. *
 *   RLEEngine::Line_Decompress -- Decompresses a line-compressed RLE data
 *sequence.           *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *                                                                                             *
 *    This routine will compress the sequence of bytes specified by using RLE
 *compression.     *
 *                                                                                             *
 ...
 *                                                                                             *
 * WARNINGS:    The compressed data may, in rare instances, be larger than the
 *data it was     * compressing. The worst case is 33% larger. Keep that in mind
 *when supplying    * the destination buffer to this routine. *
 *                                                                                             *
 * HISTORY: * 04/17/1997 JLB : Created. *
 *=============================================================================================*/
 ...
 * RLEEngine::Line_Compress -- Compress a line of data. *
 *                                                                                             *
 *    This routine will compress a sequence of bytes and store the length of the
 *compressed    * data at the beginning of the output buffer. By encoding the
 *compressed size in this      * fashion, it is possible to build a sequence of
 *compressed bytes (such as with a sprite)  * so that each sequence can be
 *quickly traversed.                                          *
 *                                                                                             *
 * INPUT:   source   -- Pointer to the source data to be compressed. *
 *                                                                                             *
 *          dest     -- Pointer to the destination buffer that will hold the
 *length value and  * the compressed data. *
 *                                                                                             *
 *          length   -- The number of source bytes to compress. *
 *                                                                                             *
 * OUTPUT:  Returns with the number of bytes stored into the output buffer. *
 *                                                                                             *
 * WARNINGS:   The output data could be larger than the source data by as much
 *as 33% + 2      *
 *                                                                                             *
 * HISTORY: * 04/17/1997 JLB : Created. *
 *=============================================================================================*/
 ...
 *                                                                                             *
 *          dest     -- Pointer to the buffer that will hold the uncompressed
 *data.            *
 *                                                                                             *
 *          length   -- The length of the source RLE data to process. *
 *                                                                                             *
 * OUTPUT:  Returns with the actual number of bytes stored into the output
 *buffer.             *
 *                                                                                             *
 * WARNINGS:   The output buffer must be large enough to hold the decompressed
 *data. This      * could be as much as 128 times larger than the source RLE
 *data.                  *
 *                                                                                             *
 * HISTORY: * 04/17/1997 JLB : Created. *
 *=============================================================================================*/
 ...
 *sequence.             *
 *                                                                                             *
 *    This routine is the counterpart to Line_Compress. It will take a
 *compressed line and     * fully decompress it into the destination buffer. *
 *                                                                                             *
