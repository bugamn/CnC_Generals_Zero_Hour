...
bool GetVersionInfo(char *filename, VS_FIXEDFILEINFO *fileInfo) {
  ...
  if (verInfoSize) {
    ...
    if (memHandle) {
      ...
      if (buffer) {
        BOOL success =
            GetFileVersionInfo(filename, verHandle, verInfoSize, buffer);
...
//
////////////////////////////////////////////////////////////////////////
bool Get_Image_File_Header(const char *filename,
...
//
////////////////////////////////////////////////////////////////////////
bool Get_Image_File_Header(HINSTANCE app_instance,
                           IMAGE_FILE_HEADER *file_header) {
  bool retval = false;
  ...
  if (dos_header != NULL) {
    ...
    //
    ::memcpy(file_header, (((char *)dos_header) + image_header_offset),
