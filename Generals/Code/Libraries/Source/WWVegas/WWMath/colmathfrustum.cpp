...
CollisionMath::OverlapType CollisionMath::Overlap_Test(
    const FrustumClass& frustum, const Vector3& point) {
  int mask = 0;
...
CollisionMath::OverlapType CollisionMath::Overlap_Test(
    const FrustumClass& frustum, const TriClass& tri) {
  int mask = 0;
...
CollisionMath::OverlapType CollisionMath::Overlap_Test(
    const FrustumClass& frustum, const SphereClass& sphere) {
  int mask = 0;
...
CollisionMath::OverlapType CollisionMath::Overlap_Test(
    const FrustumClass& frustum, const AABoxClass& box) {
  int mask = 0;
...
CollisionMath::OverlapType CollisionMath::Overlap_Test(
    const FrustumClass& frustum, const OBBoxClass& box) {
  int mask = 0;
...
CollisionMath::OverlapType CollisionMath::Overlap_Test(
    const FrustumClass& frustum, const OBBoxClass& box, int& planes_passed) {
  int mask = 0;
