...
CollisionMath::OverlapType CollisionMath::Overlap_Test(
    const AAPlaneClass& plane, const Vector3& point) {
...
CollisionMath::OverlapType CollisionMath::Overlap_Test(
    const AAPlaneClass& plane, const LineSegClass& line) {
  int mask = 0;
...
CollisionMath::OverlapType CollisionMath::Overlap_Test(
    const AAPlaneClass& plane, const TriClass& tri) {
  int mask = 0;
...
CollisionMath::OverlapType CollisionMath::Overlap_Test(
    const AAPlaneClass& plane, const SphereClass& sphere) {
...
CollisionMath::OverlapType CollisionMath::Overlap_Test(
    const AAPlaneClass& plane, const AABoxClass& box) {
  float delta;
  int mask = 0;
...
CollisionMath::OverlapType CollisionMath::Overlap_Test(
    const AAPlaneClass& /*plane*/, const OBBoxClass& /*box*/) {
  // TODO
  WWASSERT(0);
  return POS;
}
...
CollisionMath::OverlapType CollisionMath::Overlap_Test(
    const PlaneClass& plane, const LineSegClass& line) {
  int mask = 0;
  mask |= CollisionMath::Overlap_Test(plane, line.Get_P0());
  mask |= CollisionMath::Overlap_Test(plane, line.Get_P1());
  return eval_overlap_mask(mask);
...
CollisionMath::OverlapType CollisionMath::Overlap_Test(
    const PlaneClass& plane, const SphereClass& sphere) {
