 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * Quaternion::Quaternion -- constructor * Quaternion::Set -- Set
 *the quaternion                                                     *
 *   Quaternion::operator= -- Assignment operator * Quaternion::Make_Closest --
 *Use nearest representation to the given quaternion.           * Trackball --
 ...
 *   Slerp -- Spherical Linear interpolation! * Build_Quaternion -- Creates a
 *quaternion from a Matrix                                    * Build_Matrix --
 *Creates a Matrix from a Quaternion                                        *
 *   Normalize -- normalizes a quaternion * Quaternion::Quaternion --
 *constructor                                                     * Slerp_Setup
 *-- Get ready to call "Cached_Slerp" * Cached_Slerp -- Quaternion slerping,
 *optimized with cached values                         *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *                                                                                             *
 * constructs a quaternion from the given axis and angle of rotation (in RADIANS
 *of course)    *
 *                                                                                             *
 * INPUT: * axis - axis of the rotation * angle - rotation angle *
 *                                                                                             *
 * OUTPUT: *
 *                                                                                             *
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 12/10/97   GTH : Created. *
 *=============================================================================================*/
 ...
 *                                                                                             *
 * INPUT: * x0,y0 - x1,y1 - "normalized" mouse coordinates for the mouse
 *movement                       * sphsize - size of the trackball sphere *
 *                                                                                             *
 * OUTPUT: * a quaternion representing the rotation of a trackball *
 *                                                                                             *
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 02/28/1997 GH  : Created. *
 ...
 *                                                                                             *
 * INPUT: * p - start quaternion * q - end quaternion * alpha - interpolating
 *parameter                                                            *
 *                                                                                             *
 * OUTPUT: *
 *                                                                                             *
...
#else
void __cdecl Fast_Slerp(Quaternion& res, const Quaternion& p,
                        const Quaternion& q, float alpha) {
  float beta;   // complementary interploation parameter
  float theta;  // angle between p and q
...
void Slerp(Quaternion& res, const Quaternion& p, const Quaternion& q,
           float alpha) {
  float beta;   // complementary interploation parameter
  float theta;  // angle between p and q
  // float sin_t
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 2/27/98    GTH : Created. *
 *=============================================================================================*/
void Slerp_Setup(const Quaternion& p, const Quaternion& q,
 ...
 * HISTORY: * 2/27/98    GTH : Created. *
 *=============================================================================================*/
Quaternion Cached_Slerp(const Quaternion& p, const Quaternion& q, float alpha,
                        SlerpInfoStruct* slerpinfo) {
  float beta;  // complementary interploation parameter
  float oo_sin_t;
...
void Cached_Slerp(const Quaternion& p, const Quaternion& q, float alpha,
                  SlerpInfoStruct* slerpinfo, Quaternion* set_q) {
  float beta;  // complementary interploation parameter
  float oo_sin_t;
 ...
 * OUTPUT: *
 *                                                                                             *
 * WARNINGS: * Matrix MUST NOT have scaling! *
 *                                                                                             *
 * HISTORY: * 02/28/1997 GH  : Created. *
 *=============================================================================================*/
