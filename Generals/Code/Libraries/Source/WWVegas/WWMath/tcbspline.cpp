...
** Save-Load stuff
*/
SimplePersistFactoryClass<TCBSpline3DClass, WWMATH_CHUNKID_TCBSPLINE3D>
    _TCBSpline3DFactory;
...
void TCBSpline3DClass::Set_TCB_Params(int i, float tension, float continuity,
                                      float bias) {
  WWASSERT(i >= 0);
...
void TCBSpline3DClass::Get_TCB_Params(int i, float *tension, float *continuity,
                                      float *bias) {
...
void TCBSpline3DClass::Update_Tangents(void) {
  ...
  if (IsLooping) {
    ...
    // position... Also just using the TCB params from p0 for both
    float k0 = 0.5f * ((1 - Params[0].Tension) * (1 - Params[0].Continuity) *
                       (1 - Params[0].Bias));
    float k1 = 0.5f * ((1 - Params[0].Tension) * (1 + Params[0].Continuity) *
                       (1 + Params[0].Bias));
    float k2 = 0.5f * ((1 - Params[0].Tension) * (1 + Params[0].Continuity) *
                       (1 - Params[0].Bias));
    float k3 = 0.5f * ((1 - Params[0].Tension) * (1 - Params[0].Continuity) *
                       (1 + Params[0].Bias));
    ...
    float k2 = 0.25f * ((1 - Params[0].Tension) * (1 + Params[0].Continuity) *
                        (1 - Params[0].Bias));
    float k3 = 0.25f * ((1 - Params[0].Tension) * (1 - Params[0].Continuity) *
                        (1 + Params[0].Bias));
    ...
    float k0 = 0.25f * ((1 - Params[0].Tension) * (1 - Params[0].Continuity) *
                        (1 - Params[0].Bias));
    float k1 = 0.25f * ((1 - Params[0].Tension) * (1 + Params[0].Continuity) *
                        (1 + Params[0].Bias));
  ...
  for (int pi = 1; pi < Keys.Count() - 1; pi++) {
    float k0 = 0.5f * ((1 - Params[pi].Tension) * (1 - Params[pi].Continuity) *
                       (1 - Params[pi].Bias));
    float k1 = 0.5f * ((1 - Params[pi].Tension) * (1 + Params[pi].Continuity) *
                       (1 + Params[pi].Bias));
    float k2 = 0.5f * ((1 - Params[pi].Tension) * (1 + Params[pi].Continuity) *
                       (1 - Params[pi].Bias));
    float k3 = 0.5f * ((1 - Params[pi].Tension) * (1 - Params[pi].Continuity) *
                       (1 + Params[pi].Bias));
