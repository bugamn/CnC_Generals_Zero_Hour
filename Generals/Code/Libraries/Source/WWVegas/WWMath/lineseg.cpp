 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * LineSegClass::Set -- Initialize this 'lineseg' by transforming
 *another 'lineseg'          * LineSegClass::Set_Random -- create a random
 *linesegment within the given space            *
 *   LineSegClass::Find_Point_Closest_To -- Finds point on line closest to point
 *supplied.     * LineSegClass::Find_Intersection -- Finds the closest points on
 *the two lines				  *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
...
/***********************************************************************************************
 * LineSegClass::Set -- Initialize this 'lineseg' by transforming another
 *'lineseg'            *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
...
/***********************************************************************************************
 * LineSegClass::Set_Random -- create a random linesegment within the given
 *space              *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 07/26/1999 SKB : Created. *
 *=============================================================================================*/
...
/***********************************************************************************************
 * LineSegClass::Find_Intersection -- Finds the closest points on the two
 *lines..				  *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 03/03/2000 PDS : Created. *
 *=============================================================================================*/
bool LineSegClass::Find_Intersection(const LineSegClass &other_line,
                                     Vector3 *p1, float *fraction1, Vector3 *p2,
