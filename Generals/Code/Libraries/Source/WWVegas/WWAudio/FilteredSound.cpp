...
//
//////////////////////////////////////////////////////////////////////////////////
SimplePersistFactoryClass<FilteredSoundClass, CHUNKID_FILTERED_SOUND>
    _FilteredSoundPersistFactory;
...
//
/////////////////////////////////////////////////////////////////////////////////
FilteredSoundClass::FilteredSoundClass(void) : m_hFilter(INVALID_MILES_HANDLE) {
  return;
}
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
const FilteredSoundClass &FilteredSoundClass::operator=(
    const FilteredSoundClass &src) {
  // Call the base class
...
void FilteredSoundClass::Initialize_Miles_Handle(void) {
  ...
  if ((m_SoundHandle != NULL) && (m_hFilter != INVALID_MILES_HANDLE)) {
    ...
    //
    ::AIL_set_sample_processor(m_SoundHandle->Get_HSAMPLE(), DP_FILTER,
                               m_hFilter);
    ...
    ::AIL_set_filter_sample_preference(m_SoundHandle->Get_HSAMPLE(),
                                       "Reverb reflect time", &reverb_reflect);
