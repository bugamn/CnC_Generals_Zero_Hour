...
//	Static factories
//////////////////////////////////////////////////////////////////////////////////
SimplePersistFactoryClass<LogicalListenerClass, CHUNKID_LOGICALLISTENER>
    _LogicalListenerPersistFactory;
...
LogicalListenerClass::LogicalListenerClass(void)
    : m_Scale(1), m_TypeMask(0), m_Position(0, 0, 0), m_Timestamp(0) {
  return;
}
