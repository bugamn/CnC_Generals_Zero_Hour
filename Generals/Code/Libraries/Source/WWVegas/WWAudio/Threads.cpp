 ...
 *                                                                                             *
 *                     $Archive:: /Commando/Code/WWAudio/Threads.cpp $Modtime::
 *7/17/99 3:32p                                               $*
 *                                                                                             *
 *                    $Revision:: 5 $*
 *                                                                                             *
...
///////////////////////////////////////////////////////////////////////////////////////////
WWAudioThreadsClass::DELAYED_RELEASE_INFO
    *WWAudioThreadsClass::m_ReleaseListHead = NULL;
...
//
///////////////////////////////////////////////////////////////////////////////////////////
WWAudioThreadsClass::WWAudioThreadsClass(void) { return; }
...
WWAudioThreadsClass::Create_Delayed_Release_Thread(LPVOID param) {
  ...
  if (m_hDelayedReleaseThread == (HANDLE)-1) {
    ...
    m_hDelayedReleaseThread =
        (HANDLE)::_beginthread(Delayed_Release_Thread_Proc, 0, param);
  }
...
//
///////////////////////////////////////////////////////////////////////////////////////////
void WWAudioThreadsClass::Add_Delayed_Release_Object(RefCountClass *object,
                                                     DWORD delay) {
  if (m_IsShuttingDown) {
...
//
///////////////////////////////////////////////////////////////////////////////////////////
void __cdecl WWAudioThreadsClass::Delayed_Release_Thread_Proc(
    LPVOID /*param*/) {
  ...
  //
  while (::WaitForSingleObject(m_hDelayedReleaseEvent, timeout) ==
         WAIT_TIMEOUT) {
    {
      CriticalSectionClass::LockClass lock(m_ListMutex);
...
WWAudioThreadsClass::Begin_Modify_List (void)
{
        ...
        //
        if (m_ListMutex != NULL) {
                retval = (::WaitForSingleObject (m_ListMutex, 1000) ==
WAIT_OBJECT_0); WWASSERT (retval);
        }
