...
//	Static factories
//////////////////////////////////////////////////////////////////////////////////
SimplePersistFactoryClass<SoundPseudo3DClass, CHUNKID_PSEUDO_SOUND3D>
    _PseudoSound3DPersistFactory;
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
const SoundPseudo3DClass &SoundPseudo3DClass::operator=(
    const SoundPseudo3DClass &src) {
  // Call the base class
...
void SoundPseudo3DClass::Update_Pseudo_Volume(void) {
  ...
  if (m_SoundHandle != NULL) {
    ...
    //
    Vector3 sound_pos =
        m_ListenerTransform.Get_Translation() - m_Transform.Get_Translation();
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
const PersistFactoryClass &SoundPseudo3DClass::Get_Factory(void) const {
