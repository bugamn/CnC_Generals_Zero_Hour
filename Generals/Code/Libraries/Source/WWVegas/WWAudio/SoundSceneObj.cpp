...
{
public:
        HandleMgrClass (void)	{ SoundSceneObjClass::m_IDListMutex =
::CreateMutex (NULL, FALSE, NULL); } ~HandleMgrClass (void)	{ ::CloseHandle
(SoundSceneObjClass::m_IDListMutex); }
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
const SoundSceneObjClass &SoundSceneObjClass::operator=(
  ...
  if (m_AttachedObject != NULL) {
    ...
    if (m_AttachedBone >= 0) {
      ...
      if (m_AttachedObject->Class_ID() == RenderObjClass::CLASSID_CAMERA) {
        Matrix3D cam_to_world(Vector3(0, 0, -1), Vector3(-1, 0, 0),
...
bool SoundSceneObjClass::Load(ChunkLoadClass &cload) {
  ...
  //
  //	We need to 'swizzle' the attached object pointer.  We saved the
  //pointer's
  // value, and need to map it (hopefully) to the new value.
  //
  if (m_AttachedObject != NULL) {
    SaveLoadSystemClass::Request_Ref_Counted_Pointer_Remap(
        (RefCountClass **)&m_AttachedObject);
  }
...
//
//////////////////////////////////////////////////////////////////////////////////
void SoundSceneObjClass::Unregister_Sound_Object(
