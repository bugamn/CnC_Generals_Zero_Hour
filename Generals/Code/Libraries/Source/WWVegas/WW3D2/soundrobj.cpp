...
SoundRenderObjClass::SoundRenderObjClass(void)
    : Flags(FLAG_STOP_WHEN_HIDDEN), Sound(NULL), IsInitialized(false) {
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////////////
const SoundRenderObjClass &SoundRenderObjClass::operator=(
...
//
//////////////////////////////////////////////////////////////////////////////////
void SoundRenderObjClass::Set_Sound(AudibleSoundDefinitionClass *definition) {
  //
  //	Remove the old sound from the world (if necessary)
  //
  if (Sound != NULL) {
...
//
//////////////////////////////////////////////////////////////////////////////////
void SoundRenderObjClass::On_Frame_Update(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////////////////
void SoundRenderObjClass::Set_Hidden(int onoff) {
...
//
//////////////////////////////////////////////////////////////////////////////////
void SoundRenderObjClass::Set_Visible(int onoff) {
  int before = Is_Not_Hidden_At_All();
...
//
//////////////////////////////////////////////////////////////////////////////////
void SoundRenderObjClass::Set_Animation_Hidden(int onoff) {
  int before = Is_Not_Hidden_At_All();
...
//
//////////////////////////////////////////////////////////////////////////////////
void SoundRenderObjClass::Set_Force_Visible(int onoff) {
  int before = Is_Not_Hidden_At_All();
...
void SoundRenderObjClass::Update_On_Visibilty(void) {
  ...
  //
  if (Is_Not_Hidden_At_All() && Sound->Is_In_Scene() == false &&
      Peek_Scene() != NULL) {
    //
...
//
//////////////////////////////////////////////////////////////////////////////
void SoundRenderObjClass::Set_Flag(uint32 flag, bool onoff) {
  Flags &= ~flag;
  if (onoff) {
    Flags |= flag;
  }
...
//
//////////////////////////////////////////////////////////////////////////////////
void SoundRenderObjClass::Notify_Added(SceneClass *scene) {
...
//
//////////////////////////////////////////////////////////////////////////////////
void SoundRenderObjClass::Notify_Removed(SceneClass *scene) {
...
//
//////////////////////////////////////////////////////////////////////////////////
void SoundRenderObjClass::Set_Transform(const Matrix3D &tm) {
...
//
//////////////////////////////////////////////////////////////////////////////////
void SoundRenderObjClass::Set_Position(const Vector3 &pos) {
...
//
//////////////////////////////////////////////////////////////////////////////////
SoundRenderObjDefClass::~SoundRenderObjDefClass(void) { return; }
...
//
//////////////////////////////////////////////////////////////////////////////////
const SoundRenderObjDefClass &SoundRenderObjDefClass::operator=(
    const SoundRenderObjDefClass &src) {
...
//
//////////////////////////////////////////////////////////////////////////////////
RenderObjClass *SoundRenderObjDefClass::Create(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////////////////
void SoundRenderObjDefClass::Initialize(SoundRenderObjClass &render_obj) {
  //
...
//
///////////////////////////////////////////////////////////////////////////////////
WW3DErrorType SoundRenderObjDefClass::Load_W3D(ChunkLoadClass &cload) {
...
//
//////////////////////////////////////////////////////////////////////////////////
WW3DErrorType SoundRenderObjDefClass::Save_W3D(ChunkSaveClass &csave) {
...
//
///////////////////////////////////////////////////////////////////////////////////
WW3DErrorType SoundRenderObjDefClass::Read_Header(ChunkLoadClass &cload) {
  WW3DErrorType retval = WW3D_ERROR_LOAD_FAILED;
...
//
///////////////////////////////////////////////////////////////////////////////////
WW3DErrorType SoundRenderObjDefClass::Read_Definition(ChunkLoadClass &cload) {
  WW3DErrorType retval = WW3D_ERROR_LOAD_FAILED;
...
//
///////////////////////////////////////////////////////////////////////////////////
WW3DErrorType SoundRenderObjDefClass::Write_Header(ChunkSaveClass &csave) {
  WW3DErrorType retval = WW3D_ERROR_SAVE_FAILED;
...
//
///////////////////////////////////////////////////////////////////////////////////
WW3DErrorType SoundRenderObjDefClass::Write_Definition(ChunkSaveClass &csave) {
  WW3DErrorType retval = WW3D_ERROR_SAVE_FAILED;
