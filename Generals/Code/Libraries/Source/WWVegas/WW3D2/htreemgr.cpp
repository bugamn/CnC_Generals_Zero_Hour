 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * HTreeManagerClass::HTreeManagerClass -- constructor *
 *   HTreeManagerClass::~HTreeManagerClass -- destructor *
 *   HTreeManagerClass::Free -- de-allocate all memory in use *
 *   HTreeManagerClass::Free_All_Trees -- de-allocates all hierarchy trees
 *currently loaded    * HTreeManagerClass::Load_Tree -- load a hierarchy tree
 *from a file                         * HTreeManagerClass::Get_Tree_ID -- look
 *up the ID of a named hierarchy tree                *
 *   HTreeManagerClass::Get_Tree -- get a pointer to the specified hierarchy
 *tree              * HTreeManagerClass::Get_Tree -- get a pointer to the
 *specified hierarchy tree              *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 * HISTORY: * 08/11/1997 GH  : Created. *
 *=============================================================================================*/
HTreeManagerClass::~HTreeManagerClass(void) { Free(); }
 ...
 * HISTORY: * 08/11/1997 GH  : Created. *
 *=============================================================================================*/
void HTreeManagerClass::Free(void) { Free_All_Trees(); }
...
/***********************************************************************************************
 * HTreeManagerClass::Free_All_Trees_With_Exclusion_List -- de-allocates all
 *trees not in list *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 *=============================================================================================*/
void HTreeManagerClass::Free_All_Trees_With_Exclusion_List(
    const W3DExclusionListClass &exclusion_list) {
  // For this system, since it is so simplistic, we simply loop over the array
  // either deleting the tree or copying it to the new tail index if it is
  // excluded.
  int new_tail = 0;
