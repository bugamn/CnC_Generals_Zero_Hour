 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * Animatable3DObjClass::Animatable3DObjClass -- constructor *
 ...
 *   Animatable3DObjClass::Release -- Releases any anims being held by this
 *object             * Animatable3DObjClass::Render -- Update this object for
 *rendering                          * Animatable3DObjClass::Special_Render --
 *"special render" function for animatables         *
 *   Animatable3DObjClass::Set_Transform -- sets the transform and marks
 *sub-objects as dirty  * Animatable3DObjClass::Set_Position -- Sets the
 *position and marks sub-objects as dirty    *
 *   Animatable3DObjClass::Get_Num_Bones -- returns number of bones in this
 *object             * Animatable3DObjClass::Get_Bone_Name -- returns the name
 *of the given bone                 * Animatable3DObjClass::Get_Bone_Index --
 *returns the index of the given bone               *
 *   Animatable3DObjClass::Set_Animation -- set the animation state to "none"
 *(base pose)      * Animatable3DObjClass::Set_Animation -- Set the animation
 *state to the given anim/frame    * Animatable3DObjClass::Set_Animation -- set
 *the animation state to a blend of two anims    *
 *   Animatable3DObjClass::Set_Animation -- Set animation state with an anim
 *combo             * Animatable3DObjClass::Get_Bone_Transform -- return the
 *transform for the given bone       * Animatable3DObjClass::Get_Bone_Transform
 *-- return the transform for the given bone       *
 *   Animatable3DObjClass::Capture_Bone -- capture the specified bone (override
 *animation)     * Animatable3DObjClass::Release_Bone -- release the specified
 *bone (allow animation)        * Animatable3DObjClass::Is_Bone_Captured --
 *returns whether the specified bone is captured  *
 *   Animatable3DObjClass::Control_Bone -- sets the transform for the bone *
 *   Animatable3DObjClass::Update_Sub_Object_Transforms -- recalculate the
 *transforms for our  *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 *                                                                                             *
 * INPUT: * htree_name -- name of the hierarchy tree which defines the "bone"
...
Animatable3DObjClass::Animatable3DObjClass(const char *htree_name)
    : IsTreeValid(0), CurMotionMode(BASE_POSE) {
  ...
  */
  if (htree_name == NULL) {
    ...
    HTreeClass *source =
        WW3DAssetManager::Get_Instance()->Get_HTree(htree_name);
    if (source != NULL) {
 ...
 * Animatable3DObjClass::Animatable3DObjClass -- copy constructor *
 *                                                                                             *
 * INPUT: * src -- animatable object to copy. *
 *                                                                                             *
 * OUTPUT: *
 *                                                                                             *
 * WARNINGS: *
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 3/2/99     GTH : Created. *
 *=============================================================================================*/
Animatable3DObjClass &Animatable3DObjClass::operator=(
    const Animatable3DObjClass &that) {
  if (&that != this) {
    Release();
    if (HTree) {
      delete HTree;
...
/***********************************************************************************************
 * Animatable3DObjClass::Special_Render -- "special render" function for
 *animatables           *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
...
/***********************************************************************************************
 * Animatable3DObjClass::Set_Position -- Sets the position and marks sub-objects
 *as dirty      *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
...
/***********************************************************************************************
 * Animatable3DObjClass::Set_Animation -- Set the animation state to the given
 *anim/frame      *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * HISTORY: * 12/8/98    GTH : Created. *
 *=============================================================================================*/
void Animatable3DObjClass::Set_Animation(HAnimClass *motion, float frame,
                                         int mode) {
  if (motion) {
...
/***********************************************************************************************
 * Animatable3DObjClass::Set_Animation -- set the animation state to a blend of
 *two anims      *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * HISTORY: * 12/8/98    GTH : Created. *
 *=============================================================================================*/
void Animatable3DObjClass::Set_Animation(HAnimClass *motion0, float frame0,
...
/***********************************************************************************************
 * Animatable3DObjClass::Get_Bone_Transform -- return the transform for the
 *given bone         *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
...
/***********************************************************************************************
 * Animatable3DObjClass::Release_Bone -- release the specified bone (allow
 *animation)          *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
...
/***********************************************************************************************
 * Animatable3DObjClass::Is_Bone_Captured -- returns whether the specified bone
 *is captured    *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * HISTORY: * 3/2/99     GTH : Created. *
 *=============================================================================================*/
void Animatable3DObjClass::Control_Bone(int bindex, const Matrix3D &objtm,
  ...
  switch (CurMotionMode) {
    ...
    case DOUBLE_ANIM:
      Blend_Update(Transform, ModeInterp.Motion0, ModeInterp.Frame0,
                   ModeInterp.Motion1, ModeInterp.Frame1,
                   ModeInterp.Percentage);
      break;
...
/***********************************************************************************************
 * Animatable3DObjClass::Simple_Evaluate_Bone -- If the animation is 'single',
 *evaluate the    * given pivot and return its transform.		  *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 * OUTPUT: *
 ...
 * HISTORY: * 04/13/2000    PDS : Created. *
 *=============================================================================================*/
bool Animatable3DObjClass::Simple_Evaluate_Bone(int boneindex, float frame,
                                                Matrix3D *tm) const {
  bool retval = false;
...
/***********************************************************************************************
 * Animatable3DObjClass::Compute_Current_Frame -- Returns the animation frame
 *for the next rend*
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
  ...
  switch (CurMotionMode) {
    case SINGLE_ANIM: {
      ...
      if (ModeAnim.AnimMode != ANIM_MODE_MANUAL) {
        ...
        float delta = ModeAnim.Motion->Get_Frame_Rate() *
                      ModeAnim.frameRateMultiplier * ModeAnim.animDirection *
                      sync_time_diff * 0.001f;
        frame += delta;
        ...
        switch (ModeAnim.AnimMode) {
          ...
          case ANIM_MODE_LOOP:
            ...
            break;
          case ANIM_MODE_ONCE_BACKWARDS:  // play animation one time but
                                          // backwards
            if (frame < 0) {
              frame = 0;
            }
          ...
          case ANIM_MODE_LOOP_PINGPONG:
            if (ModeAnim.animDirection >=
                1.0f) {  // playing forwards, reverse direction
              if (frame >= (ModeAnim.Motion->Get_Num_Frames() -
                            1)) {  // step backwards in animation by excess time
            ...
            } else {            // playing backwards, reverse direction
              if (frame < 0) {  // step forwards in animation by excess time
                frame = -frame;
                // If it is still too far out, reset
                if (frame >= ModeAnim.Motion->Get_Num_Frames() - 1) frame = 0;
                direction = ModeAnim.animDirection * -1.0f;
              }
            }
            break;
...
/***********************************************************************************************
 * Animatable3DObjClass::Is_Animation_Complete -- is the current animation on
 *the last frame?  *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 *=============================================================================================*/
void Animatable3DObjClass::Set_Animation_Frame_Rate_Multiplier(
    float multiplier) {
  // 020607 srj -- added
