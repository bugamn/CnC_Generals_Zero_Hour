...
D3DFORMAT WW3DFormatToD3DFormatConversionArray[WW3D_FORMAT_COUNT] = {
    ...
    D3DFMT_A8P8,     D3DFMT_P8,       D3DFMT_L8,       D3DFMT_A8L8,
    D3DFMT_A4L4,
    D3DFMT_V8U8,      // Bumpmap
    D3DFMT_L6V5U5,    // Bumpmap
    D3DFMT_X8L8V8U8,  // Bumpmap
    D3DFMT_DXT1,     D3DFMT_DXT2,     D3DFMT_DXT3,     D3DFMT_DXT4,
    D3DFMT_DXT5};
...
= { WW3D_FORMAT_UNKNOWN,		// 0 WW3D_FORMAT_UNKNOWN,
...
WW3D_FORMAT_UNKNOWN,	WW3D_FORMAT_UNKNOWN, WW3D_FORMAT_UNKNOWN,
        ...
        WW3D_FORMAT_UNKNOWN,	WW3D_FORMAT_UNKNOWN,	WW3D_FORMAT_UNKNOWN,
WW3D_FORMAT_UNKNOWN, WW3D_FORMAT_UNKNOWN,	WW3D_FORMAT_UNKNOWN,
WW3D_FORMAT_UNKNOWN,	WW3D_FORMAT_UNKNOWN, WW3D_FORMAT_L8, // 50
        WW3D_FORMAT_A8L8,
        WW3D_FORMAT_A4L4
};
*/
...
WW3DFormat
    D3DFormatToWW3DFormatConversionArray[HIGHEST_SUPPORTED_D3DFORMAT + 1];
...
WW3DFormat D3DFormat_To_WW3DFormat(D3DFORMAT d3d_format) {
  switch (d3d_format) {
    // The DXT-codes are created with FOURCC macro and thus can't be placed in
...
void Init_D3D_To_WW3_Conversion() {
  ...
  D3DFormatToWW3DFormatConversionArray[D3DFMT_V8U8] =
      WW3D_FORMAT_U8V8;  // Bumpmap
  D3DFormatToWW3DFormatConversionArray[D3DFMT_L6V5U5] =
      WW3D_FORMAT_L6V5U5;  // Bumpmap
  D3DFormatToWW3DFormatConversionArray[D3DFMT_X8L8V8U8] =
