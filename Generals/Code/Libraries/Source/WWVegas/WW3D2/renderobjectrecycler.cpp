 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * RenderObjectRecyclerClass::Reset -- reset the cache *
 *   RenderObjectRecyclerClass::Get_Render_Object -- Create/Re-use a render
 *object             * RenderObjectRecyclerClass::Return_Render_Object -- Return
 *a render object to the cache    *
 *   RenderObjectRecyclerClass::Insert_Inactive_Model -- Internally add a render
 *object to the * RenderObjectRecyclerClass::Reset_Model -- resets a render
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 4/25/2001  gth : Created. *
 *=============================================================================================*/
void RenderObjectRecyclerClass::Reset(void) { InactiveModels.Reset_List(); }
 ...
 * HISTORY: * 4/25/2001  gth : Created. *
 *=============================================================================================*/
RenderObjClass *RenderObjectRecyclerClass::Get_Render_Object(
    const char *name, const Matrix3D &tm) {
...
/***********************************************************************************************
 * RenderObjectRecyclerClass::Return_Render_Object -- Return a render object to
 *the pool       *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
...
/***********************************************************************************************
 * RenderObjectRecyclerClass::Reset_Model -- resets a render object so it can be
 *re-used       *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
...
void RenderObjectRecyclerClass::Reset_Model(RenderObjClass *model) {
  ...
  */
  if (model->Peek_Animation() != NULL) {
    model->Set_Animation(model->Peek_Animation(), 0.0f,
