 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * LayerClass::LayerClass -- constructor * LayerClass::~LayerClass
 *-- destructor                                                     *
 *   LayerClass::Set_Scene -- Set the scene used by this layer *
 *   LayerClass::Get_Scene -- get the scene being rendered by this layer *
 *   LayerClass::Peek_Scene -- get the scene being rendered by this layer w/o a
 *ref            * LayerClass::Set_Camera -- Set the camera being used by this
 *layer                         * LayerClass::Get_Camera -- get the camera being
 *used by this layer                         * LayerClass::LayerClass -- default
 *constructor                                             * LC::Peek_Camera --
 *Get copy of camera.                                                    *
 ...
 * HISTORY: * 3/27/98    GTH : Created. *
 *=============================================================================================*/
LayerClass::LayerClass(SceneClass *scene, CameraClass *cam, bool clear,
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 3/8/99    NH : Created. *
 *=============================================================================================*/
SceneClass *LayerClass::Peek_Scene(void) const { return Scene; }
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 08/14/2001 SKB : Created. *
 *=============================================================================================*/
CameraClass *LayerClass::Peek_Camera(void) const { return Camera; }
