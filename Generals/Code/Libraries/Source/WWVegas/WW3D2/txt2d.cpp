 ...
 *========================================================================*/
Text2DObjClass::Text2DObjClass(FontClass &font, const char *str, float screen_x,
                               float screen_y, int fore, int back,
                               ConvertClass &conv, bool center, bool clamp, ...)
 ...
 *========================================================================*/
void Text2DObjClass::Set_Text(FontClass &font, const char *str, float screen_x,
                              float screen_y, int fore, int back,
                              ConvertClass &conv, bool center, bool clamp,
                              ...) {
  ...
  if (!TextTexture.Build_Texture(font, text, fore, back, conv)) return;
  ...
  //					is up to the caller how he/she wants the
  //font to look. font.Set_XSpacing(-1);
  ...
  // if we requested that the coordinates be checked to ensure they are
  // onscreen, adjust the coordinates as neccessary.
  if (clamp) {
