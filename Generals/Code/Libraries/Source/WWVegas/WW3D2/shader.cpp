 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * ShaderClass::Init_From_Material3 -- Initialize a shader from a
 *Material3 structure        * ShaderClass::Apply -- Apply the renderstates for
 *this shader                              *
 *   ShaderClass::Invert_Backface_Culling -- Globally invert the sense of all
 *backface culling * ShaderClass::Is_Backface_Culling_Inverted -- Is backface
 *culling inverted?                * ShaderClass::Get_SS_Category -- Helper
 *function for static sort system                    *
...
#define SC_OPAQUE                                                              \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_ENABLE, COLOR_WRITE_ENABLE,             \
              SRCBLEND_ONE, DSTBLEND_ZERO, FOG_DISABLE, GRADIENT_MODULATE,     \
              SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, \
              CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
ShaderClass ShaderClass::_PresetOpaqueShader(SC_OPAQUE);

// Texturing, zbuffer, disabled zbuffer write, primary gradient, additive
// blending
#define SC_ADDITIVE                                                            \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE,            \
              SRCBLEND_ONE, DSTBLEND_ONE, FOG_DISABLE, GRADIENT_MODULATE,      \
              SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, \
              CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_BUMPENVMAP                                                          \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE,            \
              SRCBLEND_ONE, DSTBLEND_ONE, FOG_DISABLE, GRADIENT_BUMPENVMAP,    \
              SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, \
              CULL_MODE_ENABLE, DETAILCOLOR_ADD, DETAILALPHA_DISABLE))
...
#define SC_ALPHA                                                               \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE,            \
              ...
              GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, \
              ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE,        \
              DETAILALPHA_DISABLE))
ShaderClass ShaderClass::_PresetAlphaShader(SC_ALPHA);

// Texturing, zbuffer, disabled zbuffer write, primary gradient, multiplicative
// blending
#define SC_MULTIPLICATIVE                                                      \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE,            \
              SRCBLEND_ZERO, DSTBLEND_SRC_COLOR, FOG_DISABLE,                  \
              GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, \
              ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE,        \
              DETAILALPHA_DISABLE))
...
#define SC_OP_2D                                                               \
  (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE,            \
              SRCBLEND_ONE, DSTBLEND_ZERO, FOG_DISABLE, GRADIENT_DISABLE,      \
              SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, \
              CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_ADD_2D                                                              \
  (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE,            \
              SRCBLEND_ONE, DSTBLEND_ONE, FOG_DISABLE, GRADIENT_DISABLE,       \
              SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, \
              CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_ALPHA_2D                                                           \
  (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE,           \
              SRCBLEND_SRC_ALPHA, DSTBLEND_ONE_MINUS_SRC_ALPHA, FOG_DISABLE,  \
              GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, \
              ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE,       \
              DETAILALPHA_DISABLE))
...
#define SC_ALPHA_SOLID                                                       \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE,          \
              SRCBLEND_SRC_ALPHA, DSTBLEND_ONE_MINUS_SRC_ALPHA, FOG_DISABLE, \
              GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE,                 \
...
#define SC_ATEST_2D                                                           \
  (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE,           \
              SRCBLEND_ONE, DSTBLEND_ZERO, FOG_DISABLE, GRADIENT_DISABLE,     \
              SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_ENABLE, \
              CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_ATESTBLEND_2D                                                      \
  (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE,           \
              SRCBLEND_SRC_ALPHA, DSTBLEND_ONE_MINUS_SRC_ALPHA, FOG_DISABLE,  \
              GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, \
              ALPHATEST_ENABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE,        \
              DETAILALPHA_DISABLE))
...
#define SC_SCREEN_2D                                                          \
  (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE,           \
              SRCBLEND_ONE, DSTBLEND_ONE_MINUS_SRC_COLOR, FOG_DISABLE,        \
              GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, \
              ALPHATEST_DISABLE, CULL_MODE_ENABLE, DETAILCOLOR_DISABLE,       \
              DETAILALPHA_DISABLE))
...
/***********************************************************************************************
 * ShaderClass::Init_From_Material3 -- Initialize a shader from a Material3
 *structure          *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 *                                                                                             *
 * Enable most appropriate fog mode (FOG_ENABLE, FOG_SCALE_FRAGMENT or
 *FOG_WHITE) for given	  * source and destination blends.
 **
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
...
void ShaderClass::Enable_Fog(const char *source) {
  // Enable the appropriate fog mode based on shader's source and destination
  // blends.
...
void ShaderClass::Report_Unable_To_Fog(const char *source) {
  ...
  const char *unabletofogtext =
      "WARNING: Unable to fog shader in %s with given blending mode.\r\n";
  const char *unabletofogmoretext =
      "WARNING: Unable to fog additional shaders (further warnings will be "
      "suppressed).\r\n";
  const unsigned maxreportcount = 10;

  // Limit the no. of warning messages to some practical maximum. Suppress all
  // subsequent warnings.
...
const Blend srcBlendLUT[ShaderClass::SRCBLEND_MAX] = {
    Blend(D3DBLEND_ZERO, false), Blend(D3DBLEND_ONE, false),
    Blend(D3DBLEND_SRCALPHA, true), Blend(D3DBLEND_DESTCOLOR, true)};

const Blend dstBlendLUT[ShaderClass::DSTBLEND_MAX] = {
    Blend(D3DBLEND_ZERO, false),     Blend(D3DBLEND_ONE, false),
    Blend(D3DBLEND_SRCCOLOR, false), Blend(D3DBLEND_INVSRCCOLOR, false),
    Blend(D3DBLEND_SRCALPHA, true),  Blend(D3DBLEND_INVSRCALPHA, true)};
...
void ShaderClass::Apply() {
  ...
  if (diff & (ShaderClass::MASK_COLORMASK | ShaderClass::MASK_SRCBLEND |
              ShaderClass::MASK_DSTBLEND | ShaderClass::MASK_ALPHATEST)) {
    ULONG planeMask = 0xffffff;

    if (Get_Color_Mask() != ShaderClass::COLOR_WRITE_ENABLE) planeMask = 0;
    ...
    if (Get_Alpha_Test() == ShaderClass::ALPHATEST_ENABLE) {
      unsigned char alphareference =
          0x60;  // Alpha reference value that produces best results with
                 // mip-mapped textures.
    ...
    diff &= ~(ShaderClass::MASK_COLORMASK | ShaderClass::MASK_SRCBLEND |
              ShaderClass::MASK_DSTBLEND | ShaderClass::MASK_ALPHATEST);
    if (!diff) return;
  }

  if (diff & (ShaderClass::MASK_FOG)) {
    // Whenever fog is enabled or disabled, the entire shader is invalidated.
    // This is why we can defer the "fog enabled" check inside the "fog settings
    // changed" check.
  ...
  if (diff &
      (ShaderClass::MASK_POSTDETAILCOLORFUNC | ShaderClass::MASK_TEXTURING)) {
  ...
  if (diff &
      (ShaderClass::MASK_POSTDETAILALPHAFUNC | ShaderClass::MASK_TEXTURING)) {
  ...
  DX8Wrapper::Set_DX8_Render_State(D3DRS_ZFUNC,
                                   D3DCMPFUNC(int(Get_Depth_Compare()) + 1));
  ...
  DX8Wrapper::Set_DX8_Render_State(
      D3DRS_CULLMODE, Get_Cull_Mode() ? _PolygonCullMode : D3DCULL_NONE);
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 7/13/2001  hy : Created. *
 *=============================================================================================*/
ShaderClass::StaticSortCategoryType ShaderClass::Get_SS_Category(void) const {
  // category: Opaque
  if ((ALPHATEST_DISABLE == Get_Alpha_Test()) &&
      (DSTBLEND_ZERO == Get_Dst_Blend_Func()))
    return SSCAT_OPAQUE;
  // category: Alpha Test
  ...
  // category: Additive
  if ((SRCBLEND_ONE == Get_Src_Blend_Func()) &&
      (DSTBLEND_ONE == Get_Dst_Blend_Func()))
