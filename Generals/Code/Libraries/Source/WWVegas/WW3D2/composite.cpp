 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * CompositeRenderObjClass::CompositeRenderObjClass -- Constructor
 ...
 *   CompositeRenderObjClass::Restart -- Recursively call Restart on all
 *sub-objects           * CompositeRenderObjClass::Get_Name -- returns the name
 *of this render object               * CompositeRenderObjClass::Set_Name --
 ...
 *   CompositeRenderObjClass::Notify_Added -- notify all sub-objects that they
 *were added      * CompositeRenderObjClass::Notify_Removed -- notifies all
 *subobjs they were removed from th * CompositeRenderObjClass::Cast_Ray -- cast
 *a ray against this object                       *
 *   CompositeRenderObjClass::Cast_AABox -- cast a swept AABox against this
 *object             * CompositeRenderObjClass::Cast_OBBox -- cast a swept OBBox
 *against this object             * CompositeRenderObjClass::Intersect_AABox --
 *intersect this object with an AABox           *
 *   CompositeRenderObjClass::Intersect_OBBox -- intersect this object with an
 *OBBox           * CompositeRenderObjClass::Create_Decal -- create a decal on
 *this object                    * CompositeRenderObjClass::Delete_Decal --
 *remove a logical decal from this object          *
 *   CompositeRenderObjClass::Update_Obj_Space_Bounding_Volumes -- updates the
 *object-space BV * CompositeRenderObjClass::Set_User_Data -- set the userdata
 *pointer                        *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
...
CompositeRenderObjClass::CompositeRenderObjClass(
    const CompositeRenderObjClass &that)
    : Name(NULL), BaseModelName(NULL) {
 ...
 * HISTORY: * 1/26/00    gth : Created. *
 *=============================================================================================*/
CompositeRenderObjClass &CompositeRenderObjClass::operator=(
    const CompositeRenderObjClass &that) {
  Set_Name(that.Get_Name());
  Set_Base_Model_Name(that.Get_Base_Model_Name());
  return *this;
 ...
 * CompositeRenderObjClass::Set_Base_Model_Name -- sets the "base-model-name" *
 *                                                                                             *
 *    The base-model-name was needed by the aggregate code.  Ask Patrick Smith
 *about it :-)    *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
...
/***********************************************************************************************
 * CompositeRenderObjClass::Notify_Removed -- notifies all subobjs they were
 *removed from the  *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
...
/***********************************************************************************************
 * CompositeRenderObjClass::Intersect_AABox -- intersect this object with an
 *AABox             *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * HISTORY: * 1/26/00    gth : Created. *
 *=============================================================================================*/
bool CompositeRenderObjClass::Intersect_AABox(
    AABoxIntersectionTestClass &boxtest) {
  bool res = false;
  for (int i = 0; i < Get_Num_Sub_Objects(); i++) {
    RenderObjClass *robj = Get_Sub_Object(i);
    WWASSERT(robj);
 ...
 * HISTORY: * 1/26/00    gth : Created. *
 *=============================================================================================*/
bool CompositeRenderObjClass::Intersect_OBBox(
    OBBoxIntersectionTestClass &boxtest) {
  bool res = false;
  for (int i = 0; i < Get_Num_Sub_Objects(); i++) {
    RenderObjClass *robj = Get_Sub_Object(i);
    WWASSERT(robj);
...
/***********************************************************************************************
 * CompositeRenderObjClass::Delete_Decal -- remove a logical decal from this
 *object            *
 *                                                                                             *
 * This internally removes all decals with the given ID.  The ID comes from the
 *generator      * which was used to create the decals. *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 * OUTPUT: *
