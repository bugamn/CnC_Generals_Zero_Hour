 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * BoxRenderObjClass::BoxRenderObjClass -- Constructor *
 *   BoxRenderObjClass::BoxRenderObjClass -- Constructor - init from a
 *definition              * BoxRenderObjClass::BoxRenderObjClass -- Copy
 *constructor                                  * BoxRenderObjClass::operator --
 *assignment operator                                        *
 *   BoxRenderObjClass::Get_Num_Polys -- returns number of polygons *
 *   BoxRenderObjClass::Get_Name -- returns name * BoxRenderObjClass::Set_Name
 *-- sets the name                                              *
 *   BoxRenderObjClass::Set_Color -- Sets the color of the box *
 *   BoxRenderObjClass::Init_Box_Render_System -- global initialization needed
 *for boxes to wo * BoxRenderObjClass::Shutdown_Box_Render_System -- cleanup box
 *render system                * BoxRenderObjClass::Set_Box_Display_Mask -- Sets
 *global display mask for all boxes         *
 ...
 *   AABoxRenderObjClass::AABoxRenderObjClass -- Constructor - init from a
 *definition          * AABoxRenderObjClass::AABoxRenderObjClass -- copy
 *constructor                              *
 ...
 *   AABoxRenderObjClass::update_cached_box -- update the world-space version of
 *this box      * AABoxRenderObjClass::Cast_Ray -- cast a ray against this box *
 ...
 *   AABoxRenderObjClass::Get_Obj_Space_Bounding_Sphere -- return the
 *object-space bounding sp * AABoxRenderObjClass::Get_Obj_Space_Bounding_Box --
 *returns the obj-space bounding box     *
 *   OBBoxRenderObjClass::OBBoxRenderObjClass -- Constructor *
 *   OBBoxRenderObjClass::OBBoxRenderObjClass -- Constructor - initiallize from
 *a definition   * OBBoxRenderObjClass::OBBoxRenderObjClass -- copy constructor
 ** OBBoxRenderObjClass::OBBoxRenderObjClass -- constructor - initialize from a
 *wwmath obbox  * OBBoxRenderObjClass::operator -- assignment operator *
 *   OBBoxRenderObjClass::Clone -- clone this obbox *
 *   OBBoxRenderObjClass::Class_ID -- returns the class ID of
 *OBBoxRenderObjClass              * OBBoxRenderObjClass::Render -- render this
 *obbox                                          *
 ...
 *   OBBoxRenderObjClass::Intersect_AABox -- test this box for intersection with
 *an AAbox      * OBBoxRenderObjClass::Intersect_OBBox -- test this box for
 *intersection with an OBBox      *
 *   OBBoxRenderObjClass::Get_Obj_Space_Bounding_Sphere -- return the obj-space
 *bounding spher * OBBoxRenderObjClass::Get_Obj_Space_Bounding_Box -- returns
 *the obj-space bounding box     * OBBoxRenderObjClass::Get_Box -- returns the
 *cached world-space box                        *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
...
BoxRenderObjClass::BoxRenderObjClass(const W3dBoxStruct &def) {
  ...
  int col_bits = (def.Attributes & W3D_BOX_ATTRIBUTE_COLLISION_TYPE_MASK) >>
                 W3D_BOX_ATTRIBUTE_COLLISION_TYPE_SHIFT;
...
/***********************************************************************************************
 * BoxRenderObjClass::Init_Box_Render_System -- global initialization needed for
 *boxes to work *
 *                                                                                             *
 ...
 *                                                                                             *
 * Releases resources allocated in Init * NOTE: this is a static function that
...
/***********************************************************************************************
 * BoxRenderObjClass::Set_Box_Display_Mask -- Sets global display mask for all
 *boxes           *
 *                                                                                             *
 * Boxes are debug objects and usually used for collision.  This mask is 'AND'ed
 *with each     * box's collision type to determine whether the box should be
 *rendered.                       *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * HISTORY: * 1/19/00    gth : Created. *
 *=============================================================================================*/
void BoxRenderObjClass::render_box(RenderInfoClass &rinfo,
 ...
 * HISTORY: * 1/19/00    gth : Created. *
 *=============================================================================================*/
void BoxRenderObjClass::vis_render_box(SpecialRenderInfoClass &rinfo,
                                       const Vector3 &center,
                                       const Vector3 &extent) {
  if (!IsInitted) return;
  ...
  // render!
  rinfo.VisRasterizer->Render_Triangles(verts, NUM_BOX_VERTS, _BoxFaces,
                                        NUM_BOX_FACES, Get_Bounding_Box());
}
 ...
 * HISTORY: * 1/19/00    gth : Created. *
 *=============================================================================================*/
AABoxRenderObjClass &AABoxRenderObjClass::operator=(
    const AABoxRenderObjClass &that) {
  if (this != &that) {
...
bool AABoxRenderObjClass::Cast_AABox(AABoxCollisionTestClass &boxtest) {
  ...
  if (CollisionMath::Collide(boxtest.Box, boxtest.Move, CachedBox,
                             boxtest.Result)) {
...
/***********************************************************************************************
 * AABoxRenderObjClass::Get_Obj_Space_Bounding_Sphere -- return the object-space
 *bounding sphe *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * HISTORY: * 1/19/00    gth : Created. *
 *=============================================================================================*/
void AABoxRenderObjClass::Get_Obj_Space_Bounding_Sphere(
    SphereClass &sphere) const {
  sphere.Init(ObjSpaceCenter, ObjSpaceExtent.Length());
}

/***********************************************************************************************
 * AABoxRenderObjClass::Get_Obj_Space_Bounding_Box -- returns the obj-space
 *bounding box       *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
...
/***********************************************************************************************
 * OBBoxRenderObjClass::OBBoxRenderObjClass -- Constructor - initiallize from a
 *definition     *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * HISTORY: * 1/19/00    gth : Created. *
 *=============================================================================================*/
OBBoxRenderObjClass &OBBoxRenderObjClass::operator=(
    const OBBoxRenderObjClass &that) {
  if (this != &that) {
    BoxRenderObjClass::operator=(that);
    CachedBox = that.CachedBox;
  }
...
/***********************************************************************************************
 * OBBoxRenderObjClass::Intersect_OBBox -- test this box for intersection with
 *an OBBox        *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * HISTORY: * 1/19/00    gth : Created. *
 *=============================================================================================*/
void OBBoxRenderObjClass::Get_Obj_Space_Bounding_Sphere(
    SphereClass &sphere) const {
  sphere.Init(ObjSpaceCenter, ObjSpaceExtent.Length());
}

/***********************************************************************************************
 * OBBoxRenderObjClass::Get_Obj_Space_Bounding_Box -- returns the obj-space
 *bounding box       *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
