 ...
 *	  Set_Opacity -- Reset the line opacity. * Line3DClass::Render -- render
 *the 3d line                             *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
...
const unsigned short Indices[] = {3, 5, 1, 7, 5, 3, 1, 5, 0, 5, 4, 0,
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 12/8/98    GTH : Created. * 02/16/2001 HY  : Ported to DX8
 **
 *=============================================================================================*/
...
void Line3DClass::Render(RenderInfoClass &rinfo) {
  ...
  DynamicIBAccessClass ib(BUFFER_TYPE_DYNAMIC_DX8, 36);
  {
    ...
    for (int i = 0; i < 36; i++) mem[i] = Indices[i];
  }
...
**
*/
int Line3DClass::Get_Num_Polys(void) const { return 12; }
