 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * DistLODDefClass -- default constructor for DistLODDefClass *
 ...
 ** DistLODClass::DistLODClass -- constructor * DistLODClass::DistLODClass --
 *copy constructor                                            *
 *   DistLODClass::~DistLODClass -- destructor * DistLODClass::Free -- releases
 *memory in use                                              *
 ...
 *   DistLODClass::Render -- Render this LOD. * DistLODClass::Special_Render --
 *custom render function                                    *
 *   DistLODCLass::Get_Num_Sub_Objects -- returns the number of subobjects
 *(levels of detail)  * DistLODClass::Get_Sub_Object -- returns pointer to the
 *specified sub-object (LOD)         * DistLODCLass::Set_Transform -- sets the
 *transform for this model                          * DistLODClass::Set_Position
 *-- set the position of this object                             *
 *   DistLODClass::Set_Animation -- set the animation state of this model *
 *   DistLODClass::Set_Animation -- set the animation state of this model *
 *   DistLODClass::Set_Animation -- set the animation state to a blend of two
 *anims            * DistLODClass::Set_Animation -- set the animation state to a
 *combination of anims          * DistLODClass::Get_Num_Bones -- returns the
 *number of bones                                * DistLODClass::Get_Bone_Name
 *-- returns the name of the specified bone                     *
 *   DistLODClass::Get_Bone_Index -- returns the index of the given bone (if
 *found)            * DistLODClass::Get_Bone_Transform -- returns the transform
 *of the given bone               * DistLODClass::Get_Bone_Transform -- returns
 *the transform of the given bone               * DistLODClass::Capture_Bone --
 *take control of a bone                                      *
 ...
 *   DistLODCLass::Get_Num_Snap_Points -- returns number of snap points in this
 *model          * DistLODClass::Get_Snap_Point -- returns the i'th snap point *
...
PrototypeClass *DistLODLoaderClass::Load_W3D(ChunkLoadClass &cload) {
  ...
  if (pCDistLODClass->Load_W3D(cload) != WW3D_ERROR_OK) {
    ...
    DistLODPrototypeClass *pCLODProto =
        W3DNEW DistLODPrototypeClass(pCDistLODClass);
    return pCLODProto;
  }
}
 ...
 * DistLODDefClass::DistLODDefClass -- manual constructor for DistLODDefClass *
 *                                                                                             *
 * This constructor allows you to create a DistLODDef Manually (and then use it
 *to create      * the desired DistLODClass).  The array of
 *DistLODModelDefStructs which you pass in will      * only be read from so you
 *are responsible for the memory used by them.                       *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 * OUTPUT: *
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 7/15/98    GTH : Created. *
 *=============================================================================================*/
DistLODDefClass::DistLODDefClass(const char *name, int lodcount,
                                 DistLODNodeDefStruct *modeldefs)
...
bool DistLODDefClass::read_header(ChunkLoadClass &cload) {
  ...
  */
  ...
  if (cload.Read(&lodHeader, sizeof(W3dLODModelHeaderStruct)) !=
 ...
 * HISTORY: * 7/15/98    GTH : Created. *
 *=============================================================================================*/
bool DistLODDefClass::read_node(ChunkLoadClass &cload,
                                DistLODNodeDefStruct *node) {
  return true;
}
...
DistLODClass::DistLODClass(const DistLODDefClass &def) {
  ...
  for (int i = 0; i < LodCount; i++) {
    ...
    Lods[i].Model =
        WW3DAssetManager::Get_Instance()->Create_Render_Obj(def.Lods[i].Name);
 ...
 * OUTPUT: *
 *                                                                                             *
 * WARNINGS: * returns the number of polys in the *current* lod. *
 *                                                                                             *
 * HISTORY: * 3/3/99     GTH : Created. *
 *=============================================================================================*/
...
/***********************************************************************************************
 * DistLODCLass::Get_Num_Sub_Objects -- returns the number of subobjects (levels
 *of detail)    *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 3/1/99     GTH : Created. *
 *=============================================================================================*/
int DistLODClass::Get_Num_Sub_Objects(void) const { return LodCount; }

/***********************************************************************************************
 * DistLODClass::Get_Sub_Object -- returns pointer to the specified sub-object
 *(LOD)           *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
...
int DistLODClass::Add_Sub_Object_To_Bone(RenderObjClass *subobj,
                                         int bone_index) {
  ...
  if (subobj->Class_ID() == CLASSID_DISTLOD) {
    ...
    for (int i = 0; i < LodCount; i++) {
      Lods[i].Model->Add_Sub_Object_To_Bone(
          sub_lod_obj->Lods[MIN(i, sub_lod_obj->LodCount - 1)].Model,
          bone_index);
    }
  } else {
 ...
 * HISTORY: * 3/3/99     GTH : Created. *
 *=============================================================================================*/
void DistLODClass::Set_Animation(HAnimClass *motion0, float frame0,
...
/***********************************************************************************************
 * DistLODClass::Set_Animation -- set the animation state to a combination of
 *anims            *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * HISTORY: * 3/3/99     GTH : Created. *
 *=============================================================================================*/
void DistLODClass::Control_Bone(int bindex, const Matrix3D &tm,
...
void DistLODClass::Update_Lod(const CameraClass &camera) {
  ...
  float dist =
      (camera.Get_Position() - Lods[CurLod].Model->Get_Bounding_Sphere().Center)
          .Quick_Length();
