 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * HRawAnimClass::HRawAnimClass -- constructor *
 *   HRawAnimClass::~HRawAnimClass -- Destructor * HRawAnimClass::Free --
 ...
 *   HRawAnimClass::Get_Translation -- returns the translation vector for the
 *given frame         * HRawAnimClass::Get_Orientation -- returns a quaternion
 *for the orientation of the pivot      * HRawAnimClass::Get_XRotation --
 *Returns the X euler angle for the given pivot, frame         *
 *   HRawAnimClass::Get_YRotation -- returns the Y Euler angle for the given
 *pivot, frame         * HRawAnimClass::Get_ZRotation -- returns the Z Euler
 *angle for the given pivot, frame         * HRawAnimClass::read_bit_channel --
 *read a bit channel from the file                          *
 *   HRawAnimClass::add_bit_channel -- install a bit channel into the animation
 ** HRawAnimClass::Get_Visibility -- return visibility state for given
 *pivot/frame               *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
...
HRawAnimClass::HRawAnimClass(void)
    : NumFrames(0), NumNodes(0), FrameRate(0), NodeMotion(NULL) {
 ...
 * HISTORY: * 08/11/1997 GH  : Created. *
 *=============================================================================================*/
HRawAnimClass::~HRawAnimClass(void) { Free(); }
...
int HRawAnimClass::Load_W3D(ChunkLoadClass& cload) {
  ...
  */
  ...
  /*
  ** Check if the animation version is pre-3.0.  If so, we need to add 1 to all
  *of the
  ** bone indexes.  In version 3.0 onward, all htree's use bone 0 as the root
  *node.
  */
  ...
  while (cload.Open_Chunk()) {
    switch (cload.Cur_Chunk_ID()) {
      case W3D_CHUNK_ANIMATION_CHANNEL:
        ...
        // (gth) if the channel is referring to a node which is outside the
        // range, just throw away the channel.  This probably means the
        // animation must be re-exported
 ...
 * HISTORY: * 08/11/1997 GH  : Created. *
 *=============================================================================================*/
bool HRawAnimClass::read_channel(ChunkLoadClass& cload,
                                 MotionChannelClass** newchan, bool pre30) {
 ...
 *=============================================================================================*/
bool HRawAnimClass::read_bit_channel(ChunkLoadClass& cload,
                                     BitChannelClass** newchan, bool pre30) {
 ...
 * HISTORY: * 08/11/1997 GH  : Created. *
 *=============================================================================================*/
void HRawAnimClass::Get_Translation(Vector3& trans, int pividx,
                                    float frame) const {
...
/***********************************************************************************************
 * HRawAnimClass::Get_Orientation -- returns a quaternion for the orientation of
 *the              *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * HISTORY: * 08/11/1997 GH  : Created. *
 *=============================================================================================*/
void HRawAnimClass::Get_Orientation(Quaternion& q, int pividx,
                                    float frame) const {
  //	int frame0 = (int)frame;
  int frame0 = WWMath::Float_To_Long(frame - 0.499999f);
  int frame1 = frame0 + 1;
...
/***********************************************************************************************
 * HRawAnimClass::Get_Transform -- returns the transform matrix for the given
 *frame            *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * HISTORY: * 08/11/1997 GH  : Created. *
 *=============================================================================================*/
void HRawAnimClass::Get_Transform(Matrix3D& mtx, int pividx,
                                  float frame) const {
  struct NodeMotionStruct* motion = &NodeMotion[pividx];

  //	if ( (motion->X == NULL) && (motion->Y == NULL) && (motion->Z == NULL) )
  //{ 		 trans.Set(0.0f,0.0f,0.0f); 		return;
  //	}
...
/***********************************************************************************************
 * HRawAnimClass::Is_Node_Motion_Present -- return true if there is motion
 *defined for this frame *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 * OUTPUT: *
