 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * HModelDefClass::HModelDefClass -- Constructor *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 12/15/97   GTH : Created. *
 *=============================================================================================*/
HModelDefClass::HModelDefClass(void)
    : SubObjectCount(0), SubObjects(NULL), SnapPoints(NULL) {}
...
int HModelDefClass::Load_W3D(ChunkLoadClass& cload) {
  ...
  */
  ...
  if (cload.Read(&header, sizeof(W3dHModelHeaderStruct)) !=
      sizeof(W3dHModelHeaderStruct)) {
    goto Error;
  }
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 08/11/1997 GH  : Created. * 10/22/97   GH  : Check for mesh
 *connections with PivotID=-1                               *
 *=============================================================================================*/
bool HModelDefClass::read_connection(ChunkLoadClass& cload,
                                     HmdlNodeDefStruct* node, bool pre30) {
  W3dHModelNodeStruct con;
  if (cload.Read(&con, sizeof(W3dHModelNodeStruct)) !=
      sizeof(W3dHModelNodeStruct)) {
    return false;
  }
