 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * MeshLoaderClass::Load -- reads in a mesh and creates a prototype
 *for it                   * HModelLoaderClass::Load -- reads in an hmodel
 *definition and creates a prototype for it   *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
...
class HModelPrototypeClass : public W3DMPO, public PrototypeClass {
 ...
 public:
  ...
  virtual RenderObjClass *Create(void) {
    return NEW_REF(HLodClass, (*HModelDef));
  }
