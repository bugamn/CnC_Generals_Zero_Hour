...
//
/////////////////////////////////////////////////////////////////////
ParameterClass *ParameterClass::Construct(Type type, void *data,
                                          const char *name) {
  ...
  switch (type) {
    ...
    case TYPE_DEFINITIONIDLIST:
      new_param =
          W3DNEW DefIDListParameterClass((DynamicVectorClass<int> *)data);
      new_param->Set_Name(name);
      ((DefIDListParameterClass *)new_param)
          ->Set_Class_ID(CLASSID_GAME_OBJECTS);
      break;
    ...
    case TYPE_FILENAMELIST:
      new_param = W3DNEW FilenameListParameterClass(
          (DynamicVectorClass<StringClass> *)data);
      new_param->Set_Name(name);
      break;
...
//
/////////////////////////////////////////////////////////////////////
const StringParameterClass &StringParameterClass::operator=(
    const StringParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
bool StringParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
void StringParameterClass::Copy_Value(const ParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
const char *StringParameterClass::Get_String(void) const {
...
//
/////////////////////////////////////////////////////////////////////
void StringParameterClass::Set_String(const char *string) {
  if (m_String != NULL) {
    Set_Modified();
    (*m_String) = string;
  }
...
//
/////////////////////////////////////////////////////////////////////
FilenameParameterClass::FilenameParameterClass(
    const FilenameParameterClass &src)
...
//
/////////////////////////////////////////////////////////////////////
const FilenameParameterClass &FilenameParameterClass::operator=(
    const FilenameParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
bool FilenameParameterClass::operator==(const ParameterClass &src) {
  return StringParameterClass::operator==(src);
}
...
//
/////////////////////////////////////////////////////////////////////
void FilenameParameterClass::Copy_Value(const ParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
SoundFilenameParameterClass::SoundFilenameParameterClass(
    const SoundFilenameParameterClass &src)
...
//
/////////////////////////////////////////////////////////////////////
const SoundFilenameParameterClass &SoundFilenameParameterClass::operator=(
    const SoundFilenameParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
bool SoundFilenameParameterClass::operator==(
    const SoundFilenameParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
EnumParameterClass::EnumParameterClass(int *value) : m_Value(value) { return; }
...
//
/////////////////////////////////////////////////////////////////////
const EnumParameterClass &EnumParameterClass::operator=(
    const EnumParameterClass &src) {
  m_List.Delete_All();
...
bool EnumParameterClass::operator==(const EnumParameterClass &src) {
  ...
  if (m_Value != NULL && src.m_Value != NULL && (*m_Value) == (*src.m_Value)) {
    retval = true;
  }
...
//
/////////////////////////////////////////////////////////////////////
void EnumParameterClass::Add_Value(const char *display_name, int value) {
...
//
/////////////////////////////////////////////////////////////////////
PhysDefParameterClass::PhysDefParameterClass(int *id) : m_Value(id) { return; }
...
//
/////////////////////////////////////////////////////////////////////
const PhysDefParameterClass &PhysDefParameterClass::operator=(
    const PhysDefParameterClass &src) {
  m_Value = src.m_Value;
  ParameterClass::operator=(src);
  return *this;
}
...
//
/////////////////////////////////////////////////////////////////////
bool PhysDefParameterClass::operator==(const PhysDefParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
bool PhysDefParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
void PhysDefParameterClass::Copy_Value(const ParameterClass & /*src*/) {
  //
...
//
/////////////////////////////////////////////////////////////////////
ModelDefParameterClass::ModelDefParameterClass(int *id) : m_Value(id) {
  return;
}
...
//
/////////////////////////////////////////////////////////////////////
ModelDefParameterClass::ModelDefParameterClass(
    const ModelDefParameterClass &src)
    : m_Value(NULL) {
  (*this) = src;
  return;
}
...
//
/////////////////////////////////////////////////////////////////////
const ModelDefParameterClass &ModelDefParameterClass::operator=(
    const ModelDefParameterClass &src) {
  m_Value = src.m_Value;
  ParameterClass::operator=(src);
  return *this;
...
//
/////////////////////////////////////////////////////////////////////
bool ModelDefParameterClass::operator==(const ModelDefParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
bool ModelDefParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
void ModelDefParameterClass::Copy_Value(const ParameterClass & /*src*/) {
  //
  //	We don't allow the value to be copied
  //
  return;
...
//
/////////////////////////////////////////////////////////////////////
DefParameterClass::DefParameterClass(int *id) : m_Value(id) { return; }
...
//
/////////////////////////////////////////////////////////////////////
const DefParameterClass &DefParameterClass::operator=(
    const DefParameterClass &src) {
  m_Value = src.m_Value;
...
//
/////////////////////////////////////////////////////////////////////
bool DefParameterClass::operator==(const DefParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
bool DefParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
void DefParameterClass::Copy_Value(const ParameterClass &src) {
  if (src.Get_Type() == Get_Type()) {
...
GenericDefParameterClass::GenericDefParameterClass(int *id)
    : m_ClassID(0), DefParameterClass(id) {
  return;
}
...
//
/////////////////////////////////////////////////////////////////////
GenericDefParameterClass::GenericDefParameterClass(
    const GenericDefParameterClass &src)
    : m_ClassID(0), DefParameterClass(src) {
  (*this) = src;
  return;
}
...
//
/////////////////////////////////////////////////////////////////////
const GenericDefParameterClass &GenericDefParameterClass::operator=(
    const GenericDefParameterClass &src) {
  DefParameterClass::operator=(src);
  return *this;
}
...
//
/////////////////////////////////////////////////////////////////////
bool GenericDefParameterClass::operator==(const GenericDefParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
bool GenericDefParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;

  if (src.Get_Type() == Get_Type()) {
    retval = GenericDefParameterClass::operator==(
        (const GenericDefParameterClass &)src);
  }
...
//
/////////////////////////////////////////////////////////////////////
void GenericDefParameterClass::Copy_Value(const ParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
GameObjDefParameterClass::GameObjDefParameterClass(
    const GameObjDefParameterClass &src)
...
//
/////////////////////////////////////////////////////////////////////
const GameObjDefParameterClass &GameObjDefParameterClass::operator=(
    const GameObjDefParameterClass &src) {
  DefParameterClass::operator=(src);
  return *this;
}
...
//
/////////////////////////////////////////////////////////////////////
bool GameObjDefParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;

  if (src.Get_Type() == Get_Type()) {
    retval = GameObjDefParameterClass::operator==(
        (const GameObjDefParameterClass &)src);
  }
...
//
/////////////////////////////////////////////////////////////////////
void GameObjDefParameterClass::Copy_Value(const ParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
WeaponObjDefParameterClass::WeaponObjDefParameterClass(
    const WeaponObjDefParameterClass &src)
...
//
/////////////////////////////////////////////////////////////////////
const WeaponObjDefParameterClass &WeaponObjDefParameterClass::operator=(
    const WeaponObjDefParameterClass &src) {
  m_Value = src.m_Value;
  ParameterClass::operator=(src);
  return *this;
...
//
/////////////////////////////////////////////////////////////////////
bool WeaponObjDefParameterClass::operator==(
    const WeaponObjDefParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
bool WeaponObjDefParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;

  if (src.Get_Type() == Get_Type()) {
    retval = WeaponObjDefParameterClass::operator==(
        (const WeaponObjDefParameterClass &)src);
  }
...
//
/////////////////////////////////////////////////////////////////////
void WeaponObjDefParameterClass::Copy_Value(const ParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
AmmoObjDefParameterClass::AmmoObjDefParameterClass(
    const AmmoObjDefParameterClass &src)
    : GameObjDefParameterClass(NULL) {
  (*this) = src;
  return;
}
...
//
/////////////////////////////////////////////////////////////////////
const AmmoObjDefParameterClass &AmmoObjDefParameterClass::operator=(
    const AmmoObjDefParameterClass &src) {
  m_Value = src.m_Value;
  ParameterClass::operator=(src);
  return *this;
...
//
/////////////////////////////////////////////////////////////////////
bool AmmoObjDefParameterClass::operator==(const AmmoObjDefParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
bool AmmoObjDefParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;

  if (src.Get_Type() == Get_Type()) {
    retval = AmmoObjDefParameterClass::operator==(
        (const AmmoObjDefParameterClass &)src);
  }
...
//
/////////////////////////////////////////////////////////////////////
void AmmoObjDefParameterClass::Copy_Value(const ParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
ExplosionObjDefParameterClass::ExplosionObjDefParameterClass(
    const ExplosionObjDefParameterClass &src)
    : GameObjDefParameterClass(NULL) {
  (*this) = src;
  return;
}
...
//
/////////////////////////////////////////////////////////////////////
const ExplosionObjDefParameterClass &ExplosionObjDefParameterClass::operator=(
    const ExplosionObjDefParameterClass &src) {
  m_Value = src.m_Value;
  ParameterClass::operator=(src);
  return *this;
...
//
/////////////////////////////////////////////////////////////////////
bool ExplosionObjDefParameterClass::operator==(
    const ExplosionObjDefParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
bool ExplosionObjDefParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;

  if (src.Get_Type() == Get_Type()) {
    retval = ExplosionObjDefParameterClass::operator==(
        (const ExplosionObjDefParameterClass &)src);
  }
...
//
/////////////////////////////////////////////////////////////////////
void ExplosionObjDefParameterClass::Copy_Value(const ParameterClass &src) {
  if (src.Is_Type(ParameterClass::TYPE_AMMOOBJDEFINITIONID)) {
...
//
/////////////////////////////////////////////////////////////////////
SoundDefParameterClass::SoundDefParameterClass(
    const SoundDefParameterClass &src)
    : DefParameterClass(src) {
  (*this) = src;
  return;
}
...
//
/////////////////////////////////////////////////////////////////////
const SoundDefParameterClass &SoundDefParameterClass::operator=(
    const SoundDefParameterClass &src) {
  DefParameterClass::operator=(src);
  return *this;
}
...
//
/////////////////////////////////////////////////////////////////////
bool SoundDefParameterClass::operator==(const SoundDefParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
bool SoundDefParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
ScriptParameterClass::ScriptParameterClass(StringClass *name,
                                           StringClass *params)
    : m_ScriptName(name), m_ScriptParams(params) {
  return;
}
...
ScriptParameterClass::ScriptParameterClass(const ScriptParameterClass &src)
    : m_ScriptName(NULL), m_ScriptParams(NULL) {
  (*this) = src;
  return;
}
...
//
/////////////////////////////////////////////////////////////////////
const ScriptParameterClass &ScriptParameterClass::operator=(
    const ScriptParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
bool ScriptParameterClass::operator==(const ScriptParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
bool ScriptParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
void ScriptParameterClass::Copy_Value(const ParameterClass &src) {
...
DefIDListParameterClass::DefIDListParameterClass(DynamicVectorClass<int> *list)
    : m_IDList(list), m_ClassID(0), m_SelectedClassID(NULL) {
  return;
}
...
//
/////////////////////////////////////////////////////////////////////
DefIDListParameterClass::DefIDListParameterClass(
    const DefIDListParameterClass &src)
    : m_IDList(NULL), m_ClassID(0), m_SelectedClassID(NULL) {
  (*this) = src;
  return;
}
...
//
/////////////////////////////////////////////////////////////////////
const DefIDListParameterClass &DefIDListParameterClass::operator=(
    const DefIDListParameterClass &src) {
...
bool DefIDListParameterClass::operator==(const ParameterClass &src) {
  ...
  if (src.Get_Type() == Get_Type()) {
    retval = DefIDListParameterClass::operator==(
        (const DefIDListParameterClass &)src);
  }
...
//
/////////////////////////////////////////////////////////////////////
ZoneParameterClass::ZoneParameterClass(OBBoxClass *box) : m_OBBox(box) {
  return;
}
...
//
/////////////////////////////////////////////////////////////////////
const ZoneParameterClass &ZoneParameterClass::operator=(
    const ZoneParameterClass &src) {
  m_OBBox = src.m_OBBox;
...
//
/////////////////////////////////////////////////////////////////////
bool ZoneParameterClass::operator==(const ZoneParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
bool ZoneParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
void ZoneParameterClass::Copy_Value(const ParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
FilenameListParameterClass::FilenameListParameterClass(
...
/////////////////////////////////////////////////////////////////////
FilenameListParameterClass::FilenameListParameterClass(
    const FilenameListParameterClass &src)
    : m_FilenameList(NULL) {
  (*this) = src;
  return;
}
...
//
/////////////////////////////////////////////////////////////////////
const FilenameListParameterClass &FilenameListParameterClass::operator=(
    const FilenameListParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
bool FilenameListParameterClass::operator==(
    const FilenameListParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
bool FilenameListParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;

  if (src.Get_Type() == Get_Type()) {
    retval = FilenameListParameterClass::operator==(
        (const FilenameListParameterClass &)src);
  }
...
//
/////////////////////////////////////////////////////////////////////
void FilenameListParameterClass::Copy_Value(const ParameterClass &src) {
...
ScriptListParameterClass::ScriptListParameterClass(
    ...
    : m_NameList(name_list), m_ParamList(param_list) {
  return;
}
...
/////////////////////////////////////////////////////////////////////
ScriptListParameterClass::ScriptListParameterClass(
    const ScriptListParameterClass &src)
    : m_NameList(NULL), m_ParamList(NULL) {
  (*this) = src;
  return;
}
...
//
/////////////////////////////////////////////////////////////////////
const ScriptListParameterClass &ScriptListParameterClass::operator=(
    const ScriptListParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
bool ScriptListParameterClass::operator==(const ScriptListParameterClass &src) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////
bool ScriptListParameterClass::Are_Lists_Identical(
...
//
/////////////////////////////////////////////////////////////////////
bool ScriptListParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;

  if (src.Get_Type() == Get_Type()) {
    retval = ScriptListParameterClass::operator==(
        (const ScriptListParameterClass &)src);
  }
...
//
/////////////////////////////////////////////////////////////////////
void ScriptListParameterClass::Copy_Value(const ParameterClass &src) {
...
//
/////////////////////////////////////////////////////////////////////
SeparatorParameterClass::SeparatorParameterClass(
    const SeparatorParameterClass &src) {
  (*this) = src;
  return;
}
...
//
/////////////////////////////////////////////////////////////////////
const SeparatorParameterClass &SeparatorParameterClass::operator=(
    const SeparatorParameterClass &src) {
  ParameterClass::operator=(src);
  return *this;
}
...
//
/////////////////////////////////////////////////////////////////////
bool SeparatorParameterClass::operator==(const SeparatorParameterClass &src) {
  return true;
}
...
//
/////////////////////////////////////////////////////////////////////
bool SeparatorParameterClass::operator==(const ParameterClass &src) {
  bool retval = false;

  if (src.Get_Type() == Get_Type()) {
    retval = SeparatorParameterClass::operator==(
        (const SeparatorParameterClass &)src);
  }
...
//
/////////////////////////////////////////////////////////////////////
void SeparatorParameterClass::Copy_Value(const ParameterClass &src) {
  ParameterClass::Copy_Value(src);
  return;
}
