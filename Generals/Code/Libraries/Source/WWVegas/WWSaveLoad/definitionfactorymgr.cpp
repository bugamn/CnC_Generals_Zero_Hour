...
//
////////////////////////////////////////////////////////////////////////////
DefinitionFactoryClass *DefinitionFactoryMgrClass::Find_Factory(
    uint32 class_id) {
...
//
////////////////////////////////////////////////////////////////////////////
DefinitionFactoryClass *DefinitionFactoryMgrClass::Get_First(
  ...
  for (DefinitionFactoryClass *curr_factory = _FactoryListHead;
    ...
    //	Is this the factory we were looking for?
    //
    if (::SuperClassID_From_ClassID(curr_factory->Get_Class_ID()) ==
        superclass_id) {
      factory = curr_factory;
    }
  }
...
//
////////////////////////////////////////////////////////////////////////////
DefinitionFactoryClass *DefinitionFactoryMgrClass::Get_Next(
    DefinitionFactoryClass *curr_factory, uint32 superclass_id) {
  DefinitionFactoryClass *factory = 0;
  ...
  //
  while ((factory == NULL) &&
         ((curr_factory = curr_factory->m_NextFactory) != NULL)) {
    //
    //	Is this the factory we were looking for?
    //
    if (::SuperClassID_From_ClassID(curr_factory->Get_Class_ID()) ==
...
//
////////////////////////////////////////////////////////////////////////////
void DefinitionFactoryMgrClass::Register_Factory(
...
//
////////////////////////////////////////////////////////////////////////////
void DefinitionFactoryMgrClass::Unregister_Factory(
    DefinitionFactoryClass *factory) {
  WWASSERT(factory != 0);
...
//
////////////////////////////////////////////////////////////////////////////
void DefinitionFactoryMgrClass::Unlink_Factory(
    DefinitionFactoryClass *factory) {
  WWASSERT(factory != 0);
