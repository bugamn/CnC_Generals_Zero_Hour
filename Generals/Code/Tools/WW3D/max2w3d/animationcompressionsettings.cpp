 ...
 *                                                                                             *
 *                     $Archive::
 * /Commando/Code/Tools/max2w3d/animationcompressionsettings.cpp $*
 *                                                                                             *
...
////////////////////////////////////////////////////////////////////////////////////////
AnimationCompressionSettingsDialogClass::
    AnimationCompressionSettingsDialogClass(Interface *maxinterface,
                                            HWND parent_wnd)
...
//
////////////////////////////////////////////////////////////////////////////////////////
int AnimationCompressionSettingsDialogClass::Do_Modal(void) {
  int retval =
      ::DialogBoxParam(AppInstance, MAKEINTRESOURCE(IDD_ANIMATION_COMPRESSION),
...
//
////////////////////////////////////////////////////////////////////////////////////////
BOOL CALLBACK AnimationCompressionSettingsDialogClass::Real_Message_Proc(
  ...
  if (message == WM_INITDIALOG) {
    ...
    dialog_obj =
        (AnimationCompressionSettingsDialogClass *)::GetProp(wnd, "DIALOG_OBJ");
  }
...
//
////////////////////////////////////////////////////////////////////////////////////////
BOOL AnimationCompressionSettingsDialogClass::Message_Proc(UINT message,
                                                           WPARAM wparam,
                                                           LPARAM lparam) {
  BOOL retval = FALSE;
...
//
////////////////////////////////////////////////////////////////////////////////////////
void AnimationCompressionSettingsDialogClass::Initialize_Controls(void) {
...
//
////////////////////////////////////////////////////////////////////////////////////////
void AnimationCompressionSettingsDialogClass::Save_Settings(void) {
  //
  //	Read the compression type setting
  //
  int flavor = ComboBox_GetCurSel(
      ::GetDlgItem(Wnd, IDC_COMPRESS_ANIMATION_FLAVOR_COMBO));
  Options->CompressAnimationFlavor = flavor;

  //
  //	Determine whether or not we want to force reduction
  //
  Options->ReduceAnimation =
      (IsDlgButtonChecked(Wnd, IDC_REDUCE_ANIMATION_CHECK) == 1);

  //
  //	Read the reduction percent setting
  //
  int reduce_percent =
      ComboBox_GetCurSel(::GetDlgItem(Wnd, IDC_REDUCE_ANIMATION_COMBO)) + 1;
  Options->ReduceAnimationPercent = reduce_percent;

  //
  //	Read the amount of compression error we'll allow in the translational
  //component
  //
  char string[128];
  ...
  //
  //	Read the amount of compression error we'll allow in the rotational
  //component
  //
