...
/* $Header: /Commando/Code/Tools/max2w3d/dllmain.cpp 8     7/24/01 5:11p
 * Moumine_ballo $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * DllMain -- Entry point for the dll * LibDescription -- Returns
 *description of this library                                     *
 *   LibNumberClasses -- Returns number of classes in this library *
 *   LibClassDesc -- Returns a ClassDesc for the specified class * LibVersion --
...
DLLEXPORT int LibNumberClasses() {
  return 9;  // Moumine 7/24/2001    4:38:27 PM was 10. Removed
             // Mesh_Deformation(#6)
}
...
DLLEXPORT ClassDesc* LibClassDesc(int i) {
  switch (i) {
    ...
    // Moumine 7/24/2001    4:33:52 PM Removed #6 and shifted up instead of
    // returning NULL
