 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * BonePickerClass::Filter -- determine whether the passed node is
 *suitable                  * BonePickerClass::HitTest -- MAX HitTest method *
 ...
 * HISTORY: * 10/26/1997 GH  : Created. *
 *=============================================================================================*/
BOOL BonePickerClass::HitTest(IObjParam *ip, HWND hwnd, ViewExp *vpt, IPoint2 m,
                              int flags) {
...
BOOL BonePickerClass::filter(INode *inode) { return Filter(inode); }
