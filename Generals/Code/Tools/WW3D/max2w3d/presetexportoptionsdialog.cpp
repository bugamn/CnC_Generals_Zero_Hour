 ...
 *                                                                                             *
 *                     $Archive::
 * /Commando/Code/Tools/max2w3d/presetexportoptionsdialog.cpp  $*
 *                                                                                             *
...
static const char *BROWSE_FILTER =
...
PresetExportOptionsDialogClass::PresetExportOptionsDialogClass(
    Interface *maxinterface, HWND parent_wnd)
...
//
////////////////////////////////////////////////////////////////////////////////////////
int PresetExportOptionsDialogClass::Do_Modal(void) {
  int retval = ::DialogBoxParam(AppInstance,
                                MAKEINTRESOURCE(IDD_W3D_PRESET_EXPORT_OPTIONS),
...
//
////////////////////////////////////////////////////////////////////////////////////////
BOOL CALLBACK PresetExportOptionsDialogClass::Real_Message_Proc(HWND wnd,
                                                                UINT message,
                                                                WPARAM wparam,
                                                                LPARAM lparam) {
...
//
////////////////////////////////////////////////////////////////////////////////////////
BOOL CALLBACK PresetExportOptionsDialogClass::Settings_Pane_Message_Proc(
...
//
////////////////////////////////////////////////////////////////////////////////////////
BOOL PresetExportOptionsDialogClass::Pane_Message_Proc(UINT message,
                                                       WPARAM wparam,
                                                       LPARAM lparam) {
  BOOL retval = FALSE;
    ...
    case WM_COMMAND: {
      ...
      switch (LOWORD(wparam)) {
        case IDC_EXPORT_MESH_SMOOTH_CHECK:
          Options->SmoothBetweenMeshes =
              (SendMessage(control_wnd, BM_GETCHECK, 0, 0L) == 1);
          break;

        case IDC_EXPORT_MESH_AABTREES:
          Options->DisableExportAABTrees =
              (SendMessage(control_wnd, BM_GETCHECK, 0, 0L) != 1);
          break;
        ...
        case IDC_USE_SKELETON_CHECK:
          Options->LoadHierarchy =
              (SendMessage(control_wnd, BM_GETCHECK, 0, 0L) == 1);
          break;

        case IDC_COMPRESS_ANIMATION_CHECK:
          Options->CompressAnimation =
              (SendMessage(control_wnd, BM_GETCHECK, 0, 0L) == 1);
          break;
        ...
        case IDC_EXPORT_MESH_MAT_TO_TEXTURE:
          Options->EnableMaterialColorToTextureConversion =
              (SendMessage(control_wnd, BM_GETCHECK, 0, 0L) == 1);
          break;
...
//
////////////////////////////////////////////////////////////////////////////////////////
BOOL PresetExportOptionsDialogClass::Message_Proc(UINT message, WPARAM wparam,
                                                  LPARAM lparam) {
  BOOL retval = FALSE;
...
//
////////////////////////////////////////////////////////////////////////////////////////
BOOL PresetExportOptionsDialogClass::On_Command(WPARAM wparam, LPARAM lparam) {
  BOOL retval = FALSE;
...
//
////////////////////////////////////////////////////////////////////////////////////////
void PresetExportOptionsDialogClass::Show_Settings_Pane(int pane_id) {
...
//
////////////////////////////////////////////////////////////////////////////////////////
void PresetExportOptionsDialogClass::Create_Settings_Panes(void) {
  PaneWnds[PANE_HLOD] =
      ::CreateDialogParam(AppInstance, MAKEINTRESOURCE(IDD_EXPORT_PANE_HLOD),
                          Wnd, Settings_Pane_Message_Proc, (LPARAM)this);

  PaneWnds[PANE_ANIM_HLOD] = ::CreateDialogParam(
      AppInstance, MAKEINTRESOURCE(IDD_EXPORT_PANE_ANIMATED_HLOD), Wnd,
      Settings_Pane_Message_Proc, (LPARAM)this);

  PaneWnds[PANE_ANIM] = ::CreateDialogParam(
      AppInstance, MAKEINTRESOURCE(IDD_EXPORT_PANE_ANIMATION), Wnd,
      Settings_Pane_Message_Proc, (LPARAM)this);

  PaneWnds[PANE_TERRAIN] =
      ::CreateDialogParam(AppInstance, MAKEINTRESOURCE(IDD_EXPORT_PANE_TERRAIN),
                          Wnd, Settings_Pane_Message_Proc, (LPARAM)this);

  PaneWnds[PANE_SKELETON] = ::CreateDialogParam(
      AppInstance, MAKEINTRESOURCE(IDD_EXPORT_PANE_SKELETON), Wnd,
      Settings_Pane_Message_Proc, (LPARAM)this);

  PaneWnds[PANE_MESH] =
      ::CreateDialogParam(AppInstance, MAKEINTRESOURCE(IDD_EXPORT_PANE_MESH),
                          Wnd, Settings_Pane_Message_Proc, (LPARAM)this);
  ...
  for (int index = 0; index < PANE_MAX; index++) {
    ...
    //
    ::SetWindowPos(
        pane_wnd, ::GetDlgItem(Wnd, IDC_GROUP_BOX),
        group_rect.left + (width / 2) - ((rect.right - rect.left) / 2),
        group_rect.top + (height / 2) - ((rect.bottom - rect.top) / 2), 0, 0,
        SWP_NOSIZE);
  }
...
//
////////////////////////////////////////////////////////////////////////////////////////
void PresetExportOptionsDialogClass::Destroy_Settings_Panes(void) {
  //
...
//
////////////////////////////////////////////////////////////////////////////////////////
void PresetExportOptionsDialogClass::Determine_Preset_Type(void) {
  //
  ...
  if (Options->EnableTerrainMode) {
    ...
    if (Options->ExportAnimation == false) {
      ...
      //
      Show_Settings_Pane(PANE_SKELETON);
      SendDlgItemMessage(Wnd, IDC_SKELETON_RADIO, BM_SETCHECK, (WPARAM)TRUE,
                         0L);
    } else {
      //
      //	Select the anim UI
  ...
  } else if (Options->ExportHierarchy == false &&
...
//
////////////////////////////////////////////////////////////////////////////////////////
void PresetExportOptionsDialogClass::Initialize_Controls(void) {
  //
  ...
  for (int index = 0; index < PANE_MAX; index++) {
    ...
    if (::GetDlgItem(pane_wnd, IDC_RANGE_LOW_SPIN) != NULL) {
      ...
      low_spin = ::SetupIntSpinner(pane_wnd, IDC_RANGE_LOW_SPIN,
                                   IDC_RANGE_LOW_EDIT, startframe, endframe, 0);

      high_spin =
          ::SetupIntSpinner(pane_wnd, IDC_RANGE_HIGH_SPIN, IDC_RANGE_HIGH_EDIT,
                            startframe, endframe, 0);

      ::SetProp(::GetDlgItem(pane_wnd, IDC_RANGE_LOW_SPIN), "ISpinnerControl",
                (HANDLE)low_spin);
      ::SetProp(::GetDlgItem(pane_wnd, IDC_RANGE_HIGH_SPIN), "ISpinnerControl",
                (HANDLE)high_spin);
    }
  }
...
//
////////////////////////////////////////////////////////////////////////////////////////
void PresetExportOptionsDialogClass::Update_Controls(void) {
  //
  //	Loop over all the panes and update any of the controls therein
  //
  for (int index = 0; index < PANE_MAX; index++) {
    ...
    //
    CheckDlgButton(pane_wnd, IDC_EXPORT_MESH_SMOOTH_CHECK,
                   Options->SmoothBetweenMeshes);
    CheckDlgButton(pane_wnd, IDC_EXPORT_MESH_AABTREES,
                   !Options->DisableExportAABTrees);
#if ENABLE_MESH_OPTIMIZING
    CheckDlgButton(pane_wnd, IDC_EXPORT_MESH_OPTIMIZE,
                   Options->EnableOptimizeMeshData);
#endif
    CheckDlgButton(pane_wnd, IDC_USE_SKELETON_CHECK, Options->LoadHierarchy);
    CheckDlgButton(pane_wnd, IDC_COMPRESS_ANIMATION_CHECK,
                   Options->CompressAnimation);
    CheckDlgButton(pane_wnd, IDC_EXPORT_MESH_MAT_TO_TEXTURE,
                   Options->EnableMaterialColorToTextureConversion);

    //
    //	Enable/disable the compression settings button
    //
    HWND compress_settings_btn =
        ::GetDlgItem(pane_wnd, IDC_COMPRESSION_SETTINGS);
    ...
    if (low_spin_wnd != NULL && high_spin_wnd != NULL) {
      ...
      high_spin =
          (ISpinnerControl *)::GetProp(high_spin_wnd, "ISpinnerControl");
...
//
////////////////////////////////////////////////////////////////////////////////////////
void PresetExportOptionsDialogClass::Save_Settings(void) {
  //
