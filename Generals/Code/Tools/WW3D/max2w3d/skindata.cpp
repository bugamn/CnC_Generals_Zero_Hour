...
/* $Header: /Commando/Code/Tools/max2w3d/skindata.cpp 7     5/28/98 12:15p
 * Greg_h $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * SkinDataClass::Save -- save the skindata in the MAX file *
...
IOResult SkinDataClass::Save(ISave *isave) {
  ...
  */
  if (VertData.Count() > 0) {
    isave->BeginChunk(INFLUENCE_DATA_CHUNK);
    isave->Write(VertData.Addr(0), VertData.Count() * sizeof(InfluenceStruct),
                 &nb);
    isave->EndChunk();
  }
