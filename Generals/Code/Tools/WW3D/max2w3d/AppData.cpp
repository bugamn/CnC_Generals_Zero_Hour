...
Value *copy_app_data_cf(Value **arg_list, int count) {
  ...
  */
  ...
  if (app_data_0 != NULL) {
    ...
    if (copy_data_0 == NULL) throw RuntimeError("Out of memory.");

    // Copy the app data and give it to the target node.
    *copy_data_0 = *app_data_0;
    dest_node->AddAppDataChunk(W3DUtilityClassID, UTILITY_CLASS_ID,
                               W3D_APPDATA_0, sizeof(W3DAppData0Struct),
                               copy_data_0);
  }
  ...
  */
  ...
  if (app_data_1 == NULL)
    throw RuntimeError("Unable to retrieve W3DAppData1Struct from object: ",
                       arg_list[1]);

  W3DAppData1Struct *copy_data_1 = new W3DAppData1Struct;
  if (copy_data_1 == NULL) throw RuntimeError("Out of memory.");
  ...
  */
  ...
  if (copy_data_2 == NULL) throw RuntimeError("Out of memory.");
  ...
  */
  ...
  if (dazzle_app_data != NULL) {
    ...
    if (copy_dazzle_data == NULL) throw RuntimeError("Out of memory.");
...
Value *set_origin_app_data_cf(Value **arg_list, int count) {
  ...
  if (data == NULL)
    throw RuntimeError("Unable to retrieve W3DAppData0Struct from object: ",
                       arg_list[0]);
...
Value *get_hierarchy_file_cf(Value **arg_list, int count) {
  ...
  AppDataChunk *appdata =
      MAXScript_interface->GetScenePointer()->GetAppDataChunk(
          W3D_EXPORTER_CLASS_ID, SCENE_EXPORT_CLASS_ID, 0);
  if (appdata) options = (W3dExportOptionsStruct *)(appdata->data);
