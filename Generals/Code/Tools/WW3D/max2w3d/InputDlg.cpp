...
static BOOL CALLBACK _thunk_dialog_proc(HWND hWnd, UINT uMsg, WPARAM wParam,
                                        LPARAM lParam);

/////////////////////////////////////////////////////////////////////////////
// InputDlg dialog

InputDlg::InputDlg(HWND hWndParent) : m_hWndParent(hWndParent), m_hWnd(NULL) {
...
int InputDlg::DoModal(void) {
  ...
  BOOL result = DialogBoxParam(AppInstance, MAKEINTRESOURCE(IDD), m_hWndParent,
                               (DLGPROC)_thunk_dialog_proc, (LPARAM)this);
...
BOOL CALLBACK _thunk_dialog_proc(HWND hWnd, UINT uMsg, WPARAM wParam,
                                 LPARAM lParam) {
...
BOOL CALLBACK InputDlg::DialogProc(HWND hWnd, UINT uMsg, WPARAM wParam,
                                   LPARAM lParam) {
