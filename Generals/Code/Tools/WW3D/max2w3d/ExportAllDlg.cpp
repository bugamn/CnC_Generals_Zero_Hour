...
BOOL CALLBACK ExportAllDlg::DialogProc(HWND hWnd, UINT uMsg, WPARAM wParam,
                                       LPARAM lParam) {
...
BOOL ExportAllDlg::OnOK(void) {
  ...
  m_Recursive =
      (IsDlgButtonChecked(m_hWnd, IDC_RECURSIVE) == BST_CHECKED) ? TRUE : FALSE;
