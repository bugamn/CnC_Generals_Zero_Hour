...
** Static functions
*/
static BOOL CALLBACK _logdata_dialog_proc(HWND Hwnd, UINT message,
                                          WPARAM wParam, LPARAM lParam);
static DWORD WINAPI _logdata_thread_function(LPVOID log_obj_ptr);

/***********************************************************************************************
 * LogDataDialogClass::LogDataDialogClass -- constructor for the options dialog
 *object         *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 02/09/2000 JGA  : Created. *
 *=============================================================================================*/
LogDataDialogClass::LogDataDialogClass(HWND parent)
    : Hwnd(NULL),
      ...
      last_buffer_index(0),
      status(0) {
  ThreadHandle = CreateThread(NULL, 0, _logdata_thread_function, (LPVOID)this,
                              0, &ThreadID);
...
/***********************************************************************************************
 * LogDataDialogClass::printf -- handles doing printfs into the current log
 *window             *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 02/11/2000 JGA  : Created. *
 *=============================================================================================*/
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 02/14/2000 JGA  : Created. *
 *=============================================================================================*/
...
/***********************************************************************************************
 * LogDataDialogClass::Dialog_Proc -- Handles the windows message for the
 *options dialog    *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 *=============================================================================================*/
bool LogDataDialogClass::Dialog_Proc(HWND hwnd, UINT message, WPARAM wParam,
                                     LPARAM) {
...
/***********************************************************************************************
 * _logdata_dialog_proc -- thunks into the logdata dialog class's windows
 *message handler      *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * HISTORY: * 02/09/2000 JGA  : Created. *
 *=============================================================================================*/
BOOL CALLBACK _logdata_dialog_proc(HWND hwnd, UINT message, WPARAM wParam,
                                   LPARAM lParam) {
  ...
  LogDataDialogClass *log =
      (LogDataDialogClass *)::GetProp(hwnd, "LogDataDialogClass");
...
DWORD WINAPI _logdata_thread_function(LPVOID log_obj_ptr) {
  ...
  DialogBoxParam(AppInstance, MAKEINTRESOURCE(IDD_W3D_LOG),
                 ((LogDataDialogClass *)log_obj_ptr)->ParentHwnd,
                 (DLGPROC)_logdata_dialog_proc, (LPARAM)log_obj_ptr);
