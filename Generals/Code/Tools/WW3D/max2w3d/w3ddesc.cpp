 ...
 *=============================================================================================*/
void* W3dClassDesc::Create(BOOL) { return new W3dExportClass; }

/***********************************************************************************************
 * W3dClassDesc::IsPublic -- Controls if the plug-in shows up in lists from the
 *user to choose *
 *                                                                                             *
 ...
 * HISTORY: * 06/09/1997 GH  : Created. *
 *=============================================================================================*/
int W3dClassDesc::IsPublic() { return 1; }
 ...
 *for the			  * plug-in in the MAX user interface.
 **
 *                                                                                             *
 * INPUT: none
 **
 ...
 * HISTORY: * 06/09/1997 GH  : Created. *
 *=============================================================================================*/
SClass_ID W3dClassDesc::SuperClassID() { return SCENE_EXPORT_CLASS_ID; }

/***********************************************************************************************
 * W3dClassDesc::ClassID -- Returns the class ID *
 *                                                                                             *
 * This method must return the unique ID for the object.  If two ClassIDs
 *conflict, the		  * system will only load the first one it finds.  The
 *ClassID consists of two unsigned 32-bit  * quantities.
 **
 * 																														  *
 * INPUT: none
 **
 ...
 * HISTORY: * 06/09/1997 GH  : Created. *
 *=============================================================================================*/
Class_ID W3dClassDesc::ClassID() { return W3D_EXPORTER_CLASS_ID; }

/***********************************************************************************************
 * W3dClassDesc::Category -- returns a string describing the category a plug-in
 *fits into      *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * HISTORY: * 06/09/1997 GH  : Created. *
 *=============================================================================================*/
const TCHAR* W3dClassDesc::Category() { return Get_String(IDS_SCENE_EXPORT); }
