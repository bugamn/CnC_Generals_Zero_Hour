 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * PassDlgProc -- dialog proc which thunks into a GameMtlPassDlg *
 *   GameMtlPassDlg::GameMtlPassDlg -- constructor *
 *   GameMtlPassDlg::~GameMtlPassDlg -- destructor * GameMtlPassDlg::DialogProc
 ...
 *=============================================================================================*/
static BOOL CALLBACK PassDlgProc(HWND hwndDlg, UINT msg, WPARAM wParam,
                                 LPARAM lParam) {
  ...
  if (msg == WM_INITDIALOG) {
    ...
    if ((theDlg = (GameMtlPassDlg *)GetWindowLong(hwndDlg, GWL_USERDATA)) ==
        NULL) {
      return FALSE;
    }
  }
 ...
 * HISTORY: * 11/23/98   GTH : Created. *
 *=============================================================================================*/
GameMtlPassDlg::GameMtlPassDlg(HWND hwMtlEdit, IMtlParams *imp, GameMtl *m,
                               int pass) {
  HwndEdit = hwMtlEdit;
  TheMtl = m;
  IParams = imp;
  ...
  HwndPanel = IParams->AddRollupPage(
      AppInstance, MAKEINTRESOURCE(IDD_GAMEMTL_PASS), PassDlgProc, title,
      (LPARAM)this,
...
GameMtlPassDlg::~GameMtlPassDlg() {
  TheMtl->Set_Flag(_Pass_Index_To_Flag[PassIndex],
 ...
 * HISTORY: * 11/23/98   GTH : Created. *
 *=============================================================================================*/
BOOL GameMtlPassDlg::DialogProc(HWND hDlg, UINT message, WPARAM wParam,
                                LPARAM lParam) {
  int i = 0;
  ...
  switch (message) {
    case WM_INITDIALOG: {
      Page[0] =
          new GameMtlVertexMaterialDlg(HwndPanel, IParams, TheMtl, PassIndex);
      if (TheMtl->Get_Shader_Type() == GameMtl::STE_PC_SHADER) {
        ...
        Page[1] =
            new PS2GameMtlShaderDlg(HwndPanel, IParams, TheMtl, PassIndex);
      }
 ...
 * HISTORY: * 11/23/98   GTH : Created. *
 *=============================================================================================*/
Class_ID GameMtlPassDlg::ClassID() { return GameMaterialClassID; }
