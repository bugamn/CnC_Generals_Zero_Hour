 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * RCMenuClass::Init -- initialize the "right-click" menu *
...
void RCMenuClass::Init(RightClickMenuManager* manager, HWND hWnd, IPoint2 m) {
  ...
  if (SelNode) {
    ...
    */
    ...
    //		manager->AddMenu(this, MF_STRING | MF_GRAYED, MENU_NODE_POINTER,
    //string);
    ...
    */
    ...
    manager->AddMenu(this, menuflags, MENU_TOGGLE_HIERARCHY,
                     "W3D: Export Hierarchy");
    ...
    */
    ...
    manager->AddMenu(this, menuflags, MENU_TOGGLE_GEOMETRY,
                     "W3D: Export Geometry");
  }
}
