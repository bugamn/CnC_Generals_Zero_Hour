 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * FormClass::Create_Form -- Loads the dialog template and
 *initializes                       * FormClass::fnFormProc -- windows proc
 *which thunks into the virtual Dialog_Proc           *
 *   FormClass::ExecuteDlgInit -- Initializes controls in the dialog template *
 *   FormClass::ExecuteDlgInit -- Initializes the controls in the dialog
 *template              *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 11/6/98    GTH : Created. *
 *=============================================================================================*/
HWND FormClass::Create_Form(HWND parent_wnd, UINT template_id) {
  // call PreCreateWindow to get prefered extended style
  CREATESTRUCT cs = {0};
  cs.style = WS_CHILD;

  m_hWnd = ::CreateDialogParam(AppInstance, MAKEINTRESOURCE(template_id),
                               parent_wnd, fnFormProc, (LPARAM)this);
...
/***********************************************************************************************
 * FormClass::fnFormProc -- windows proc which thunks into the virtual
 *Dialog_Proc             *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
 ...
 * HISTORY: * 11/6/98    GTH : Created. *
 *=============================================================================================*/
BOOL WINAPI FormClass::fnFormProc(HWND dlg_wnd, UINT message, WPARAM wparam,
                                  LPARAM lparam) {
 ...
 * FormClass::ExecuteDlgInit -- Initializes controls in the dialog template *
 *                                                                                             *
 * This code was lifted straight out of MFC.  It does some "interesting" things
 *like putting   * strings into combo boxes which are typed in the resource
 *editor.                            *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
