...
//
///////////////////////////////////////////////////////////////////////////
VertexRestoreClass::VertexRestoreClass(Mesh *mesh, MeshDeformClass *modifier,
...
void VertexRestoreClass::Restore(int is_undo) {
  ...
  if (is_undo != 0) {
    ...
    //
    m_pModifier->NotifyDependents(FOREVER, PART_GEOM | PART_VERTCOLOR,
                                  REFMSG_CHANGE);
...
VertexPositionRestoreClass::VertexPositionRestoreClass(
    Mesh *mesh, MeshDeformClass *modifier, MeshDeformModData *mod_data)
...
//
///////////////////////////////////////////////////////////////////////////
VertexColorRestoreClass::VertexColorRestoreClass(Mesh *mesh,
