 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * ExportLog::Init -- Initialize the export logging system *
 *   ExportLog::Shutdown -- Shutdown the export logging system *
 *   ExportLog::printf -- Print a string to the log window * ExportLog::rprintf
 *-- Print a string over the last line printed                           *
...
/*
**
** ExportLog implementation.  Note, this is a class which only contains static
*functions.
**
*/
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 10/30/2000 gth : Created. *
 *=============================================================================================*/
 ...
 * ExportLog::Shutdown -- Shutdown the export logging system *
 *                                                                                             *
 * INPUT: * wait_for_ok - should we wait for the user to press OK on the dialog?
 **
 *                                                                                             *
 * OUTPUT: *
 *                                                                                             *
