...
/* $Header: /Commando/Code/Tools/max2w3d/gamemaps.cpp 5     10/28/97 6:08p
 * Greg_h $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * GameMapsClass::ClassID -- Returns the ClassID for GameMapsClass
 ** GameMapsClass::AssignController -- Assigns a controller to one of the
 *Sub-Anims           * GameMapsClass::NotifyRefChanged -- Max is notifying
 *GameMapsClass that a reference has cha* GameMapsClass::Clone -- Create a clone
 *of the GameMapsClass                               * GameMapsClass::Save --
 *Saves the GameMapsClass data into a MAX file                       *
 ...
 *=============================================================================================*/
Class_ID GameMapsClass::ClassID() { return _GameMapsClassID; }
...
/***********************************************************************************************
 * GameMapsClass::NotifyRefChanged -- Max is notifying GameMapsClass that a
 *reference has chan *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
