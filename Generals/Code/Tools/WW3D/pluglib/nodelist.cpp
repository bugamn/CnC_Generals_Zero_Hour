 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * INodeListClass::INodeListClass -- Create an INodeList *
 *   INodeListClass::~INodeListClass -- Delete the INode List * INode *
 *INodeListClass::operator[] -- Array-like access to the list members *
 ...
 *   INodeListClass::INodeListClass -- Constructor * INodeListClass::Insert --
 *insert a list of nodes into this list                           *
 ...
 *                                                                                             *
 * INPUT: * scene - 3dsMAX scene to enumerate
 ...
 * WARNINGS: *
 *                                                                                             *
 * HISTORY: * 06/09/1997 GH  : Created. *
 *=============================================================================================*/
INodeListClass::INodeListClass(IScene* scene, TimeValue time,
 ...
 *=============================================================================================*/
INodeListClass::INodeListClass(INode* root, TimeValue time,
                               INodeFilterClass* nodefilter)
    : NumNodes(0), Time(time), ListHead(NULL), INodeFilter(nodefilter) {
  if (INodeFilter == NULL) {
    INodeFilter = &_AnyFilter;
  }
  Add_Tree(root);
 ...
 * HISTORY: * 07/02/1997 GH  : Created. *
 *=============================================================================================*/
INodeListClass::INodeListClass(INodeListClass& copyfrom, TimeValue time,
                               INodeFilterClass* inodefilter)
    : NumNodes(0), Time(time), ListHead(NULL), INodeFilter(inodefilter) {
  if (INodeFilter == NULL) {
    INodeFilter = &_AnyFilter;
 ...
 *                                                                                             *
 * INPUT: * index - index of the list entry
 **
 * 																														  *
 * OUTPUT: * pointer to an INode
 **
 * 																														  *
 * WARNINGS: *
 *                                                                                             *
 ...
 * INodeListClass::callback -- callback function for MAX *
 *                                                                                             *
 * 3dsMAX calls this function with a pointer to each INode in the scene.  We
 *keep a pointer	  * to the ones we like.
 **
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
