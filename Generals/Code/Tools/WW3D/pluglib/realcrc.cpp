 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * CRC_Memory -- calculates a CRC for a block of memory *
 *   CRC_String -- Calculates a CRC for a NULL-terminated string * CRC_Stringi
 *-- Calculates a CRC for a string, case-insensitive *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
...
#define CRC32(c, crc)                                  \
  (CRC32_Table[((unsigned long)(crc) ^ (c)) & 0xFFL] ^ \
   (((crc) >> 8) & 0x00FFFFFFL))
