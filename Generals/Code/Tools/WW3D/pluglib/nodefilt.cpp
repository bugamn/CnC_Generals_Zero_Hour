...
/* $Header: /Commando/Code/Tools/max2w3d/nodefilt.cpp 9     1/16/98 10:34a
 * Greg_h $ */
/***********************************************************************************************
 ...
 *                                                                                             *
 *---------------------------------------------------------------------------------------------*
 * Functions: * VisibleMeshINodeFilter::Accept_Node -- Accepts visible meshes *
 ...
 *   VisibleMeshOrHelperINodeFilter::Accept_Node -- Accepts visible helper or
 *mesh objects     * HelperINodeFilter::Accept_Node -- Accepts all helper inodes
 *(including hidden)            * MeshINodeFilter::Accept_Node -- Accepts all
 *mesh inodes (including hidden)                *
 *   VisibleSelectedINodeFilter::Accept_Node -- Accepts Visible and selected
 *inodes            *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *- - - - - - - */
...
/***********************************************************************************************
 * HelperINodeFilter::Accept_Node -- Accepts all helper inodes (including
 *hidden)              *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
...
BOOL VisibleMeshINodeFilter::Accept_Node(INode* node, TimeValue time) {
  ...
  if (obj && !node->IsHidden() && obj->CanConvertToType(triObjectClassID) &&
      obj->SuperClassID() == GEOMOBJECT_CLASS_ID
...
/***********************************************************************************************
 * VisibleMeshOrHelperINodeFilter::Accept_Node -- Accepts visible helper or mesh
 *objects       *
 *                                                                                             *
 * INPUT: *
 *                                                                                             *
