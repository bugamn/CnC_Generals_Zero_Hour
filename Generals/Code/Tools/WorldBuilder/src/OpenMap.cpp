...
OpenMap::OpenMap(TOpenMapInfo *pInfo, CWnd *pParent /*=NULL*/)
    : CDialog(OpenMap::IDD, pParent), m_pInfo(pInfo) {
  m_pInfo->browse = false;
#if defined(_DEBUG) || defined(_INTERNAL)
  m_usingSystemDir = ::AfxGetApp()->GetProfileInt(MAP_OPENSAVE_PANEL_SECTION,
                                                  "UseSystemDir", TRUE);
#else
...
void OpenMap::OnSystemMaps() { populateMapListbox(TRUE); }

void OpenMap::OnUserMaps() { populateMapListbox(FALSE); }
...
void OpenMap::OnDblclkOpenList() { OnOK(); }
