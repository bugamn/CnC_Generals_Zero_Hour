...
BlendMaterial::BlendMaterial(CWnd *pParent /*=NULL*/) : m_updating(false) {
...
BOOL BlendMaterial::OnInitDialog() {
  ...
  // IDC_TERRAIN_SWATCHES); m_terrainSwatches.ShowWindow(SW_SHOW);
...
void BlendMaterial::addTerrain(const char *pPath, Int terrainNdx,
  ...
  //availableTiles/2) / availableTiles;
