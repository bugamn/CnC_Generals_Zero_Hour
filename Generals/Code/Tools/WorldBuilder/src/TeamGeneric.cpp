...
static const UINT s_allControls[][2] = {
    {
        IDC_SCRIPT_PREFIX1,
        IDC_TeamGeneric_Script1,
    },
    {
        IDC_SCRIPT_PREFIX2,
        IDC_TeamGeneric_Script2,
    },
    {
        IDC_SCRIPT_PREFIX3,
        IDC_TeamGeneric_Script3,
    },
    {
        IDC_SCRIPT_PREFIX4,
        IDC_TeamGeneric_Script4,
    },
    {
        IDC_SCRIPT_PREFIX5,
        IDC_TeamGeneric_Script5,
    },
    {
        IDC_SCRIPT_PREFIX6,
        IDC_TeamGeneric_Script6,
    },
    {
        IDC_SCRIPT_PREFIX7,
        IDC_TeamGeneric_Script7,
    },
    {
        IDC_SCRIPT_PREFIX8,
        IDC_TeamGeneric_Script8,
    },
    {
        IDC_SCRIPT_PREFIX9,
        IDC_TeamGeneric_Script9,
    },
    {
        IDC_SCRIPT_PREFIX10,
        IDC_TeamGeneric_Script10,
    },
    {
        IDC_SCRIPT_PREFIX11,
        IDC_TeamGeneric_Script11,
    },
    {
        IDC_SCRIPT_PREFIX12,
        IDC_TeamGeneric_Script12,
    },
    {
        IDC_SCRIPT_PREFIX13,
        IDC_TeamGeneric_Script13,
    },
    {
        IDC_SCRIPT_PREFIX14,
        IDC_TeamGeneric_Script14,
    },
    {
        IDC_SCRIPT_PREFIX15,
        IDC_TeamGeneric_Script15,
    },
    {
        IDC_SCRIPT_PREFIX16,
...
void TeamGeneric::_scriptsToDict() {
  ...
  while (s_allControls[i][1]) {
    ...
    keyName.format(
        "%s%d",
        TheNameKeyGenerator->keyToName(TheKey_teamGenericScriptHook).str(),
        scriptNum);
