...
//
/// Constructor
FeatherTool::FeatherTool(void) : Tool(ID_FEATHERTOOL, IDC_BRUSH_CROSS) {
...
void FeatherTool::mouseDown(TTrackingMode m, CPoint viewPt, WbView *pView,
...
void FeatherTool::mouseUp(TTrackingMode m, CPoint viewPt, WbView *pView,
                          CWorldBuilderDoc *pDoc) {
  if (m != TRACK_L) return;
...
void FeatherTool::mouseMoved(TTrackingMode m, CPoint viewPt, WbView *pView,
                             CWorldBuilderDoc *pDoc) {
  Coord3D cpt;
