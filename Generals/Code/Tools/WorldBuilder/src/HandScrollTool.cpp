...
void HandScrollTool::mouseDown(TTrackingMode m, CPoint viewPt, WbView* pView,
...
void HandScrollTool::mouseMoved(TTrackingMode m, CPoint viewPt, WbView* pView,
                                CWorldBuilderDoc* pDoc) {
  if (m == TRACK_NONE) return;
...
void HandScrollTool::mouseUp(TTrackingMode m, CPoint viewPt, WbView* pView,
                             CWorldBuilderDoc* pDoc) {
  if (m == TRACK_M) {
