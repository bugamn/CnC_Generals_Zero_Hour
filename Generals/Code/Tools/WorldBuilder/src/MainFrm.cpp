...
CMainFrame::~CMainFrame() {
  ...
  ::AfxGetApp()->WriteProfileInt(MAIN_FRAME_SECTION, "AutoSaveIntervalSeconds",
                                 m_autoSaveInterval);
  CoUninitialize();
}
...
#define WRAP(btn)                   \
  m_floatingToolBar.SetButtonStyle( \
      btn, m_floatingToolBar.GetButtonStyle(btn) | TBBS_WRAPPED)
...
#undef WRAP
  ...
  frameRect.top =
      ::AfxGetApp()->GetProfileInt(OPTIONS_PANEL_SECTION, "Top", frameRect.top);
  frameRect.left = ::AfxGetApp()->GetProfileInt(OPTIONS_PANEL_SECTION, "Left",
                                                frameRect.left);

  m_brushOptions.Create(IDD_BRUSH_OPTIONS, this);
  m_brushOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
  ...
  m_featherOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                                SWP_NOZORDER | SWP_NOSIZE);
  m_featherOptions.GetWindowRect(&frameRect);
  if (m_optionsPanelWidth < frameRect.Width())
    m_optionsPanelWidth = frameRect.Width();
  if (m_optionsPanelHeight < frameRect.Height())
    m_optionsPanelHeight = frameRect.Height();

  m_noOptions.Create(IDD_NO_OPTIONS, this);
  m_noOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                           SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_terrainMaterial.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                                 SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_blendMaterial.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                               SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_moundOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                              SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_objectOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                               SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_fenceOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                              SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_mapObjectProps.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                                SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_roadOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                             SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_waypointOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                                 SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_waterOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                              SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_lightOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                              SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_meshMoldOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                                 SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_buildListOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                                  SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_groveOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                              SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_rampOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                             SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_scorchOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                               SWP_NOZORDER | SWP_NOSIZE);
  ...
  frameRect.top = ::AfxGetApp()->GetProfileInt(
      GLOBALLIGHT_OPTIONS_PANEL_SECTION, "Top", frameRect.top);
  frameRect.left = ::AfxGetApp()->GetProfileInt(
      GLOBALLIGHT_OPTIONS_PANEL_SECTION, "Left", frameRect.left);

  m_globalLightOptions.Create(IDD_GLOBAL_LIGHT_OPTIONS, this);
  m_globalLightOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                                    SWP_NOZORDER | SWP_NOSIZE);
  ...
  frameRect.top = ::AfxGetApp()->GetProfileInt(CAMERA_OPTIONS_PANEL_SECTION,
                                               "Top", frameRect.top);
  frameRect.left = ::AfxGetApp()->GetProfileInt(CAMERA_OPTIONS_PANEL_SECTION,
                                                "Left", frameRect.left);

  m_cameraOptions.Create(IDD_CAMERA_OPTIONS, this);
  m_cameraOptions.SetWindowPos(NULL, frameRect.left, frameRect.top, 0, 0,
                               SWP_NOZORDER | SWP_NOSIZE);
  ...
  m_layersList->SetWindowPos(NULL, optionsRect.left, optionsRect.bottom + 100,
                             0, 0, SWP_NOZORDER | SWP_NOSIZE);

  Int sbf =
      ::AfxGetApp()->GetProfileInt(MAIN_FRAME_SECTION, "ShowBrushFeedback", 1);
  if (sbf != 0) {
  ...
  Int autoSave =
      ::AfxGetApp()->GetProfileInt(MAIN_FRAME_SECTION, "AutoSave", 1);
  m_autoSave = autoSave != 0;
  autoSave = ::AfxGetApp()->GetProfileInt(MAIN_FRAME_SECTION,
...
void CMainFrame::adjustWindowSize(void) {
  ...
  Int viewWidth = ::AfxGetApp()->GetProfileInt(MAIN_FRAME_SECTION, "Width",
                                               THREE_D_VIEW_WIDTH);
  Int viewHeight = ::AfxGetApp()->GetProfileInt(MAIN_FRAME_SECTION, "Height",
                                                THREE_D_VIEW_HEIGHT);
...
void CMainFrame::ResetWindowPositions(void) {
  ...
  this->FloatControlBar(&m_floatingToolBar, pos, CBRS_ALIGN_LEFT);
  m_floatingToolBar.SetWindowPos(NULL, pos.x, pos.y, 0, 0,
...
void CMainFrame::showOptionsDialog(Int dialogID) {
  ...
  switch (dialogID) {
    case IDD_BRUSH_OPTIONS:
      newOptions = &m_brushOptions;
      break;
    case IDD_TERRAIN_MATERIAL:
      newOptions = &m_terrainMaterial;
      break;
    case IDD_BLEND_MATERIAL:
      newOptions = &m_blendMaterial;
      break;
    case IDD_OBJECT_OPTIONS:
      newOptions = &m_objectOptions;
      break;
    case IDD_FENCE_OPTIONS:
      newOptions = &m_fenceOptions;
      break;
    case IDD_MAPOBJECT_PROPS:
      newOptions = &m_mapObjectProps;
      break;
    case IDD_ROAD_OPTIONS:
      newOptions = &m_roadOptions;
      break;
    case IDD_MOUND_OPTIONS:
      newOptions = &m_moundOptions;
      break;
    case IDD_FEATHER_OPTIONS:
      newOptions = &m_featherOptions;
      break;
    case IDD_MESHMOLD_OPTIONS:
      newOptions = &m_meshMoldOptions;
      break;
    case IDD_WAYPOINT_OPTIONS:
      newOptions = &m_waypointOptions;
      break;
    case IDD_WATER_OPTIONS:
      newOptions = &m_waterOptions;
      break;
    case IDD_LIGHT_OPTIONS:
      newOptions = &m_lightOptions;
      break;
    case IDD_BUILD_LIST_PANEL:
      newOptions = &m_buildListOptions;
      break;
    case IDD_GROVE_OPTIONS:
      newOptions = &m_groveOptions;
      break;
    case IDD_RAMP_OPTIONS:
      newOptions = &m_rampOptions;
      break;
    case IDD_SCORCH_OPTIONS:
      newOptions = &m_scorchOptions;
      break;
    case IDD_NO_OPTIONS:
      newOptions = &m_noOptions;
      break;
    default:
      break;
  }
  ...
  if (newOptions && newOptions != m_curOptions) {
    ...
    ::AfxGetApp()->WriteProfileInt(OPTIONS_PANEL_SECTION, "Left",
                                   frameRect.left);
...
void CMainFrame::handleCameraChange(void) { m_cameraOptions.update(); }
