...
/** Finds the current texture class, and tells the terrain material panel to use
 * it as fg. */
void EyedropperTool::mouseDown(TTrackingMode m, CPoint viewPt, WbView *pView,
  ...
  CPoint ndx;
  if (!pDoc->getCellIndexFromCoord(cpt, &ndx)) return;
