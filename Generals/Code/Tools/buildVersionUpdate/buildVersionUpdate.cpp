...
// ////////////////////////////////////////////////////// Generals version
// number class updater Author: Matthew D. Campbell, November 2001
...
#define COMMENTS                                                         \
  "// Do not modify this file by hand. Auto-created and\n// Updated by " \
  "buildVersionUpdate.\n"
#define NUMFMT "#define %s %d\n"
#define NUMFMT_MINOR                                      \
  "#define %s %d			///< This effects the replay version " \
  "number.\n"
        ...
        while (!feof(filePtr)) {
          ...
          if ((stringPtr = strstr(buffer, VERSION_STRING)) != NULL) {
            ...
            if (*ptr == '\"') {
              ...
              printf(
                  "Build 0. Oops, didn't find a string of the format: '#define "
                  "VERSION \"x.y.z\"'");
            }
          }  // End if if (strstr
        }  // End of while
