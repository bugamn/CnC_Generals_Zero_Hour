...
void DebugWindowDialog::InitPanel(void) {
  ...
  if (pWnd) {
    ...
    for (j = 0; j < NUM_EMISSION_TYPES; ++j) {
      ...
      m_emissionTypePanels[j]->SetWindowPos(
  ...
  if (pWnd) {
    ...
    for (j = 0; j < NUM_VELOCITY_TYPES; ++j) {
      ...
      m_velocityTypePanels[j]->SetWindowPos(
          NULL, rect.left, rect.top, rect.Width(), rect.Height(), SWP_NOZORDER);
    }
    pWnd->ShowWindow(SW_HIDE);
  ...
  if (pWnd) {
    ...
    for (j = 0; j < NUM_PARTICLE_TYPES; ++j) {
      ...
      m_particleTypePanels[j]->SetWindowPos(
          NULL, rect.left, rect.top, rect.Width(), rect.Height(), SWP_NOZORDER);
    }
    pWnd->ShowWindow(SW_HIDE);
...
HWND DebugWindowDialog::GetMainWndHWND(void) { return mMainWndHWND; }
...
void DebugWindowDialog::OnClose() { ShowWindow(SW_MINIMIZE); }
...
void DebugWindowDialog::clearAllThingTemplates(void) {
  ...
  // this is a kindof(dirty_hack), because there's no way at runtime to verify
  // that particleTypePanels[1] is actually a PArticlePanelDrawable
...
void DebugWindowDialog::appendThingTemplateToList(
    IN const std::string& rString) {
  m_listOfThingTemplates.push_back(rString);
}

void DebugWindowDialog::OnParticleSystemChange() { m_changeHasOcurred = true; }

void DebugWindowDialog::OnPushSave() { m_shouldWriteINI = true; }

void DebugWindowDialog::OnReloadTextures() {
  // First, reload the textures
  ParticlePanelParticle* pParticle =
      (ParticlePanelParticle*)m_particleTypePanels[0];
  if (!pParticle) {
    return;
  }
...
void DebugWindowDialog::getSelectedParticleAsciiStringParm(
    IN int parmNum, OUT char* bufferToCopyInto) const {
  if (parmNum < 0 || parmNum >= PARM_NumParms || !bufferToCopyInto ||
      !m_particleSystem) {
    return;
  }
...
void DebugWindowDialog::updateParticleAsciiStringParm(
    IN int parmNum, OUT const char* bufferToCopyFrom) {
...
void DebugWindowDialog::getColorValueFromSystem(
    IN Int systemNum, OUT RGBColorKeyframe& colorFrame) const {
...
void DebugWindowDialog::updateColorValueToSystem(
...
void DebugWindowDialog::getAlphaRangeFromSystem(
    IN Int systemNum, OUT ParticleSystemInfo::RandomKeyframe& randomVar) const {
  if (systemNum >= MAX_KEYFRAMES || systemNum < 0 || !m_particleSystem) {
    return;
  }
...
void DebugWindowDialog::updateAlphaRangeToSystem(
    IN Int systemNum, IN const ParticleSystemInfo::RandomKeyframe& randomVar) {
  if (systemNum >= MAX_KEYFRAMES || systemNum < 0 || !m_particleSystem) {
    return;
  }
...
void DebugWindowDialog::getHalfSizeFromSystem(IN Int coordNum,
  ...
  switch (coordNum) {
    case 0:
      halfSize = m_particleSystem->m_emissionVolume.box.halfSize.x;
      return;
    case 1:
      halfSize = m_particleSystem->m_emissionVolume.box.halfSize.y;
      return;
    case 2:
      halfSize = m_particleSystem->m_emissionVolume.box.halfSize.z;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateHalfSizeToSystem(IN Int coordNum,
  ...
  switch (coordNum) {
    case 0:
      m_particleSystem->m_emissionVolume.box.halfSize.x = halfSize;
      return;
    case 1:
      m_particleSystem->m_emissionVolume.box.halfSize.y = halfSize;
      return;
    case 2:
      m_particleSystem->m_emissionVolume.box.halfSize.z = halfSize;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getLineFromSystem(IN Int coordNum,
  ...
  switch (coordNum) {
    case 0:
      linePoint = m_particleSystem->m_emissionVolume.line.start.x;
      return;
    case 1:
      linePoint = m_particleSystem->m_emissionVolume.line.start.y;
      return;
    case 2:
      linePoint = m_particleSystem->m_emissionVolume.line.start.z;
      return;
    case 3:
      linePoint = m_particleSystem->m_emissionVolume.line.end.x;
      return;
    case 4:
      linePoint = m_particleSystem->m_emissionVolume.line.end.y;
      return;
    case 5:
      linePoint = m_particleSystem->m_emissionVolume.line.end.z;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateLineToSystem(IN Int coordNum,
  ...
  switch (coordNum) {
    case 0:
      m_particleSystem->m_emissionVolume.line.start.x = linePoint;
      return;
    case 1:
      m_particleSystem->m_emissionVolume.line.start.y = linePoint;
      return;
    case 2:
      m_particleSystem->m_emissionVolume.line.start.z = linePoint;
      return;
    case 3:
      m_particleSystem->m_emissionVolume.line.end.x = linePoint;
      return;
    case 4:
      m_particleSystem->m_emissionVolume.line.end.y = linePoint;
      return;
    case 5:
      m_particleSystem->m_emissionVolume.line.end.z = linePoint;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getVelSphereFromSystem(IN Int velNum,
  ...
  switch (velNum) {
    case 0:
      radius = m_particleSystem->m_emissionVelocity.spherical.speed.m_low;
      return;
    case 1:
      radius = m_particleSystem->m_emissionVelocity.spherical.speed.m_high;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateVelSphereToSystem(IN Int velNum,
  ...
  switch (velNum) {
    case 0:
      m_particleSystem->m_emissionVelocity.spherical.speed.m_low = radius;
      return;
    case 1:
      m_particleSystem->m_emissionVelocity.spherical.speed.m_high = radius;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getVelHemisphereFromSystem(IN Int velNum,
  ...
  switch (velNum) {
    case 0:
      radius = m_particleSystem->m_emissionVelocity.hemispherical.speed.m_low;
      return;
    case 1:
      radius = m_particleSystem->m_emissionVelocity.hemispherical.speed.m_high;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateVelHemisphereToSystem(IN Int velNum,
  ...
  switch (velNum) {
    case 0:
      m_particleSystem->m_emissionVelocity.hemispherical.speed.m_low = radius;
      return;
    case 1:
      m_particleSystem->m_emissionVelocity.hemispherical.speed.m_high = radius;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getVelOrthoFromSystem(IN Int coordNum,
  ...
  switch (coordNum) {
    case 0:
      ortho = m_particleSystem->m_emissionVelocity.ortho.x.m_low;
      return;
    case 1:
      ortho = m_particleSystem->m_emissionVelocity.ortho.y.m_low;
      return;
    case 2:
      ortho = m_particleSystem->m_emissionVelocity.ortho.z.m_low;
      return;
    case 3:
      ortho = m_particleSystem->m_emissionVelocity.ortho.x.m_high;
      return;
    case 4:
      ortho = m_particleSystem->m_emissionVelocity.ortho.y.m_high;
      return;
    case 5:
      ortho = m_particleSystem->m_emissionVelocity.ortho.z.m_high;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateVelOrthoToSystem(IN Int coordNum,
  ...
  switch (coordNum) {
    case 0:
      m_particleSystem->m_emissionVelocity.ortho.x.m_low = ortho;
      return;
    case 1:
      m_particleSystem->m_emissionVelocity.ortho.y.m_low = ortho;
      return;
    case 2:
      m_particleSystem->m_emissionVelocity.ortho.z.m_low = ortho;
      return;
    case 3:
      m_particleSystem->m_emissionVelocity.ortho.x.m_high = ortho;
      return;
    case 4:
      m_particleSystem->m_emissionVelocity.ortho.y.m_high = ortho;
      return;
    case 5:
      m_particleSystem->m_emissionVelocity.ortho.z.m_high = ortho;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getVelCylinderFromSystem(IN Int coordNum,
  ...
  switch (coordNum) {
    case 0:
      cylinder = m_particleSystem->m_emissionVelocity.cylindrical.radial.m_low;
      return;
    case 1:
      cylinder = m_particleSystem->m_emissionVelocity.cylindrical.normal.m_low;
      return;
    case 2:
      cylinder = m_particleSystem->m_emissionVelocity.cylindrical.radial.m_high;
      return;
    case 3:
      cylinder = m_particleSystem->m_emissionVelocity.cylindrical.normal.m_high;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateVelCylinderToSystem(IN Int coordNum,
  ...
  switch (coordNum) {
    case 0:
      m_particleSystem->m_emissionVelocity.cylindrical.radial.m_low = cylinder;
      return;
    case 1:
      m_particleSystem->m_emissionVelocity.cylindrical.normal.m_low = cylinder;
      return;
    case 2:
      m_particleSystem->m_emissionVelocity.cylindrical.radial.m_high = cylinder;
      return;
    case 3:
      m_particleSystem->m_emissionVelocity.cylindrical.normal.m_high = cylinder;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getVelOutwardFromSystem(IN Int coordNum,
  ...
  switch (coordNum) {
    case 0:
      cylinder = m_particleSystem->m_emissionVelocity.outward.speed.m_low;
      return;
    case 1:
      cylinder = m_particleSystem->m_emissionVelocity.outward.otherSpeed.m_low;
      return;
    case 2:
      cylinder = m_particleSystem->m_emissionVelocity.outward.speed.m_high;
      return;
    case 3:
      cylinder = m_particleSystem->m_emissionVelocity.outward.otherSpeed.m_high;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateVelOutwardToSystem(IN Int coordNum,
  ...
  switch (coordNum) {
    case 0:
      m_particleSystem->m_emissionVelocity.outward.speed.m_low = cylinder;
      return;
    case 1:
      m_particleSystem->m_emissionVelocity.outward.otherSpeed.m_low = cylinder;
      return;
    case 2:
      m_particleSystem->m_emissionVelocity.outward.speed.m_high = cylinder;
      return;
    case 3:
      m_particleSystem->m_emissionVelocity.outward.otherSpeed.m_high = cylinder;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateCurrentParticleSystem(
    ParticleSystemTemplate* particleTemplate) {
  m_particleSystem = particleTemplate;
  performUpdate(true);
}

void DebugWindowDialog::updateSystemUseParameters(
    IN ParticleSystemTemplate* particleTemplate) {
  m_particleSystem = particleTemplate;
  performUpdate(false);
}

void DebugWindowDialog::getInitialDelayFromSystem(
    IN Int parmNum, OUT Real& initialDelay) const {
  if (!m_particleSystem) {
    return;
  }
  ...
  switch (parmNum) {
    case 0:
      initialDelay = m_particleSystem->m_initialDelay.m_low;
      return;
    case 1:
      initialDelay = m_particleSystem->m_initialDelay.m_high;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateInitialDelayToSystem(
    IN Int parmNum, IN const Real& initialDelay) {
  if (!m_particleSystem) {
    return;
  }
  ...
  switch (parmNum) {
    case 0:
      m_particleSystem->m_initialDelay.m_low = initialDelay;
      return;
    case 1:
      m_particleSystem->m_initialDelay.m_high = initialDelay;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getBurstDelayFromSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      burstDelay = m_particleSystem->m_burstDelay.m_low;
      return;
    case 1:
      burstDelay = m_particleSystem->m_burstDelay.m_high;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateBurstDelayToSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      m_particleSystem->m_burstDelay.m_low = burstDelay;
      return;
    case 1:
      m_particleSystem->m_burstDelay.m_high = burstDelay;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getBurstCountFromSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      burstCount = m_particleSystem->m_burstCount.m_low;
      return;
    case 1:
      burstCount = m_particleSystem->m_burstCount.m_high;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateBurstCountToSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      m_particleSystem->m_burstCount.m_low = burstCount;
      return;
    case 1:
      m_particleSystem->m_burstCount.m_high = burstCount;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getColorScaleFromSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      colorScale = m_particleSystem->m_colorScale.m_low;
      return;
    case 1:
      colorScale = m_particleSystem->m_colorScale.m_high;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateColorScaleToSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      m_particleSystem->m_colorScale.m_low = colorScale;
      return;
    case 1:
      m_particleSystem->m_colorScale.m_high = colorScale;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getParticleLifetimeFromSystem(
    IN Int parmNum, OUT Real& particleLifetime) const {
  if (!m_particleSystem) {
    return;
  }
  ...
  switch (parmNum) {
    case 0:
      particleLifetime = m_particleSystem->m_lifetime.m_low;
      return;
    case 1:
      particleLifetime = m_particleSystem->m_lifetime.m_high;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateParticleLifetimeToSystem(
    IN Int parmNum, IN const Real& particleLifetime) {
  if (!m_particleSystem) {
    return;
  }
  ...
  switch (parmNum) {
    case 0:
      m_particleSystem->m_lifetime.m_low = particleLifetime;
      return;
    case 1:
      m_particleSystem->m_lifetime.m_high = particleLifetime;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getParticleSizeFromSystem(
    IN Int parmNum, OUT Real& particleSize) const {
  if (!m_particleSystem) {
    return;
  }
  ...
  switch (parmNum) {
    case 0:
      particleSize = m_particleSystem->m_startSize.m_low;
      return;
    case 1:
      particleSize = m_particleSystem->m_startSize.m_high;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateParticleSizeToSystem(
    IN Int parmNum, IN const Real& particleSize) {
  if (!m_particleSystem) {
    return;
  }
  ...
  switch (parmNum) {
    case 0:
      m_particleSystem->m_startSize.m_low = particleSize;
      return;
    case 1:
      m_particleSystem->m_startSize.m_high = particleSize;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getStartSizeRateFromSystem(
    IN Int parmNum, OUT Real& startSizeRate) const {
  if (!m_particleSystem) {
    return;
  }
  ...
  switch (parmNum) {
    case 0:
      startSizeRate = m_particleSystem->m_startSizeRate.m_low;
      return;
    case 1:
      startSizeRate = m_particleSystem->m_startSizeRate.m_high;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateStartSizeRateToSystem(
    IN Int parmNum, IN const Real& startSizeRate) {
  if (!m_particleSystem) {
    return;
  }
  ...
  switch (parmNum) {
    case 0:
      m_particleSystem->m_startSizeRate.m_low = startSizeRate;
      return;
    case 1:
      m_particleSystem->m_startSizeRate.m_high = startSizeRate;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getSizeRateFromSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      sizeRate = m_particleSystem->m_sizeRate.m_low;
      return;
    case 1:
      sizeRate = m_particleSystem->m_sizeRate.m_high;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateSizeRateToSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      m_particleSystem->m_sizeRate.m_low = sizeRate;
      return;
    case 1:
      m_particleSystem->m_sizeRate.m_high = sizeRate;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getSizeDampingFromSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      sizeDamping = m_particleSystem->m_sizeRateDamping.m_low;
      return;
    case 1:
      sizeDamping = m_particleSystem->m_sizeRateDamping.m_high;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateSizeDampingToSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      m_particleSystem->m_sizeRateDamping.m_low = sizeDamping;
      return;
    case 1:
      m_particleSystem->m_sizeRateDamping.m_high = sizeDamping;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getSystemLifetimeFromSystem(
    OUT Real& systemLifetime) const {
  if (!m_particleSystem) {
    return;
  }
...
void DebugWindowDialog::updateSystemLifetimeToSystem(
    IN const Real& systemLifetime) {
  if (!m_particleSystem) {
    return;
  }
...
void DebugWindowDialog::getSlaveOffsetFromSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      slaveOffset = m_particleSystem->m_slavePosOffset.x;
      return;
    case 1:
      slaveOffset = m_particleSystem->m_slavePosOffset.y;
      return;
    case 2:
      slaveOffset = m_particleSystem->m_slavePosOffset.z;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateSlaveOffsetToSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      m_particleSystem->m_slavePosOffset.x = slaveOffset;
      return;
    case 1:
      m_particleSystem->m_slavePosOffset.y = slaveOffset;
      return;
    case 2:
      m_particleSystem->m_slavePosOffset.z = slaveOffset;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getDriftVelocityFromSystem(
    IN Int parmNum, OUT Real& driftVelocity) const {
  if (!m_particleSystem) {
    return;
  }
  ...
  switch (parmNum) {
    case 0:
      driftVelocity = m_particleSystem->m_driftVelocity.x;
      return;
    case 1:
      driftVelocity = m_particleSystem->m_driftVelocity.y;
      return;
    case 2:
      driftVelocity = m_particleSystem->m_driftVelocity.z;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::updateDriftVelocityToSystem(
    IN Int parmNum, IN const Real& driftVelocity) {
  if (!m_particleSystem) {
    return;
  }
  ...
  switch (parmNum) {
    case 0:
      m_particleSystem->m_driftVelocity.x = driftVelocity;
      return;
    case 1:
      m_particleSystem->m_driftVelocity.y = driftVelocity;
      return;
    case 2:
      m_particleSystem->m_driftVelocity.z = driftVelocity;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getPerParticleSystemFromSystem(
    OUT char* buffer, IN Int bufferSize) const {
  if (!m_particleSystem) {
    return;
  }
...
void DebugWindowDialog::getSwitchFromSystem(IN SwitchType switchType,
  ...
  switch (switchType) {
    case ST_HOLLOW:
      switchVal = m_particleSystem->m_isEmissionVolumeHollow;
      break;
    case ST_ONESHOT:
      switchVal = m_particleSystem->m_isOneShot;
      break;
    case ST_ALIGNXY:
      switchVal = m_particleSystem->m_isGroundAligned;
      break;
    case ST_EMITABOVEGROUNDONLY:
      switchVal = m_particleSystem->m_isEmitAboveGroundOnly;
      break;
    case ST_PARTICLEUPTOWARDSEMITTER:
      switchVal = m_particleSystem->m_isParticleUpTowardsEmitter;
      break;
  };
}
...
void DebugWindowDialog::updateSwitchToSystem(IN SwitchType switchType,
  ...
  switch (switchType) {
    case ST_HOLLOW:
      m_particleSystem->m_isEmissionVolumeHollow = switchVal;
      break;
    case ST_ONESHOT:
      m_particleSystem->m_isOneShot = switchVal;
      break;
    case ST_ALIGNXY:
      m_particleSystem->m_isGroundAligned = switchVal;
      break;
    case ST_EMITABOVEGROUNDONLY:
      m_particleSystem->m_isEmitAboveGroundOnly = switchVal;
      break;
    case ST_PARTICLEUPTOWARDSEMITTER:
      m_particleSystem->m_isParticleUpTowardsEmitter = switchVal;
      break;
  };
}
...
void DebugWindowDialog::getPingPongStartAngleFromSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      angle = m_particleSystem->m_windMotionStartAngleMin;
      break;
    case 1:
      angle = m_particleSystem->m_windMotionStartAngleMax;
      break;
    default:
      return;
  };
...
void DebugWindowDialog::updatePingPongStartAngleToSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      m_particleSystem->m_windMotionStartAngleMin = radian;
      return;
    case 1:
      m_particleSystem->m_windMotionStartAngleMax = radian;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getPingPongEndAngleFromSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      angle = m_particleSystem->m_windMotionEndAngleMin;
      break;
    case 1:
      angle = m_particleSystem->m_windMotionEndAngleMax;
      break;
    default:
      return;
  };
...
void DebugWindowDialog::updatePingPongEndAngleToSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      m_particleSystem->m_windMotionEndAngleMin = radian;
      return;
    case 1:
      m_particleSystem->m_windMotionEndAngleMax = radian;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getWindAngleChangeFromSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      angle = m_particleSystem->m_windAngleChangeMin;
      break;
    case 1:
      angle = m_particleSystem->m_windAngleChangeMax;
      break;
    default:
      return;
  };
...
void DebugWindowDialog::updateWindAngleChangeToSystem(IN Int parmNum,
  ...
  switch (parmNum) {
    case 0:
      m_particleSystem->m_windAngleChangeMin = radian;
      return;
    case 1:
      m_particleSystem->m_windAngleChangeMax = radian;
      return;
    default:
      return;
  };
...
void DebugWindowDialog::getWindMotionFromSystem(
    OUT ParticleSystemInfo::WindMotion& windMotion) const {
  if (!m_particleSystem) {
    return;
  }
...
void DebugWindowDialog::updateWindMotionToSystem(
    IN const ParticleSystemInfo::WindMotion& windMotion) {
  if (!m_particleSystem) {
    return;
  }
...
// The reason I'm using this function is to prohibit me from forgetting to add
// an update one way or the other. The idea is that when you implement one, you
// might as well implement the other, and this way they're in one place.
void DebugWindowDialog::performUpdate(IN Bool toUI) {
  ...
  {  // Update the emission type, velocity type, particle type and shader type.
    ...
    if (pCombo) {
      int selndx;
      if (toUI) {
        selndx = pCombo->SelectString(
            -1, ParticlePriorityNames[(long)m_particleSystem->m_priority]);
      } else {
    ...
    if (pCombo) {
      ...
      if (toUI) {
        selndx = pCombo->SelectString(
            -1, EmissionVolumeTypeNames[(long)m_particleSystem
                                            ->m_emissionVolumeType]);
      } else {
        selndx = pCombo->GetCurSel();
        if (selndx >= 0) {
          m_particleSystem->m_emissionVolumeType =
              (ParticleSystemInfo::EmissionVolumeType)(selndx + 1);
        }
      }
    ...
    if (pCombo) {
      ...
      if (toUI) {
        selndx = pCombo->SelectString(
            -1, EmissionVelocityTypeNames[(long)m_particleSystem
                                              ->m_emissionVelocityType]);
      } else {
        selndx = pCombo->GetCurSel();
        if (selndx >= 0) {
          m_particleSystem->m_emissionVelocityType =
              (ParticleSystemInfo::EmissionVelocityType)(selndx + 1);
        }
      }
    ...
    if (pCombo) {
      ...
      if (toUI) {
        selndx = pCombo->SelectString(
            -1, ParticleTypeNames[(long)m_particleSystem->m_particleType]);
      } else {
        selndx = pCombo->GetCurSel();
        if (selndx >= 0) {
          m_particleSystem->m_particleType =
              (ParticleSystemInfo::ParticleType)(selndx + 1);
        }
      }
    ...
    if (pCombo) {
      if (toUI) {
        pCombo->SelectString(
            -1, ParticleShaderTypeNames[(long)m_particleSystem->m_shaderType]);
      } else {
        int selndx = pCombo->GetCurSel();
        if (selndx >= 0) {
          m_particleSystem->m_shaderType =
              (ParticleSystemInfo::ParticleShaderType)(selndx + 1);
        }
      }
    }
  }

  {  // update the minimum and maximum for Angle X, Y and Z, and Angular X, Y,
     // and Z
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_angleX.getMinimumValue());
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_angleY.getMinimumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_angleZ.getMinimumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_angleX.getMaximumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_angleY.getMaximumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_angleZ.getMaximumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_angularRateX.getMinimumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_angularRateY.getMinimumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_angularRateZ.getMinimumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_angularRateX.getMaximumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_angularRateY.getMaximumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_angularRateZ.getMaximumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
  ...
  {  // update the damping values.
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_angularDamping.getMinimumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_angularDamping.getMaximumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_velDamping.getMinimumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
    ...
    if (pWnd) {
      if (toUI) {
        sprintf(buff, FORMAT_STRING,
                m_particleSystem->m_velDamping.getMaximumValue());
        pWnd->SetWindowText(buff);
      } else {
        pWnd->GetWindowText(buff, ARBITRARY_BUFF_SIZE - 1);
...
void DebugWindowDialog::OnParticleSystemEdit() { signalParticleSystemEdit(); }

void DebugWindowDialog::signalParticleSystemEdit(void) { performUpdate(false); }
...
Bool DebugWindowDialog::shouldBusyWait(void) { return m_shouldBusyWait; }
...
void DebugWindowDialog::OnReloadSystem(void) { m_shouldReload = true; }

void DebugWindowDialog::OnReloadCurrent() { OnReloadSystem(); }

void DebugWindowDialog::OnReloadAll() { OnReloadSystem(); }

void DebugWindowDialog::OnSaveCurrent() { OnPushSave(); }

void DebugWindowDialog::OnSaveAll() { OnPushSave(); }
