...
template <typename T>
bool IsCharacter(WChar ch, const T* oneOf) {
  assert(oneOf != NULL);
...
template <typename T>
bool StripLeft(WChar* string, const T* trimChars) {
...
template <typename T>
bool StripRight(WChar* string, const T* trimChars) {
...
UString::UString() : mData(NULL), mCapacity(0) {}
...
UString::UString(UInt capacity) : mData(NULL), mCapacity(0) {
...
UString::UString(const Char* s) : mData(NULL), mCapacity(0) { Copy(s); }
...
UString::UString(const WChar* ws) : mData(NULL), mCapacity(0) { Copy(ws); }
...
UString::UString(const UString& s) : mData(NULL), mCapacity(0) { Copy(s); }
...
void UString::Copy(const UString& s) { Copy(s.Get()); }
...
void UString::Concat(const UString& s) { Concat(s.Get()); }
...
Int UString::Compare(const WChar* ws) const { return wcscmp(ws, Get()); }
...
Int UString::Compare(const UString& s) const { return Compare(s.Get()); }
...
Int UString::CompareNoCase(const WChar* ws) const { return wcsicmp(ws, Get()); }
...
Int UString::Find(Char c) const { return Find((WChar)c); }
...
Int UString::FindLast(Char c) const { return FindLast((WChar)c); }
...
UInt UString::Capacity(void) const { return mCapacity; }
