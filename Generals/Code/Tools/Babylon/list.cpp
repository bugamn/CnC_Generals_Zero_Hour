...
void ListNode::Append(ListNode *new_node) {
  assert(!new_node
              ->InList()); /* node is already in a list or was not initialized*/
...
int ListNode::InList(void) { return prev != this; }

int ListNode::IsHead(void) { return item == &this->item; }

int ListNode::Priority(void) { return pri; }
...
List::List(void) { SetItem(&this->item); }
