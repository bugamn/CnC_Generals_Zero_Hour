...
// MDC: Made all this dependent on _REENTRANT being defined so VC++ doesn't
// complain on single-threaded programs...
...
//
//
// Since Win32 & POSIX have different type signatures for the thread entry
// points
//  an intermediate system-dependent function in this file gets called first.
//  That function then calls the system independent version.  So the system
//  dependent version needs 2 Items  1) The address of the _real_ thread func 2)
//  the data to pass.  We only have 1 argument available, so you figure out the
//  rest...
//
