...
// Project:    GUIEdit
//
// File name:  C:\projects\RTS\code\Tools\GUIEdit\Source\Dialog
// Procedures\TabControlProperties.cpp
//
...
static void GadgetTabControlUpdatePaneNames(GameWindow *tabControl) {
  ...
  for (Int paneIndex = 0; paneIndex < NUM_TAB_PANES; paneIndex++) {
    WinInstanceData *paneInstData =
        tabData->subPanes[paneIndex]->winGetInstanceData();

    char buffer[128];  // legal limit is 64, which will be checked at save.
    sprintf(buffer, "%s Pane %d", controlInstData->m_decoratedNameString.str(),
            paneIndex);
      ...
      switch (controlID) {
        ...
        case IDOK: {
          ...
          if (tabControl) {
            ...
            GadgetTabControlSetEnabledBorderColorTabZero(tabControl,
                                                         info->borderColor);
            ...
            GadgetTabControlSetEnabledBorderColorTabOne(tabControl,
                                                        info->borderColor);
            ...
            GadgetTabControlSetEnabledBorderColorTabTwo(tabControl,
                                                        info->borderColor);
            ...
            GadgetTabControlSetEnabledBorderColorTabThree(tabControl,
                                                          info->borderColor);
            ...
            GadgetTabControlSetEnabledBorderColorTabFour(tabControl,
                                                         info->borderColor);
            ...
            GadgetTabControlSetEnabledBorderColorTabFive(tabControl,
                                                         info->borderColor);
            ...
            GadgetTabControlSetEnabledBorderColorTabSix(tabControl,
                                                        info->borderColor);
            ...
            GadgetTabControlSetEnabledBorderColorTabSeven(tabControl,
                                                          info->borderColor);
            ...
            GadgetTabControlSetEnabledBorderColorBackground(tabControl,
                                                            info->borderColor);
            ...
            GadgetTabControlSetDisabledBorderColorTabZero(tabControl,
                                                          info->borderColor);
            ...
            GadgetTabControlSetDisabledBorderColorTabOne(tabControl,
                                                         info->borderColor);
            ...
            GadgetTabControlSetDisabledBorderColorTabTwo(tabControl,
                                                         info->borderColor);
            ...
            GadgetTabControlSetDisabledBorderColorTabThree(tabControl,
                                                           info->borderColor);
            ...
            GadgetTabControlSetDisabledBorderColorTabFour(tabControl,
                                                          info->borderColor);
            ...
            GadgetTabControlSetDisabledBorderColorTabFive(tabControl,
                                                          info->borderColor);
            ...
            GadgetTabControlSetDisabledBorderColorTabSix(tabControl,
                                                         info->borderColor);
            ...
            GadgetTabControlSetDisabledBorderColorTabSeven(tabControl,
                                                           info->borderColor);
            ...
            GadgetTabControlSetDisabledBorderColorBackground(tabControl,
                                                             info->borderColor);
            ...
            GadgetTabControlSetHiliteBorderColorTabZero(tabControl,
                                                        info->borderColor);
            ...
            GadgetTabControlSetHiliteBorderColorTabOne(tabControl,
                                                       info->borderColor);
            ...
            GadgetTabControlSetHiliteBorderColorTabTwo(tabControl,
                                                       info->borderColor);
            ...
            GadgetTabControlSetHiliteBorderColorTabThree(tabControl,
                                                         info->borderColor);
            ...
            GadgetTabControlSetHiliteBorderColorTabFour(tabControl,
                                                        info->borderColor);
            ...
            GadgetTabControlSetHiliteBorderColorTabFive(tabControl,
                                                        info->borderColor);
            ...
            GadgetTabControlSetHiliteBorderColorTabSix(tabControl,
                                                       info->borderColor);
            ...
            GadgetTabControlSetHiliteBorderColorTabSeven(tabControl,
                                                         info->borderColor);
            ...
            GadgetTabControlSetHiliteBorderColorBackground(tabControl,
                                                           info->borderColor);

            TabControlData *tabData =
                (TabControlData *)tabControl->winGetUserData();

            tabData->tabWidth =
                GetDlgItemInt(hWndDialog, TAB_WIDTH, NULL, FALSE);
            tabData->tabHeight =
                GetDlgItemInt(hWndDialog, TAB_HEIGHT, NULL, FALSE);
            tabData->tabCount =
                GetDlgItemInt(hWndDialog, TAB_COUNT, NULL, FALSE);
            tabData->paneBorder =
                GetDlgItemInt(hWndDialog, BORDER_WIDTH, NULL, FALSE);
            tabData->activeTab =
                GetDlgItemInt(hWndDialog, ACTIVE_TAB, NULL, FALSE);
...
HWND InitTabControlPropertiesDialog(GameWindow *tabControl) {
  ...
  dialog = CreateDialog(
      TheEditor->getInstance(), (LPCTSTR)TAB_CONTROL_PROPERTIES_DIALOG,
      TheEditor->getWindowHandle(), (DLGPROC)tabControlPropertiesCallback);
