      ...
      switch (controlID) {
        ...
        case IDOK: {
          ...
          if (window) {
            ...
            GadgetProgressBarSetEnabledBarBorderColor(window,
                                                      info->borderColor);
            ...
            GadgetProgressBarSetDisabledBarBorderColor(window,
                                                       info->borderColor);
            ...
            GadgetProgressBarSetDisabledBarImageSmallCenter(window,
                                                            info->image);
...
HWND InitProgressBarPropertiesDialog(GameWindow *window) {
  ...
  dialog = CreateDialog(
      TheEditor->getInstance(), (LPCTSTR)PROGRESS_BAR_PROPERTIES_DIALOG,
      TheEditor->getWindowHandle(), (DLGPROC)progressBarPropertiesCallback);
