    ...
    case WM_COMMAND: {
      ...
      switch (controlID) {
        ...
        case BUTTON_SUBCONTROL_COLOR: {
          ...
          StoreColor(COMBOBOX_DROP_DOWN_BUTTON_ENABLED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_UP_BUTTON_ENABLED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_DOWN_BUTTON_ENABLED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_SLIDER_ENABLED_TOP, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_SLIDER_THUMB_ENABLED, info->color,
                     info->borderColor);

          info = GetStateInfo(COMBOBOX_LISTBOX_ENABLED_SELECTED_ITEM_LEFT);
          StoreColor(COMBOBOX_EDIT_BOX_ENABLED_LEFT, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_DROP_DOWN_BUTTON_ENABLED_PUSHED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_UP_BUTTON_ENABLED_PUSHED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_ENABLED_SELECTED_ITEM_LEFT, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_DOWN_BUTTON_ENABLED_PUSHED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_SLIDER_THUMB_ENABLED_PUSHED, info->color,
                     info->borderColor);

          info = GetStateInfo(COMBOBOX_DISABLED);
          StoreColor(COMBOBOX_DROP_DOWN_BUTTON_DISABLED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_DISABLED, info->color, info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_UP_BUTTON_DISABLED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_DOWN_BUTTON_DISABLED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_SLIDER_DISABLED_TOP, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_SLIDER_THUMB_DISABLED, info->color,
                     info->borderColor);

          info = GetStateInfo(COMBOBOX_DISABLED_SELECTED_ITEM_LEFT);
          StoreColor(COMBOBOX_EDIT_BOX_DISABLED_LEFT, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_DROP_DOWN_BUTTON_DISABLED_PUSHED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_DISABLED_SELECTED_ITEM_LEFT, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_UP_BUTTON_DISABLED_PUSHED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_DOWN_BUTTON_DISABLED_PUSHED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_SLIDER_THUMB_DISABLED_PUSHED, info->color,
                     info->borderColor);

          info = GetStateInfo(COMBOBOX_HILITE);
          StoreColor(COMBOBOX_DROP_DOWN_BUTTON_HILITE, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_HILITE, info->color, info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_UP_BUTTON_HILITE, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_DOWN_BUTTON_HILITE, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_SLIDER_HILITE_TOP, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_SLIDER_THUMB_HILITE, info->color,
                     info->borderColor);

          info = GetStateInfo(COMBOBOX_HILITE_SELECTED_ITEM_LEFT);
          StoreColor(COMBOBOX_DROP_DOWN_BUTTON_HILITE_PUSHED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_EDIT_BOX_HILITE_LEFT, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_HILITE_SELECTED_ITEM_LEFT, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_UP_BUTTON_HILITE_PUSHED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_DOWN_BUTTON_HILITE_PUSHED, info->color,
                     info->borderColor);
          StoreColor(COMBOBOX_LISTBOX_SLIDER_THUMB_HILITE_PUSHED, info->color,
                     info->borderColor);
        ...
        case IDOK: {
          ...
          if (window) {
            ...
            if (SaveCommonDialogProperties(hWndDialog, window) == FALSE) break;
            ...
            GadgetComboBoxSetEnabledSelectedItemBorderColor(window,
                                                            info->borderColor);
            ...
            GadgetComboBoxSetEnabledSelectedItemImageCenter(window,
                                                            info->image);
            info = GetStateInfo(COMBOBOX_ENABLED_SELECTED_ITEM_SMALL_CENTER);
            GadgetComboBoxSetEnabledSelectedItemImageSmallCenter(window,
                                                                 info->image);
            ...
            GadgetComboBoxSetDisabledSelectedItemBorderColor(window,
                                                             info->borderColor);
            info = GetStateInfo(COMBOBOX_DISABLED_SELECTED_ITEM_RIGHT);
            GadgetComboBoxSetDisabledSelectedItemImageRight(window,
                                                            info->image);
            info = GetStateInfo(COMBOBOX_DISABLED_SELECTED_ITEM_CENTER);
            GadgetComboBoxSetDisabledSelectedItemImageCenter(window,
                                                             info->image);
            info = GetStateInfo(COMBOBOX_DISABLED_SELECTED_ITEM_SMALL_CENTER);
            GadgetComboBoxSetDisabledSelectedItemImageSmallCenter(window,
                                                                  info->image);
            ...
            GadgetComboBoxSetHiliteSelectedItemBorderColor(window,
                                                           info->borderColor);
            ...
            GadgetComboBoxSetHiliteSelectedItemImageSmallCenter(window,
                                                                info->image);

            GameWindow *dropDownButton =
                GadgetComboBoxGetDropDownButton(window);
            if (dropDownButton) {
              // save the image and color data
              // ----------------------------------------------------------------
              ...
              GadgetButtonSetEnabledBorderColor(dropDownButton,
                                                info->borderColor);
              ...
              GadgetButtonSetDisabledBorderColor(dropDownButton,
                                                 info->borderColor);
              ...
              GadgetButtonSetHiliteBorderColor(dropDownButton,
                                               info->borderColor);
            ...
            if (listBox) {
              ...
              info = GetStateInfo(COMBOBOX_LISTBOX_ENABLED_SELECTED_ITEM_LEFT);
              GadgetListBoxSetEnabledSelectedItemImageLeft(listBox,
                                                           info->image);
              ...
              GadgetListBoxSetEnabledSelectedItemImageRight(listBox,
                                                            info->image);
              info =
                  GetStateInfo(COMBOBOX_LISTBOX_ENABLED_SELECTED_ITEM_CENTER);
              GadgetListBoxSetEnabledSelectedItemImageCenter(listBox,
                                                             info->image);
              info = GetStateInfo(
                  COMBOBOX_LISTBOX_ENABLED_SELECTED_ITEM_SMALL_CENTER);
              GadgetListBoxSetEnabledSelectedItemImageSmallCenter(listBox,
                                                                  info->image);
              ...
              GadgetListBoxSetDisabledSelectedItemImageLeft(listBox,
                                                            info->image);
              GadgetListBoxSetDisabledSelectedItemColor(listBox, info->color);
              GadgetListBoxSetDisabledSelectedItemBorderColor(
                  listBox, info->borderColor);
              info =
                  GetStateInfo(COMBOBOX_LISTBOX_DISABLED_SELECTED_ITEM_RIGHT);
              GadgetListBoxSetDisabledSelectedItemImageRight(listBox,
                                                             info->image);
              info =
                  GetStateInfo(COMBOBOX_LISTBOX_DISABLED_SELECTED_ITEM_CENTER);
              GadgetListBoxSetDisabledSelectedItemImageCenter(listBox,
                                                              info->image);
              info = GetStateInfo(
              ...
              GadgetListBoxSetHiliteSelectedItemBorderColor(listBox,
                                                            info->borderColor);
              info = GetStateInfo(COMBOBOX_LISTBOX_HILITE_SELECTED_ITEM_RIGHT);
              GadgetListBoxSetHiliteSelectedItemImageRight(listBox,
                                                           info->image);
              info = GetStateInfo(COMBOBOX_LISTBOX_HILITE_SELECTED_ITEM_CENTER);
              GadgetListBoxSetHiliteSelectedItemImageCenter(listBox,
                                                            info->image);
              info = GetStateInfo(
                  COMBOBOX_LISTBOX_HILITE_SELECTED_ITEM_SMALL_CENTER);
              GadgetListBoxSetHiliteSelectedItemImageSmallCenter(listBox,
                                                                 info->image);
              ...
              if (upButton) {
                ...
                GadgetButtonSetEnabledSelectedBorderColor(upButton,
                                                          info->borderColor);
                ...
                GadgetButtonSetDisabledSelectedBorderColor(upButton,
                                                           info->borderColor);
                ...
                GadgetButtonSetHiliteSelectedBorderColor(upButton,
                                                         info->borderColor);
              ...
              if (downButton) {
                ...
                GadgetButtonSetEnabledBorderColor(downButton,
                                                  info->borderColor);

                info =
                    GetStateInfo(COMBOBOX_LISTBOX_DOWN_BUTTON_ENABLED_PUSHED);
                ...
                GadgetButtonSetDisabledBorderColor(downButton,
                                                   info->borderColor);

                info =
                    GetStateInfo(COMBOBOX_LISTBOX_DOWN_BUTTON_DISABLED_PUSHED);
                ...
                GadgetButtonSetHiliteSelectedBorderColor(downButton,
                                                         info->borderColor);
              ...
              if (slider) {
                ...
                info =
                    GetStateInfo(COMBOBOX_LISTBOX_SLIDER_ENABLED_SMALL_CENTER);
                ...
                info =
                    GetStateInfo(COMBOBOX_LISTBOX_SLIDER_DISABLED_SMALL_CENTER);
                ...
                info =
                    GetStateInfo(COMBOBOX_LISTBOX_SLIDER_HILITE_SMALL_CENTER);
                ...
                GadgetSliderSetEnabledThumbBorderColor(slider,
                                                       info->borderColor);

                info =
                    GetStateInfo(COMBOBOX_LISTBOX_SLIDER_THUMB_ENABLED_PUSHED);
                ...
                GadgetSliderSetDisabledThumbBorderColor(slider,
                                                        info->borderColor);

                info =
                    GetStateInfo(COMBOBOX_LISTBOX_SLIDER_THUMB_DISABLED_PUSHED);
                ...
                GadgetSliderSetHiliteThumbBorderColor(slider,
                                                      info->borderColor);

                info =
                    GetStateInfo(COMBOBOX_LISTBOX_SLIDER_THUMB_HILITE_PUSHED);
            ...
            GadgetComboBoxSetIsEditable(
                window, IsDlgButtonChecked(hWndDialog, CHECK_IS_EDITABLE));
            GadgetComboBoxSetAsciiOnly(
                window, IsDlgButtonChecked(hWndDialog, CHECK_ASCII_TEXT));
            GadgetComboBoxSetLettersAndNumbersOnly(
                window,
                IsDlgButtonChecked(hWndDialog, CHECK_LETTERS_AND_NUMBERS));

            // change in the size of the comboBox
            Int newMaxChars =
                GetDlgItemInt(hWndDialog, EDIT_MAX_CHARS, NULL, FALSE);
            if (newMaxChars != comboData->maxChars)
              GadgetComboBoxSetMaxChars(window, newMaxChars);

            Int newMaxDisplay = GetDlgItemInt(
                hWndDialog, EDIT_MAX_ITEMS_DISPLAYED, NULL, FALSE);
...
HWND InitComboBoxPropertiesDialog(GameWindow *window) {
  ...
  dialog = CreateDialog(
      TheEditor->getInstance(), (LPCTSTR)COMBO_BOX_PROPERTIES_DIALOG,
      TheEditor->getWindowHandle(), (DLGPROC)comboBoxPropertiesCallback);
  ...
  StoreImageAndColor(COMBOBOX_ENABLED_SELECTED_ITEM_LEFT, image, color,
                     borderColor);
  ...
  StoreImageAndColor(COMBOBOX_DISABLED_SELECTED_ITEM_LEFT, image, color,
                     borderColor);
  ...
  StoreImageAndColor(COMBOBOX_HILITE_SELECTED_ITEM_LEFT, image, color,
                     borderColor);
  ...
  if (listBox) {
    ...
    StoreImageAndColor(COMBOBOX_LISTBOX_ENABLED_SELECTED_ITEM_LEFT, image,
                       color, borderColor);
    ...
    StoreImageAndColor(COMBOBOX_LISTBOX_ENABLED_SELECTED_ITEM_SMALL_CENTER,
    ...
    StoreImageAndColor(COMBOBOX_LISTBOX_HILITE_SELECTED_ITEM_LEFT, image, color,
                       borderColor);
    ...
    if (upButton) {
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_UP_BUTTON_ENABLED, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_UP_BUTTON_ENABLED_PUSHED, image,
                         color, borderColor);
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_UP_BUTTON_DISABLED, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_UP_BUTTON_HILITE, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_UP_BUTTON_HILITE_PUSHED, image, color,
                         borderColor);
    ...
    if (downButton) {
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_DOWN_BUTTON_ENABLED, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_DOWN_BUTTON_ENABLED_PUSHED, image,
                         color, borderColor);
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_DOWN_BUTTON_DISABLED, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_DOWN_BUTTON_HILITE, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_DOWN_BUTTON_HILITE_PUSHED, image,
                         color, borderColor);
    ...
    if (slider) {
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_SLIDER_ENABLED_TOP, image, color,
                         borderColor);

      image = GadgetSliderGetEnabledImageBottom(slider);
      StoreImageAndColor(COMBOBOX_LISTBOX_SLIDER_ENABLED_BOTTOM, image, color,
                         borderColor);

      image = GadgetSliderGetEnabledImageCenter(slider);
      StoreImageAndColor(COMBOBOX_LISTBOX_SLIDER_ENABLED_CENTER, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_SLIDER_DISABLED_TOP, image, color,
                         borderColor);

      image = GadgetSliderGetDisabledImageBottom(slider);
      StoreImageAndColor(COMBOBOX_LISTBOX_SLIDER_DISABLED_BOTTOM, image, color,
                         borderColor);

      image = GadgetSliderGetDisabledImageCenter(slider);
      StoreImageAndColor(COMBOBOX_LISTBOX_SLIDER_DISABLED_CENTER, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_SLIDER_HILITE_TOP, image, color,
                         borderColor);

      image = GadgetSliderGetHiliteImageBottom(slider);
      StoreImageAndColor(COMBOBOX_LISTBOX_SLIDER_HILITE_BOTTOM, image, color,
                         borderColor);

      image = GadgetSliderGetHiliteImageCenter(slider);
      StoreImageAndColor(COMBOBOX_LISTBOX_SLIDER_HILITE_CENTER, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_SLIDER_THUMB_ENABLED, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_SLIDER_THUMB_DISABLED, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_SLIDER_THUMB_HILITE, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_LISTBOX_SLIDER_THUMB_HILITE_PUSHED, image,
                         color, borderColor);
    ...
    if (dropDownButton) {
      ...
      StoreImageAndColor(COMBOBOX_DROP_DOWN_BUTTON_ENABLED, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_DROP_DOWN_BUTTON_ENABLED_PUSHED, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_DROP_DOWN_BUTTON_DISABLED, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_DROP_DOWN_BUTTON_HILITE, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_DROP_DOWN_BUTTON_HILITE_PUSHED, image, color,
                         borderColor);
    }
    GameWindow *editBox = GadgetComboBoxGetEditBox(window);
    if (editBox) {
      ...
      StoreImageAndColor(COMBOBOX_EDIT_BOX_ENABLED_LEFT, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_EDIT_BOX_DISABLED_LEFT, image, color,
                         borderColor);
      ...
      StoreImageAndColor(COMBOBOX_EDIT_BOX_HILITE_LEFT, image, color,
                         borderColor);
      image = GadgetTextEntryGetHiliteImageRight(editBox);
      StoreImageAndColor(COMBOBOX_EDIT_BOX_HILITE_RIGHT, image,
                         WIN_COLOR_UNDEFINED, WIN_COLOR_UNDEFINED);
  ...
  CheckDlgButton(dialog, CHECK_LETTERS_AND_NUMBERS,
