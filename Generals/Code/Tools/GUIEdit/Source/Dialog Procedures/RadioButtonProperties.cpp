      ...
      switch (controlID) {
        ...
        case IDOK: {
          ...
          if (window) {
            ...
            GadgetRadioSetEnabledUncheckedBoxBorderColor(window,
                                                         info->borderColor);
            ...
            GadgetRadioSetEnabledCheckedBoxBorderColor(window,
                                                       info->borderColor);
            ...
            GadgetRadioSetDisabledUncheckedBoxBorderColor(window,
                                                          info->borderColor);
            ...
            GadgetRadioSetDisabledCheckedBoxBorderColor(window,
                                                        info->borderColor);
            ...
            GadgetRadioSetHiliteUncheckedBoxBorderColor(window,
                                                        info->borderColor);
            ...
            GadgetRadioSetHiliteCheckedBoxBorderColor(window,
                                                      info->borderColor);

            // save group
            Int group = GetDlgItemInt(hWndDialog, COMBO_GROUP, NULL, FALSE);
            Int screen = TheNameKeyGenerator->nameToKey(
                AsciiString(TheEditor->getSaveFilename()));
...
HWND InitRadioButtonPropertiesDialog(GameWindow *window) {
  ...
  dialog = CreateDialog(
      TheEditor->getInstance(), (LPCTSTR)RADIO_BUTTON_PROPERTIES_DIALOG,
      TheEditor->getWindowHandle(), (DLGPROC)radioButtonPropertiesCallback);
