...
// /////////////////////////////////////////////////////////////////// Author:
// Bryan Cleveland, March 2002 Desc:   Damage module that goes with BoneFX
// update
///////////////////////////////////////////////////////////////////////////////////////////////////
...
BoneFXDamage::BoneFXDamage(Thing *thing, const ModuleData *moduleData)
    : DamageModule(thing, moduleData) {}  // end BoneFXDamage

//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
BoneFXDamage::~BoneFXDamage(void) {}  // end ~BoneFXDamage
...
void BoneFXDamage::onBodyDamageStateChange(const DamageInfo *damageInfo,
  ...
  BoneFXUpdate *bfxu =
      (BoneFXUpdate *)getObject()->findUpdateModule(key_BoneFXUpdate);
  if (bfxu) bfxu->changeBodyDamageState(oldState, newState);
