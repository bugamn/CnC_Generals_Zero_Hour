...
// //////////////////////////////////////////////////////////// Author: Matthew
// D. Campbell, May 2002 Desc:   Die method responsible for telling
// TheScriptEngine that a special power has been completed
///////////////////////////////////////////////////////////////////////////////////////////////////
...
void SpecialPowerCompletionDie::notifyScriptEngine(void) {
  if (m_creatorID != INVALID_ID) {
    TheScriptEngine->notifyOfCompletedSpecialPower(
        ...
        getSpecialPowerCompletionDieModuleData()
            ->m_specialPowerTemplate->getName(),
        m_creatorID);
  }
}
