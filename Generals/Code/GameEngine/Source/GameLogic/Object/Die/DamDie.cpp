...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
DamDieModuleData::DamDieModuleData(void) {}  // end DamDieModuleData
...
DamDie::DamDie(Thing *thing, const ModuleData *moduleData)
    : DieModule(thing, moduleData) {}  // end DamDie

// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
DamDie::~DamDie(void) {}  // end ~DamDie
...
void DamDie::onDie(const DamageInfo *damageInfo) {
  ...
  for (obj = TheGameLogic->getFirstObject(); obj; obj = obj->getNextObject()) {
    ...
    if (obj->isKindOf(KINDOF_WAVEGUIDE) == FALSE) continue;
