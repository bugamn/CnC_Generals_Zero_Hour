...
// Desc:	 An upgrade that starts the timer on a Special Power module, so
// you can have them dependent on upgrades on the logic side, like NEED_UPGRADE
// does on the client side by disabling the button.
///////////////////////////////////////////////////////////////////////////////////////////////////
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
/* static */ void UnpauseSpecialPowerUpgradeModuleData::buildFieldParse(
...
void UnpauseSpecialPowerUpgrade::upgradeImplementation(void) {
  for (BehaviorModule** m = getObject()->getBehaviorModules(); *m; ++m) {
    ...
    if (sp->getSpecialPowerTemplate() ==
        getUnpauseSpecialPowerUpgradeModuleData()->m_specialPower)
