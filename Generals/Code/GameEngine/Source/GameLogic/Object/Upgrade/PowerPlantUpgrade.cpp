...
PowerPlantUpgrade::PowerPlantUpgrade(Thing *thing, const ModuleData *moduleData)
    : UpgradeModule(thing, moduleData) {}  // end PowerPlantUpgrade

//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
PowerPlantUpgrade::~PowerPlantUpgrade(void) {}  // end ~PowerPlantUpgrade
...
void PowerPlantUpgrade::upgradeImplementation(void) {
  ...
  if (player) player->addPowerBonus(getObject());
...
void PowerPlantUpgrade::loadPostProcess(void) {
  ...
  // Most upgrade modules have state change effects that are themselves saved.
  // This one is a fire and forget. So we need to re-fire on load if we are
  // turned on.
