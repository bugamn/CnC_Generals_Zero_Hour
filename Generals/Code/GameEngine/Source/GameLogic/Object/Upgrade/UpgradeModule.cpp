...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
Bool UpgradeMux::isAlreadyUpgraded() const { return m_upgradeExecuted; }

// ------------------------------------------------------------------------------------------------
// ***DANGER! DANGER! Don't use this, unless you are forcing an already made
// upgrade to refresh!!
// ------------------------------------------------------------------------------------------------
...
Bool UpgradeMux::attemptUpgrade(Int64 keyMask) {
  if (wouldUpgrade(keyMask)) {
    // If I have an activation condition, and I haven't activated, and this key
...
Bool UpgradeMux::wouldUpgrade(Int64 keyMask) const {
  ...
  // Make sure we have activation conditions and we haven't performed the
  // upgrade already.
