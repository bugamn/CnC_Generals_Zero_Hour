...
// Desc:   Update module to handle building states and weapon firing of the
...
//-------------------------------------------------------------------------------------------------
/*static*/ void ParticleUplinkCannonUpdateModuleData::buildFieldParse(
    MultiIniFieldParse &p) {
  ModuleData::buildFieldParse(p);

  static const FieldParse dataFieldParse[] = {
      {"SpecialPowerTemplate", INI::parseSpecialPowerTemplate, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_specialPowerTemplate)},
      {"BeginChargeTime", INI::parseDurationUnsignedInt, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_beginChargeFrames)},
      {"RaiseAntennaTime", INI::parseDurationUnsignedInt, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_raiseAntennaFrames)},
      {"ReadyDelayTime", INI::parseDurationUnsignedInt, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_readyDelayFrames)},
      {"WidthGrowTime", INI::parseDurationUnsignedInt, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_widthGrowFrames)},
      {"BeamTravelTime", INI::parseDurationUnsignedInt, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_beamTravelFrames)},
      {"TotalFiringTime", INI::parseDurationUnsignedInt, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_totalFiringFrames)},
      {"RevealRange", INI::parseReal, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_revealRange)},

      {"OuterEffectBoneName", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_outerEffectBaseBoneName)},
      {"OuterEffectNumBones", INI::parseUnsignedInt, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_outerEffectNumBones)},
      {"OuterNodesLightFlareParticleSystem", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_outerNodesLightFlareParticleSystemName)},
      {"OuterNodesMediumFlareParticleSystem", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_outerNodesMediumFlareParticleSystemName)},
      {"OuterNodesIntenseFlareParticleSystem", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_outerNodesIntenseFlareParticleSystemName)},

      {"ConnectorBoneName", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_connectorBoneName)},
      {"ConnectorMediumLaserName", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_connectorMediumLaserNameName)},
      {"ConnectorIntenseLaserName", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_connectorIntenseLaserNameName)},
      {"ConnectorMediumFlare", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_connectorMediumFlareParticleSystemName)},
      {"ConnectorIntenseFlare", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_connectorIntenseFlareParticleSystemName)},

      {"FireBoneName", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_fireBoneName)},
      {"LaserBaseLightFlareParticleSystemName", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_laserBaseLightFlareParticleSystemName)},
      {"LaserBaseMediumFlareParticleSystemName", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_laserBaseMediumFlareParticleSystemName)},
      {"LaserBaseIntenseFlareParticleSystemName", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_laserBaseIntenseFlareParticleSystemName)},

      {"ParticleBeamLaserName", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_particleBeamLaserName)},

      {"SwathOfDeathDistance", INI::parseReal, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_swathOfDeathDistance)},
      {"SwathOfDeathAmplitude", INI::parseReal, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_swathOfDeathAmplitude)},
      {"TotalScorchMarks", INI::parseUnsignedInt, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_totalScorchMarks)},
      {"ScorchMarkScalar", INI::parseReal, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_scorchMarkScalar)},
      {"BeamLaunchFX", INI::parseFXList, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_beamLaunchFX)},
      {"DelayBetweenLaunchFX", INI::parseDurationUnsignedInt, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_framesBetweenLaunchFXRefresh)},
      {"GroundHitFX", INI::parseFXList, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_groundHitFX)},

      {"DamagePerSecond", INI::parseReal, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_damagePerSecond)},
      {"TotalDamagePulses", INI::parseUnsignedInt, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_totalDamagePulses)},
      {"DamageType", INI::parseIndexList, TheDamageNames,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_damageType)},
      {"DeathType", INI::parseIndexList, TheDeathNames,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_deathType)},
      {"DamageRadiusScalar", INI::parseReal, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_damageRadiusScalar)},

      {"PoweringUpSoundLoop", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_powerupSoundName)},
      {"UnpackToIdleSoundLoop", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_unpackToReadySoundName)},
      {"FiringToPackSoundLoop", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_firingToIdleSoundName)},
      {"GroundAnnihilationSoundLoop", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_annihilationSoundName)},
      {"DamagePulseRemnantObjectName", INI::parseAsciiString, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_damagePulseRemnantObjectName)},

      {"ManualDrivingSpeed", INI::parseReal, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData, m_manualDrivingSpeed)},
      {"ManualFastDrivingSpeed", INI::parseReal, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
                m_manualFastDrivingSpeed)},
      {"DoubleClickToFastDriveDelay", INI::parseDurationUnsignedInt, NULL,
       offsetof(ParticleUplinkCannonUpdateModuleData,
...
void ParticleUplinkCannonUpdate::killEverything() {
  ...
  // This laser is independent from the other effects and needs to be specially
  // handled.
...
void ParticleUplinkCannonUpdate::onObjectCreated() {
  const ParticleUplinkCannonUpdateModuleData *data =
      getParticleUplinkCannonUpdateModuleData();
  Object *obj = getObject();

  if (!data->m_specialPowerTemplate) {
    DEBUG_CRASH(
        ("%s object's ParticleUplinkCannonUpdate lacks access to the "
         "SpecialPowerTemplate. Needs to be specified in ini.",
  ...
  m_specialPowerModule =
      obj->getSpecialPowerModule(data->m_specialPowerTemplate);
...
//-------------------------------------------------------------------------------------------------
void ParticleUplinkCannonUpdate::initiateIntentToDoSpecialPower(
  ...
  SpecialPowerModuleInterface *spmInterface =
      getObject()->getSpecialPowerModule(specialPowerTemplate);
  if (spmInterface) {
...
//-------------------------------------------------------------------------------------------------
Bool ParticleUplinkCannonUpdate::isPowerCurrentlyInUse(
    const CommandButton *command) const {
  if (m_startAttackFrame != 0 &&
      m_startAttackFrame <= TheGameLogic->getFrame()) {
    return true;
  }
  return false;
...
//-------------------------------------------------------------------------------------------------
void ParticleUplinkCannonUpdate::setSpecialPowerOverridableDestination(
    const Coord3D *loc) {
...
UpdateSleepTime ParticleUplinkCannonUpdate::update() {
  ...
  // 1) Idle while waiting to get near the time when we should be preparing to
  // be ready. 2) If superweapon delay is nuked (cheat) then we need to make the
  // building ready now.
  UnsignedInt now = TheGameLogic->getFrame();
  UnsignedInt readyToFireFrame = m_specialPowerModule->isReady()
                                     ? now
  ...
  if (m_startAttackFrame != 0 && m_startAttackFrame <= now) {
    ...
    UnsignedInt orbitalBirthFrame =
        m_startAttackFrame + data->m_beamTravelFrames;
    UnsignedInt orbitalDecayStart =
        m_startDecayFrame + data->m_beamTravelFrames;
    ...
    if (beam && orbitalBirthFrame <= now && now <= orbitalDeathFrame) {
      if (!m_manualTargetMode) {
        // Calculate the position of the beam because it swaths -- a nice S
        // curve centering at the target location!

        // First determine the factor of time completed (ranges between 0.0
        // and 1.0)
        Real factor = (Real)(now - orbitalBirthFrame) /
                      (Real)(orbitalDeathFrame - orbitalBirthFrame);

        // We're generating a swath that travels the points between sin( -1PI )
        // and sin( 1PI )
        Real radians = (factor * TWO_PI) - PI;
        Real cxDistance =
            (factor * data->m_swathOfDeathDistance) -
            (data->m_swathOfDeathDistance * 0.5f);  // cx is cartesian x
        ...
        // Calculate the point position assuming the target position is on the x
        // axis relative to the building.
        ...
        // Now that we have our cartesian offset relative to the target
        // coordinate, we need to rotate that offset so it's aligned to along
        // the building -> target vector.
        Vector2 buildingToTargetVector(
            m_initialTargetPosition.x - me->getPosition()->x,
            m_initialTargetPosition.y - me->getPosition()->y);
        buildingToTargetVector.Normalize();
        Vector2 cartesianTargetVector(m_currentTargetPosition.x,
                                      m_currentTargetPosition.y);
        cartesianTargetVector.Normalize();

        Real dotProduct =
            Vector2::Dot_Product(buildingToTargetVector, cartesianTargetVector);
        dotProduct =
            __min(0.99999f,
                  __max(-0.99999f,
                        dotProduct));  // Account for numerical errors.  Also,
                                       // acos(-1.00000) is coming out QNAN on
                                       // the superweapon general map.  Heh.
        ...
        if (m_lastDrivingClickFrame - m_2ndLastDrivingClickFrame <
            data->m_doubleClickToFastDriveDelay) {
      ...
      // Regardless of which method we used to set the target position, make
      // sure the z position is at the terrain.
      m_currentTargetPosition.z = TheTerrainLogic->getGroundHeight(
          m_currentTargetPosition.x, m_currentTargetPosition.y);
      ...
      static NameKeyType nameKeyClientUpdate = NAMEKEY("LaserUpdate");
      LaserUpdate *update =
          (LaserUpdate *)beam->findClientUpdateModule(nameKeyClientUpdate);
      if (update) {
        update->initLaser(NULL, &orbitPosition, &m_currentTargetPosition);
        scorchRadius =
            update->getCurrentLaserRadius() * data->m_scorchMarkScalar;
        damageRadius =
            update->getCurrentLaserRadius() * data->m_damageRadiusScalar;
      }
      ...
      if (m_nextScorchMarkFrame <= now) {
        ...
        Scorches scorchID = (Scorches)GameClientRandomValue(
            SCORCH_1, SCORCH_4);  // Yes, this is just client fluff!
        TheGameClient->addScorch(&m_currentTargetPosition, scorchRadius,
                                 scorchID);

        // Calculate next scorch mark frame.
        Real nextFactor =
            (Real)m_scorchMarksMade / (Real)data->m_totalScorchMarks;
        m_nextScorchMarkFrame =
            orbitalBirthFrame +
            nextFactor * (orbitalDeathFrame - orbitalBirthFrame);
        ...
        // Also reveal vision because the owning player has full rights to watch
        // the carnage he created!
        ThePartitionManager->doShroudReveal(
            m_currentTargetPosition.x, m_currentTargetPosition.y,
            data->m_revealRange, me->getControllingPlayer()->getPlayerMask());
        ThePartitionManager->undoShroudReveal(
            m_currentTargetPosition.x, m_currentTargetPosition.y,
            data->m_revealRange, me->getControllingPlayer()->getPlayerMask());
      }
      ...
      if (m_nextDamagePulseFrame <= now) {
        ...
        Real totalFiringSeconds =
            data->m_totalFiringFrames / LOGICFRAMES_PER_SECOND;
        Real damagePerPulse =
            (Real)(totalFiringSeconds * data->m_damagePerSecond) /
            (Real)data->m_totalDamagePulses;
        ...
        ObjectIterator *iter = ThePartitionManager->iterateObjectsInRange(
            &m_currentTargetPosition, damageRadius, FROM_CENTER_2D, filters);
        ...
        if (data->m_damagePulseRemnantObjectName.isNotEmpty()) {
          // Create a remnant damaging object that will fade over time to
          // represent the burning trail.
          const ThingTemplate *thing = TheThingFactory->findTemplate(
              data->m_damagePulseRemnantObjectName);
          if (thing) {
            // Fire and forget
        ...
        Real nextFactor =
            (Real)m_damagePulsesMade / (Real)data->m_totalDamagePulses;
  ...
  if (localPlayer) {
    Bool shrouded = me->getShroudedStatus(localPlayer->getPlayerIndex()) !=
                    OBJECTSHROUD_CLEAR;
    if (shrouded) {
      // We can't see it so any client effects that have been added logically
      // needs to be removed!
      removeAllEffects();
    } else {
      // We can see it -- we only want to do anything if we just started seeing
      // it, which means we want to add client effects again.
      Bool revealThisFrame = m_clientShroudedLastFrame != shrouded;
      if (revealThisFrame) {
        // Only if we reveal this frame, will we add client effects. The logic
        // can take it from here on... unless of course we lose sight again.
...
//-------------------------------------------------------------------------------------------------
void ParticleUplinkCannonUpdate::createOuterNodeParticleSystems(
  ...
  if (str.isNotEmpty()) {
    const ParticleSystemTemplate *tmp =
        TheParticleSystemManager->findTemplate(str);
    if (tmp) {
...
//-------------------------------------------------------------------------------------------------
void ParticleUplinkCannonUpdate::createConnectorLasers(
    IntensityTypes intensity) {
      ...
      for (int i = 0; i < data->m_outerEffectNumBones; i++) {
        ...
        if (beam) {
          ...
          LaserUpdate *update =
              (LaserUpdate *)beam->findClientUpdateModule(nameKeyClientUpdate);
          if (update) {
            update->initLaser(NULL, &m_outerNodePositions[i],
...
//-------------------------------------------------------------------------------------------------
void ParticleUplinkCannonUpdate::createConnectorFlare(
    IntensityTypes intensity) {
  const ParticleUplinkCannonUpdateModuleData *data =
      getParticleUplinkCannonUpdateModuleData();
  AsciiString str;
...
//-------------------------------------------------------------------------------------------------
void ParticleUplinkCannonUpdate::createLaserBaseFlare(
    IntensityTypes intensity) {
  const ParticleUplinkCannonUpdateModuleData *data =
      getParticleUplinkCannonUpdateModuleData();
  AsciiString str;
...
//-------------------------------------------------------------------------------------------------
void ParticleUplinkCannonUpdate::createGroundToOrbitLaser(
    UnsignedInt growthFrames) {
  const ParticleUplinkCannonUpdateModuleData *data =
      getParticleUplinkCannonUpdateModuleData();
  ...
  if (data->m_particleBeamLaserName.isNotEmpty()) {
    const ThingTemplate *thingTemplate =
        TheThingFactory->findTemplate(data->m_particleBeamLaserName);
    if (thingTemplate) {
      Drawable *beam = TheThingFactory->newDrawable(thingTemplate);
      if (beam) {
        ...
        if (update) {
          ...
          orbitPosition.z += 500.0f;
          update->initLaser(NULL, &m_laserOriginPosition, &orbitPosition,
                            growthFrames);
        }
      }
    }
...
//-------------------------------------------------------------------------------------------------
void ParticleUplinkCannonUpdate::createOrbitToTargetLaser(
    UnsignedInt growthFrames) {
  const ParticleUplinkCannonUpdateModuleData *data =
      getParticleUplinkCannonUpdateModuleData();
    ...
    if (thingTemplate) {
      ...
      if (beam) {
        ...
        if (update) {
          ...
          orbitPosition.z += 500.0f;
          update->initLaser(NULL, &orbitPosition, &m_initialTargetPosition,
                            growthFrames);
        }
      }
    }
...
//-------------------------------------------------------------------------------------------------
void ParticleUplinkCannonUpdate::createGroundHitParticleSystem(
    IntensityTypes intensity) {}
...
Bool ParticleUplinkCannonUpdate::calculateDefaultInformation() {
  ...
  int numBones = obj->getMultiLogicalBonePosition(
      data->m_outerEffectBaseBoneName.str(), data->m_outerEffectNumBones,
      bonePositions, boneMatrices, FALSE);

  if (numBones != data->m_outerEffectNumBones) {
    DEBUG_CRASH(
        ("Particle cannon requires %d outer node bones, but can only find %d "
         "bones.",
         data->m_outerEffectNumBones, numBones));
    m_invalidSettings = true;
    return false;
  }
  ...
  for (int i = 0; i < data->m_outerEffectNumBones; i++) {
    ...
    Matrix3D nodeMatrix;
    getObject()->convertBonePosToWorldPos(&bonePositions[i], &boneMatrices[i],
                                          &m_outerNodePositions[i],
                                          &m_outerNodeOrientations[i]);
  }
...
Bool ParticleUplinkCannonUpdate::calculateUpBonePositions() {
  const ParticleUplinkCannonUpdateModuleData *data =
      getParticleUplinkCannonUpdateModuleData();
  Object *obj = getObject();
  // Due to instant special weapons (or scripting)... it's possible to be in
  // many states that are ready to fire (or firing)
  Drawable *draw = obj->getDrawable();
  Matrix3D mtx;
  Coord3D pos;
  if (draw) {
    if (data->m_connectorBoneName.isNotEmpty() &&
        draw->getCurrentClientBonePositions(data->m_connectorBoneName.str(), 0,
                                            &pos, &mtx, 1)) {
      obj->convertBonePosToWorldPos(&pos, &mtx, &m_connectorNodePosition, &mtx);
    }
    if (data->m_connectorBoneName.isNotEmpty() &&
        draw->getCurrentClientBonePositions(data->m_fireBoneName.str(), 0, &pos,
                                            &mtx, 1)) {
...
void ParticleUplinkCannonUpdate::setLogicalStatus(PUCStatus newStatus) {
  ...
  switch (newStatus) {
    case STATUS_IDLE: {
      ...
      obj->clearModelConditionFlags(MAKE_MODELCONDITION_MASK3(
          MODELCONDITION_PACKING, MODELCONDITION_UNPACKING,
    ...
    case STATUS_PREPARING: {
      ...
      obj->clearAndSetModelConditionFlags(
          MAKE_MODELCONDITION_MASK2(MODELCONDITION_PACKING,
                                    MODELCONDITION_DEPLOYED),
      ...
      if (m_unpackToReadySound.getEventName().isNotEmpty()) {
        ...
        m_unpackToReadySound.setPlayingHandle(
            TheAudio->addAudioEvent(&m_unpackToReadySound));
      }
      TheAudio->removeAudioEvent(m_firingToIdleSound.getPlayingHandle());
      TheAudio->removeAudioEvent(m_annihilationSound.getPlayingHandle());
    ...
    case STATUS_FIRING: {
      ...
      if (m_firingToIdleSound.getEventName().isNotEmpty()) {
        ...
        m_firingToIdleSound.setPlayingHandle(
            TheAudio->addAudioEvent(&m_firingToIdleSound));
      }
      TheAudio->removeAudioEvent(m_powerupSound.getPlayingHandle());
      TheAudio->removeAudioEvent(m_unpackToReadySound.getPlayingHandle());
      TheAudio->removeAudioEvent(m_annihilationSound.getPlayingHandle());
...
//-------------------------------------------------------------------------------------------------
void ParticleUplinkCannonUpdate::setClientStatus(PUCStatus newStatus,
  ...
  // This isn't the most efficient way to do this. Various effects can live in
  // more than one status state, but keeping track of them properly is
  // error-prone and hard to read. Therefore, the new philosophy is to delete
  // EVERYTHING between status changes and create the ones we want!
  removeAllEffects();
...
//-------------------------------------------------------------------------------------------------
Bool ParticleUplinkCannonUpdate::
    doesSpecialPowerHaveOverridableDestinationActive() const {
  return m_status == STATUS_PREFIRE || m_status == STATUS_FIRING ||
         m_status == STATUS_POSTFIRE;
}
...
void ParticleUplinkCannonUpdate::xfer(Xfer *xfer) {
  ...
  // we do not need to tie up the special power module pointer, it is done on
  // object creation SpecialPowerModuleInterface *m_specialPowerModule;
