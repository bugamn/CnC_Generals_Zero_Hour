...
//				Putting a SpecialPower in a behavior takes a big
//huge amount of code duplication and 				has no precedent.
///////////////////////////////////////////////////////////////////////////////////////////////////
...
void SpyVisionUpdate::doActivationWork(Bool setting) {
  ...
  if (ourPlayer == NULL || ThePlayerList == NULL) return;
...
void SpyVisionUpdate::onDelete(void) {
  ...
  if (m_deactivateFrame) doActivationWork(FALSE);
}
