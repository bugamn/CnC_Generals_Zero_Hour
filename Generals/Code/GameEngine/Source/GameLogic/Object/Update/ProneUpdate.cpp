...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
ProneUpdateModuleData::ProneUpdateModuleData() : m_damageToFramesRatio(1.0f) {}
...
/*static*/ void ProneUpdateModuleData::buildFieldParse(MultiIniFieldParse &p) {
  ...
  static const FieldParse dataFieldParse[] = {
      {"DamageToFramesRatio", INI::parseReal, NULL,
       offsetof(ProneUpdateModuleData, m_damageToFramesRatio)},
      {0, 0, 0, 0}};
...
UpdateSleepTime ProneUpdate::update(void) {
  ...
  if (m_proneFrames > 0) {
    m_proneFrames--;
    if (m_proneFrames == 0) stopProneEffects();
  }
...
void ProneUpdate::goProne(const DamageInfo *damageInfo) {
  ...
  m_proneFrames +=
      damageTaken * getProneUpdateModuleData()->m_damageToFramesRatio;

  if (!wasProne && (m_proneFrames > 0)) startProneEffects();
}
