...
//					This instance kicks things it outputs
//into SupplyTruck autopilot after exiting.
///////////////////////////////////////////////////////////////////////////////////////////////////
...
void SupplyCenterProductionExitUpdate::exitObjectViaDoor(
  ...
  if (creationObject) {
    ...
    loc.Z =
        TheTerrainLogic ? TheTerrainLogic->getGroundHeight(loc.X, loc.Y) : 0.0f;
    ...
    //
    // get the natural rally point from the INI definition, this coord is in
    // model space relative to the model (0,0,0)
    //
...
Bool SupplyCenterProductionExitUpdate::getExitPosition(
    Coord3D &exitPosition) const {
...
//-------------------------------------------------------------------------------------------------
Bool SupplyCenterProductionExitUpdate::getNaturalRallyPoint(Coord3D &rallyPoint,
                                                            Bool offset) const {
  const SupplyCenterProductionExitUpdateModuleData *data =
      getSupplyCenterProductionExitUpdateModuleData();
  Vector3 p;
