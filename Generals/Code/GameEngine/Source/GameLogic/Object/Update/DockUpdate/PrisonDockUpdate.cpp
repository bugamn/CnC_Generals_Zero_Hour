...
// ///////////////////////////////////////////////////////////////////// Author:
// Colin Day, August 2002 Desc:   Dock update for prison structures
///////////////////////////////////////////////////////////////////////////////////////////////////
...
PrisonDockUpdate::PrisonDockUpdate(Thing *thing, const ModuleData *moduleData)
    : DockUpdate(thing, moduleData) {}  // end PrisonDockUpdate

// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
PrisonDockUpdate::~PrisonDockUpdate(void) {}  // end ~PrisonDockUpdate
...
Bool PrisonDockUpdate::action(Object *docker, Object *drone) {
  ...
  if (contain && contain->getContainCount() == 0) return FALSE;
