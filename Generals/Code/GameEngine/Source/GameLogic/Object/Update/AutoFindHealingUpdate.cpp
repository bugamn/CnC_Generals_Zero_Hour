...
//-------------------------------------------------------------------------------------------------
/*static*/ void AutoFindHealingUpdateModuleData::buildFieldParse(
    MultiIniFieldParse &p) {
  ModuleData::buildFieldParse(p);

  static const FieldParse dataFieldParse[] = {
      {"ScanRate", INI::parseDurationUnsignedInt, NULL,
       offsetof(AutoFindHealingUpdateModuleData, m_scanFrames)},
      {"ScanRange", INI::parseReal, NULL,
       offsetof(AutoFindHealingUpdateModuleData, m_scanRange)},
      {"NeverHeal", INI::parseReal, NULL,
       offsetof(AutoFindHealingUpdateModuleData, m_neverHeal)},
      {"AlwaysHeal", INI::parseReal, NULL,
       offsetof(AutoFindHealingUpdateModuleData, m_alwaysHeal)},
      {0, 0, 0, 0}};
  p.add(dataFieldParse);
}

//-------------------------------------------------------------------------------------------------
AutoFindHealingUpdate::AutoFindHealingUpdate(Thing *thing,
