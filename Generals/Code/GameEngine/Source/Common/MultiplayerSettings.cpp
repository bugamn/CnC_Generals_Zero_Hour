...
MultiplayerSettings* TheMultiplayerSettings =
    NULL;  ///< The MultiplayerSettings singleton
...
const FieldParse MultiplayerColorDefinition::m_colorFieldParseTable[] = {
    ...
    {"TooltipName", INI::parseAsciiString, NULL,
     offsetof(MultiplayerColorDefinition, m_tooltipName)},
    {"RGBColor", INI::parseRGBColor, NULL,
     offsetof(MultiplayerColorDefinition, m_rgbValue)},
    {"RGBNightColor", INI::parseRGBColor, NULL,
     offsetof(MultiplayerColorDefinition, m_rgbValueNight)},
...
const FieldParse MultiplayerSettings::m_multiplayerSettingsFieldParseTable[] = {
    ...
    {"InitialCreditsMin", INI::parseInt, NULL,
     offsetof(MultiplayerSettings, m_initialCreditsMin)},
    {"InitialCreditsMax", INI::parseInt, NULL,
     offsetof(MultiplayerSettings, m_initialCreditsMax)},
    {"StartCountdownTimer", INI::parseInt, NULL,
     offsetof(MultiplayerSettings, m_startCountdownTimerSeconds)},
    {"MaxBeaconsPerPlayer", INI::parseInt, NULL,
     offsetof(MultiplayerSettings, m_maxBeaconsPerPlayer)},
    {"UseShroud", INI::parseBool, NULL,
     offsetof(MultiplayerSettings, m_isShroudInMultiplayer)},
    {"ShowRandomPlayerTemplate", INI::parseBool, NULL,
     offsetof(MultiplayerSettings, m_showRandomPlayerTemplate)},
    {"ShowRandomStartPos", INI::parseBool, NULL,
     offsetof(MultiplayerSettings, m_showRandomStartPos)},
    {"ShowRandomColor", INI::parseBool, NULL,
     offsetof(MultiplayerSettings, m_showRandomColor)},
...
MultiplayerColorDefinition* MultiplayerSettings::newMultiplayerColorDefinition(
    AsciiString name) {
