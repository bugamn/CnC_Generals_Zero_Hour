...
// --------------------------------------------------------------
extern WindowMsgHandledType BeaconWindowInput(GameWindow *window,
                                              UnsignedInt msg,
                                              WindowMsgData mData1,
                                              WindowMsgData mData2);
...
extern WindowMsgHandledType PopupReplaySystem(GameWindow *window,
                                              UnsignedInt msg,
                                              WindowMsgData mData1,
                                              WindowMsgData mData2);
extern WindowMsgHandledType PopupReplayInput(GameWindow *window,
                                             UnsignedInt msg,
                                             WindowMsgData mData1,
                                             WindowMsgData mData2);
...
static FunctionLexicon::TableEntry gameWinSystemTable[] = {
    ...
    {NAMEKEY_INVALID, "PassSelectedButtonsToParentSystem",
    ...
    {NAMEKEY_INVALID, "GadgetHorizontalSliderSystem",
    ...
    {NAMEKEY_INVALID, "SkirmishGameOptionsMenuSystem",
     SkirmishGameOptionsMenuSystem},
    {NAMEKEY_INVALID, "SkirmishMapSelectMenuSystem",
    ...
    {NAMEKEY_INVALID, "PopupBuddyNotificationSystem",
    ...
    {NAMEKEY_INVALID, "EstablishConnectionsControlSystem",
...
static FunctionLexicon::TableEntry gameWinInputTable[] = {
    ...
    {NAMEKEY_INVALID, "GadgetHorizontalSliderInput",
    ...
    {NAMEKEY_INVALID, "SkirmishGameOptionsMenuInput",
    ...
    {NAMEKEY_INVALID, "GameSpyPlayerInfoOverlayInput",
...
static FunctionLexicon::TableEntry winLayoutInitTable[] = {
    ...
    {NAMEKEY_INVALID, "SkirmishGameOptionsMenuInit",
    ...
    {NAMEKEY_INVALID, "GameSpyPlayerInfoOverlayInit",
...
static FunctionLexicon::TableEntry winLayoutUpdateTable[] = {
    ...
    {NAMEKEY_INVALID, "SkirmishGameOptionsMenuUpdate",
     SkirmishGameOptionsMenuUpdate},
    {NAMEKEY_INVALID, "SkirmishMapSelectMenuUpdate",
    ...
    {NAMEKEY_INVALID, "GameSpyPlayerInfoOverlayUpdate",
...
static FunctionLexicon::TableEntry winLayoutShutdownTable[] = {
    ...
    {NAMEKEY_INVALID, "KeyboardOptionsMenuShutdown",
    ...
    {NAMEKEY_INVALID, "SkirmishGameOptionsMenuShutdown",
     SkirmishGameOptionsMenuShutdown},
    {NAMEKEY_INVALID, "SkirmishMapSelectMenuShutdown",
    ...
    {NAMEKEY_INVALID, "GameSpyPlayerInfoOverlayShutdown",
    ...
    {NAMEKEY_INVALID, "WOLCustomScoreScreenShutdown",
     WOLCustomScoreScreenShutdown},
    {NAMEKEY_INVALID, "NetworkDirectConnectShutdown",
...
void *FunctionLexicon::keyToFunc(NameKeyType key, TableEntry *table) {
  // sanity
  if (key == NAMEKEY_INVALID) return NULL;
...
FunctionLexicon::FunctionLexicon(void) {
  ...
  // empty the tables
  for (i = 0; i < MAX_FUNCTION_TABLES; i++) m_tables[i] = NULL;

}  // end FunctionLexicon

//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
FunctionLexicon::~FunctionLexicon(void) {}  // end ~FunctionLexicon
...
void FunctionLexicon::reset(void) {
  //
  // make sure the ordering of what happens here with respect to derived classes
  // resets is all OK since we're cheating and using the init() method
  //
...
/** Update */
//-------------------------------------------------------------------------------------------------
void FunctionLexicon::update(void) {}  // end update
...
Bool FunctionLexicon::validate(void) {
  ...
  for (i = 0; i < MAX_FUNCTION_TABLES; i++) {
    ...
    while (sourceEntry && sourceEntry->key != NAMEKEY_INVALID) {
      ...
      // of source entry is NULL (a valid entry in the table, but not a
      // function)
      //
      if (sourceEntry->func) {
        // scan all tables
