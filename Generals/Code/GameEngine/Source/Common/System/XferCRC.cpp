...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
XferCRC::~XferCRC(void) {}  // end ~XferCRC
...
//-------------------------------------------------------------------------------------------------
void XferCRC::close(void) {}  // end close

//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
Int XferCRC::beginBlock(void) { return 0; }  // end beginBlock

//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
void XferCRC::endBlock(void) {}  // end endBlock
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
void XferCRC::skip(Int dataSize) {}  // end skip

//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
UnsignedInt XferCRC::getCRC(void) { return htonl(m_crc); }  // end skip
...
void XferDeepCRC::xferAsciiString(AsciiString *asciiStringData) {
  ...
  if (asciiStringData->getLength() > 16385) {
    DEBUG_CRASH(
        ("XferSave cannot save this ascii string because it's too long.  "
