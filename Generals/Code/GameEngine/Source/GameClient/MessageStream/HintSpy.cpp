...
/**
 * This message handler displays UI "hints" (ie: a rectangle for drag selection)
 * based upon the messages that pass through it.
 */
GameMessageDisposition HintSpyTranslator::translateGameMessage(
