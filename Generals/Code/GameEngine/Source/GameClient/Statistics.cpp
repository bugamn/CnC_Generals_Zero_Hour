...
Real NormalizeToRange(Real valueToNormalize, Real minRange, Real maxRange,
                      Real outRangeMin, Real outRangeMax) {
  return (Normalize(valueToNormalize, minRange, maxRange) *
