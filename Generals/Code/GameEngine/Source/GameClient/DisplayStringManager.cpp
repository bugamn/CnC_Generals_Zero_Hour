...
// ///////////////////////////////////////////////////////////////// Created:
// Colin Day, July 2001 Desc:       Access for creating game managed display
// strings
///////////////////////////////////////////////////////////////////////////////////////////////////
...
void DisplayStringManager::link(DisplayString *string) {
  ...
  if (m_stringList) m_stringList->m_prev = string;
...
void DisplayStringManager::unLink(DisplayString *string) {
  ...
  if (string->m_next) string->m_next->m_prev = string->m_prev;
  if (string->m_prev)
