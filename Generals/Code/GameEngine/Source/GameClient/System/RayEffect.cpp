...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
RayEffectSystem::RayEffectSystem(void) { init(); }  // end RayEffectSystem

//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
RayEffectSystem::~RayEffectSystem(void) {}  // end ~RayEffectSystem
...
void RayEffectSystem::addRayEffect(const Drawable *draw,
  ...
  // sanity
  if (draw == NULL || startLoc == NULL || endLoc == NULL) return;
...
void RayEffectSystem::getRayEffectData(const Drawable *draw,
  ...
  // sanity
  if (draw == NULL || effectData == NULL) return;
