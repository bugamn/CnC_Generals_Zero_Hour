...
DebugDisplay::DebugDisplay() : m_width(0), m_height(0) { reset(); }
...
Int DebugDisplay::getCursorXPos(void) { return m_xPos; }

//============================================================================
// DebugDisplay::getCursorYPos
//============================================================================

Int DebugDisplay::getCursorYPos(void) { return m_yPos; }

//============================================================================
// DebugDisplay::getWidth
//============================================================================

Int DebugDisplay::getWidth(void) { return m_width; }

//============================================================================
// DebugDisplay::getHeight
//============================================================================

Int DebugDisplay::getHeight(void) { return m_height; }

//============================================================================
// DebugDisplay::setTextColor
//============================================================================

void DebugDisplay::setTextColor(Color color) { m_textColor = color; }

//============================================================================
// DebugDisplay::setRightMargin
//============================================================================

void DebugDisplay::setRightMargin(Int rightPos) { m_rightMargin = rightPos; }

//============================================================================
// DebugDisplay::setLeftMargin
//============================================================================

void DebugDisplay::setLeftMargin(Int leftPos) { m_leftMargin = leftPos; }
...
void DebugDisplay::printf(Char *format, ...) {
  ...
  DEBUG_ASSERTCRASH(
      result < sizeof(text),
      ("text overflow in DebugDisplay::printf() - string too long"));
