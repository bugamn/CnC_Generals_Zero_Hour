...
// ////////////////////////////////////////////////////////// Author: Colin Day,
// March 2002 Desc:   Methods specific to the control bar OCL Timer context
///////////////////////////////////////////////////////////////////////////////////////////////////
...
void ControlBar::updateOCLTimerTextDisplay(UnsignedInt totalSeconds,
  ...
  static UnsignedInt descID =
      TheNameKeyGenerator->nameToKey("ControlBar.wnd:OCLTimerStaticText");
  GameWindow *descWindow = TheWindowManager->winGetWindowFromId(NULL, descID);

  static UnsignedInt barID =
      TheNameKeyGenerator->nameToKey("ControlBar.wnd:OCLTimerProgressBar");
  ...
  // format the message
  if (seconds < 10)
    text.format(TheGameText->fetch("CONTROLBAR:OCLTimerDescWithPadding"),
                minutes, seconds);
  else
    text.format(TheGameText->fetch("CONTROLBAR:OCLTimerDesc"), minutes,
                seconds);
...
void ControlBar::updateContextOCLTimer(void) {
  ...
  // if the time has changed since what was last shown to the user update the
  // text
