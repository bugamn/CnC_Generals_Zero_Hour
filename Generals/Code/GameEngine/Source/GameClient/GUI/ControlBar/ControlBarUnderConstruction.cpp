...
// ////////////////////////////////////////////////////////// Author: Colin Day,
// March 2002 Desc:   Methods specific to the control bar under construction
// context
///////////////////////////////////////////////////////////////////////////////////////////////////
...
void ControlBar::updateConstructionTextDisplay(Object *obj) {
  UnicodeString text;
  static UnsignedInt descID =
      TheNameKeyGenerator->nameToKey("ControlBar.wnd:UnderConstructionDesc");
...
void ControlBar::populateUnderConstruction(Object *objectUnderConstruction) {
  // sanity
  if (objectUnderConstruction == NULL) return;
  ...
  const CommandButton *commandButton =
      findCommandButton("Command_CancelConstruction");
  NameKeyType id;
  id =
      TheNameKeyGenerator->nameToKey("ControlBar.wnd:ButtonCancelConstruction");
  ...
  if (exit) showRallyPoint(exit->getRallyPoint());
...
void ControlBar::updateContextUnderConstruction(void) {
  ...
  // if the object is no longer under construction switch to a new appropriate
  // context
  ...
  // if the construction percent has changed since what was last shown to the
