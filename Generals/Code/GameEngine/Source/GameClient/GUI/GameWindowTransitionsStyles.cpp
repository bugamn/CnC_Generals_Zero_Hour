...
FlashTransition::~FlashTransition(void) { m_win = NULL; }
...
void FlashTransition::update(Int frame) {
  ...
  if (frame < FLASHTRANSITION_START || frame > FLASHTRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE, ("FlashTransition::update - Frame is out of the "
                              "range the this update can handle %d",
                              frame));
    return;
  }
  switch (frame) {
    case FLASHTRANSITION_START: {
      if (m_isForward || !m_win) break;
      m_win->winHide(TRUE);
      m_isFinished = TRUE;
    } break;
...
void FlashTransition::draw(void) {
  switch (m_drawState) {
    case FLASHTRANSITION_FADE_IN_1: {
      TheDisplay->drawOpenRect(m_pos.x + 1, m_pos.y + 1, m_size.x - 2, m_size.y,
                               1, GameMakeColor(255, 203, 45, 100));
      TheDisplay->drawFillRect(m_pos.x + 1, m_pos.y + 1, m_size.x - 2, m_size.y,
                               GameMakeColor(255, 203, 45, 33));
    } break;
    case FLASHTRANSITION_FADE_IN_2: {
      TheDisplay->drawOpenRect(m_pos.x + 1, m_pos.y + 1, m_size.x - 2, m_size.y,
                               1, GameMakeColor(255, 203, 45, 150));
      TheDisplay->drawFillRect(m_pos.x + 1, m_pos.y + 1, m_size.x - 2, m_size.y,
                               GameMakeColor(255, 203, 45, 66));
    } break;
    case FLASHTRANSITION_FADE_IN_3: {
      TheDisplay->drawOpenRect(m_pos.x + 1, m_pos.y + 1, m_size.x - 2, m_size.y,
                               1, GameMakeColor(255, 203, 45, 200));
      TheDisplay->drawFillRect(m_pos.x + 1, m_pos.y + 1, m_size.x - 2, m_size.y,
                               GameMakeColor(255, 203, 45, 99));
    } break;
    case FLASHTRANSITION_FADE_TO_BACKGROUND_1: {
      TheDisplay->drawOpenRect(m_pos.x + 1, m_pos.y + 1, m_size.x - 2, m_size.y,
                               1, GameMakeColor(255, 203, 45, 250));
      TheDisplay->drawFillRect(m_pos.x + 1, m_pos.y + 1, m_size.x - 2, m_size.y,
                               GameMakeColor(255, 203, 45, 75));
    } break;
    case FLASHTRANSITION_FADE_TO_BACKGROUND_2: {
      TheDisplay->drawOpenRect(m_pos.x + 1, m_pos.y + 1, m_size.x - 2, m_size.y,
                               1, GameMakeColor(255, 203, 45, 250));
      TheDisplay->drawFillRect(m_pos.x + 1, m_pos.y + 1, m_size.x - 2, m_size.y,
                               GameMakeColor(255, 203, 45, 50));
    } break;
    case FLASHTRANSITION_FADE_TO_BACKGROUND_3: {
      TheDisplay->drawOpenRect(m_pos.x + 1, m_pos.y + 1, m_size.x - 2, m_size.y,
                               1, GameMakeColor(255, 203, 45, 250));
      TheDisplay->drawFillRect(m_pos.x + 1, m_pos.y + 1, m_size.x - 2, m_size.y,
                               GameMakeColor(255, 203, 45, 25));
    } break;
    case FLASHTRANSITION_FADE_TO_BACKGROUND_4: {
      TheDisplay->drawOpenRect(m_pos.x + 1, m_pos.y + 1, m_size.x - 2, m_size.y,
                               1, GameMakeColor(255, 203, 45, 250));
      TheDisplay->drawFillRect(m_pos.x + 1, m_pos.y + 1, m_size.x - 2, m_size.y,
                               GameMakeColor(255, 203, 45, 10));
    } break;
  }
}

void FlashTransition::skip(void) { update(FLASHTRANSITION_END); }
...
ButtonFlashTransition::~ButtonFlashTransition(void) { m_win = NULL; }
...
void ButtonFlashTransition::update(Int frame) {
  m_drawState = -1;
  if (frame < BUTTONFLASHTRANSITION_START ||
      frame > BUTTONFLASHTRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE, ("ButtonFlashTransition::update - Frame is out of "
                              "the range the this update can handle %d",
                              frame));
    return;
  }
  switch (frame) {
  ...
  if (frame > BUTTONFLASHTRANSITION_FADE_TO_BACKGROUND_4 &&
      frame < BUTTONFLASHTRANSITION_FADE_TO_GRADE_IN_1)
...
void ButtonFlashTransition::draw(void) {
  switch (m_drawState) {
    case BUTTONFLASHTRANSITION_FADE_IN_1: {
      ...
      TheDisplay->drawOpenRect(m_pos.x, m_pos.y, m_size.x, m_size.y, 1,
                               GameMakeColor(255, 203, 45, 100));
      TheDisplay->drawFillRect(m_pos.x, m_pos.y, m_size.x, m_size.y,
                               GameMakeColor(255, 203, 45, 75));
    } break;
    case BUTTONFLASHTRANSITION_FADE_IN_2: {
      // PushButtonImageDrawThree(m_win, 150);
      TheDisplay->drawOpenRect(m_pos.x, m_pos.y, m_size.x, m_size.y, 1,
                               GameMakeColor(255, 203, 45, 150));
      TheDisplay->drawFillRect(m_pos.x, m_pos.y, m_size.x, m_size.y,
                               GameMakeColor(255, 203, 45, 150));
    } break;
    case BUTTONFLASHTRANSITION_FADE_IN_3: {
    ...
    case BUTTONFLASHTRANSITION_FADE_TO_BACKGROUND_4: {
      ...
      TheDisplay->drawOpenRect(m_pos.x, m_pos.y, m_size.x, m_size.y, 1,
                               GameMakeColor(255, 203, 45, 250));
      TheDisplay->drawFillRect(m_pos.x, m_pos.y, m_size.x, m_size.y,
                               GameMakeColor(255, 203, 45, 15));
    } break;
    case BUTTONFLASHTRANSITION_FADE_TO_GRADE_IN_1: {
      if (m_isForward) PushButtonImageDrawThree(m_win, 255);
      TheDisplay->drawImage(m_gradient, m_pos.x, m_pos.y, m_pos.x + m_size.x,
                            m_pos.y + m_size.y,
                            GameMakeColor(255, 255, 255, 100));
    } break;
    case BUTTONFLASHTRANSITION_FADE_TO_GRADE_IN_2: {
      TheDisplay->drawImage(m_gradient, m_pos.x, m_pos.y, m_pos.x + m_size.x,
                            m_pos.y + m_size.y,
...
void ButtonFlashTransition::skip(void) { update(BUTTONFLASHTRANSITION_END); }
...
FadeTransition::~FadeTransition(void) { m_win = NULL; }
...
void FadeTransition::update(Int frame) {
  ...
  if (frame < FADETRANSITION_START || frame > FADETRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE, ("FadeTransition::update - Frame is out of the "
                              "range the this update can handle %d",
                              frame));
    return;
  }
...
void FadeTransition::draw(void) {
  ...
  switch (m_drawState) {
    case FADETRANSITION_FADE_IN_1: {
      TheDisplay->drawImage(image, m_pos.x, m_pos.y, m_pos.x + m_size.x,
                            m_pos.y + m_size.y,
                            GameMakeColor(255, 255, 255, 25));
    } break;
    case FADETRANSITION_FADE_IN_2: {
      TheDisplay->drawImage(image, m_pos.x, m_pos.y, m_pos.x + m_size.x,
                            m_pos.y + m_size.y,
    ...
    case FADETRANSITION_FADE_IN_9: {
      TheDisplay->drawImage(image, m_pos.x, m_pos.y, m_pos.x + m_size.x,
                            m_pos.y + m_size.y,
                            GameMakeColor(255, 255, 255, 225));
    }
  }
}

void FadeTransition::skip(void) { update(FADETRANSITION_END); }
//-----------------------------------------------------------------------------
...
ScaleUpTransition::~ScaleUpTransition(void) { m_win = NULL; }
...
void ScaleUpTransition::update(Int frame) {
  ...
  if (frame < SCALEUPTRANSITION_START || frame > SCALEUPTRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE, ("ScaleUpTransition::update - Frame is out of the "
                              "range the this update can handle %d",
                              frame));
    return;
  }
...
void ScaleUpTransition::draw(void) {
  if (!m_win) return;
  const Image *image = m_win->winGetEnabledImage(0);
  if (m_drawState <= SCALEUPTRANSITION_START ||
      m_drawState >= SCALEUPTRANSITION_END)
    return;
...
void ScaleUpTransition::skip(void) { update(SCALEUPTRANSITION_END); }
...
ScoreScaleUpTransition::~ScoreScaleUpTransition(void) { m_win = NULL; }
...
void ScoreScaleUpTransition::update(Int frame) {
  m_drawState = -1;
  if (frame < SCORESCALEUPTRANSITION_START ||
      frame > SCORESCALEUPTRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE, ("ScoreScaleUpTransition::update - Frame is out "
                              "of the range the this update can handle %d",
                              frame));
    return;
  }
  switch (frame) {
...
void ScoreScaleUpTransition::draw(void) {
  if (!m_win) return;
  const Image *image = m_win->winGetEnabledImage(0);
  if (m_drawState <= SCORESCALEUPTRANSITION_START ||
      m_drawState >= SCORESCALEUPTRANSITION_END)
    return;
  Int x = m_centerPos.x - ((m_incrementSize.x * m_drawState) / 2);
  Int y = m_centerPos.y - ((m_incrementSize.y * m_drawState) / 2);
  Int x1 = x + m_incrementSize.x * m_drawState;
...
void ScoreScaleUpTransition::skip(void) { update(SCORESCALEUPTRANSITION_END); }
...
MainMenuScaleUpTransition::~MainMenuScaleUpTransition(void) { m_win = NULL; }
...
void MainMenuScaleUpTransition::init(GameWindow *win) {
  ...
  m_growWin = TheWindowManager->winGetWindowFromId(
      NULL, TheNameKeyGenerator->nameToKey("MainMenu.wnd:WinGrowMarker"));
  if (!m_growWin) return;
...
void MainMenuScaleUpTransition::update(Int frame) {
  m_drawState = -1;
  if (frame < MAINMENUSCALEUPTRANSITION_START ||
      frame > MAINMENUSCALEUPTRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE, ("MainMenuScaleUpTransition::update - Frame is "
                              "out of the range the this update can handle %d",
                              frame));
    return;
  }
  switch (frame) {
    case MAINMENUSCALEUPTRANSITION_START: {
      if (m_isForward || !m_win || !m_growWin) break;
      //			m_win->winHide(TRUE);
  ...
  if (frame > MAINMENUSCALEUPTRANSITION_START &&
      frame < MAINMENUSCALEUPTRANSITION_END) {
    if (m_win) m_win->winHide(TRUE);
    if (m_growWin) m_growWin->winHide(TRUE);
    m_drawState = frame;
  }
}
...
void MainMenuScaleUpTransition::draw(void) {
  ...
  if (m_drawState <= MAINMENUSCALEUPTRANSITION_START ||
      m_drawState >= MAINMENUSCALEUPTRANSITION_END)
    return;
...
void MainMenuMediumScaleUpTransition::init(GameWindow *win) {
  ...
  m_growWin = TheWindowManager->winGetWindowFromId(
      NULL, TheNameKeyGenerator->nameToKey(growWinName));
  if (!m_growWin) return;
  ...
  m_incrementSize.x =
      (m_growSize.x - m_size.x) / MAINMENUMEDIUMSCALEUPTRANSITION_END;
  m_incrementSize.y =
      (m_growSize.y - m_size.y) / MAINMENUMEDIUMSCALEUPTRANSITION_END;
  //	const Image *image = m_win->winGetEnabledImage(0);
  // m_growWin->winSetEnabledImage(0, image);
}
...
void MainMenuMediumScaleUpTransition::update(Int frame) {
  m_drawState = -1;
  if (frame < MAINMENUMEDIUMSCALEUPTRANSITION_START ||
      frame > MAINMENUMEDIUMSCALEUPTRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE,
                      ("MainMenuMediumScaleUpTransition::update - Frame is out "
                       "of the range the this update can handle %d",
                       frame));
    return;
  }
...
void MainMenuMediumScaleUpTransition::draw(void) {
  if (!m_win) return;
  const Image *image = m_win->winGetEnabledImage(0);
  if (m_drawState <= MAINMENUMEDIUMSCALEUPTRANSITION_START ||
      m_drawState >= MAINMENUMEDIUMSCALEUPTRANSITION_END)
    return;
...
void MainMenuSmallScaleDownTransition::init(GameWindow *win) {
  ...
  m_incrementSize.x =
      (m_growSize.x - m_size.x) / MAINMENUSMALLSCALEDOWNTRANSITION_END;
  m_incrementSize.y =
      (m_growSize.y - m_size.y) / MAINMENUSMALLSCALEDOWNTRANSITION_END;
  const Image *image = m_win->winGetEnabledImage(0);
  m_growWin->winSetEnabledImage(0, image);
}
...
void MainMenuSmallScaleDownTransition::update(Int frame) {
  m_drawState = -1;
  if (frame < MAINMENUSMALLSCALEDOWNTRANSITION_START ||
      frame > MAINMENUSMALLSCALEDOWNTRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE,
                      ("MainMenuSmallScaleDownTransition::update - Frame is "
                       "out of the range the this update can handle %d",
                       frame));
    return;
  }
...
void MainMenuSmallScaleDownTransition::draw(void) {
  if (!m_win) return;
  const Image *image = m_win->winGetEnabledImage(0);
  if (m_drawState <= MAINMENUSMALLSCALEDOWNTRANSITION_START ||
      m_drawState >= MAINMENUSMALLSCALEDOWNTRANSITION_END)
    return;
  Int x = m_pos.x - ((m_incrementSize.x * m_drawState) / 2);
  Int y = m_pos.y - ((m_incrementSize.y * m_drawState) / 2);
  Int x1 = m_pos.x + m_size.x + ((m_incrementSize.x * m_drawState) / 2);
...
TextTypeTransition::~TextTypeTransition(void) {
  m_win = NULL;
  if (m_dStr) TheDisplayStringManager->freeDisplayString(m_dStr);
  m_dStr = NULL;
}
...
void TextTypeTransition::update(Int frame) {
  ...
  if (frame < TEXTTYPETRANSITION_START || frame > TEXTTYPETRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE, ("TextTypeTransition::update - Frame is out of "
                              "the range the this update can handle %d",
                              frame));
    return;
  }
...
void TextTypeTransition::skip(void) { update(TEXTTYPETRANSITION_END); }
...
CountUpTransition::~CountUpTransition(void) { m_win = NULL; }
...
void CountUpTransition::update(Int frame) {
  ...
  if (frame < COUNTUPTRANSITION_START || frame > COUNTUPTRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE, ("CountUpTransition::update - Frame is out of the "
                              "range the this update can handle %d",
                              frame));
    return;
  }
  ...
  if (frame > COUNTUPTRANSITION_START && frame < m_frameLength) {
    ...
    if (m_currentValue > m_intValue) m_currentValue = m_intValue;
...
void CountUpTransition::skip(void) {
  if (!m_isFinished) update(COUNTUPTRANSITION_END);
}
...
ScreenFadeTransition::~ScreenFadeTransition(void) { m_win = NULL; }
...
void ScreenFadeTransition::update(Int frame) {
  ...
  if (frame < SCREENFADETRANSITION_START || frame > SCREENFADETRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE, ("ScreenFadeTransition::update - Frame is out of "
                              "the range the this update can handle %d",
                              frame));
    return;
  }
...
void ScreenFadeTransition::skip(void) { update(SCREENFADETRANSITION_END); }
...
void ControlBarArrowTransition::init(GameWindow *win) {
  ...
  m_fadePercent = 1.0f / (CONTROLBARARROWTRANSITION_END -
                          CONTROLBARARROWTRANSITION_BEGIN_FADE);

  m_arrowImage = TheControlBar->getArrowImage();
  GameWindow *twin = TheWindowManager->winGetWindowFromId(
  ...
  m_pos.x =
      (screenPos.x + screenSize.x / 2) - m_arrowImage->getImageWidth() / 2;
...
void ControlBarArrowTransition::update(Int frame) {
  m_drawState = -1;
  if (frame < CONTROLBARARROWTRANSITION_START ||
      frame > CONTROLBARARROWTRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE, ("ControlBarArrowTransition::update - Frame is "
                              "out of the range the this update can handle %d",
                              frame));
    return;
  }
...
void ControlBarArrowTransition::draw(void) {
  if (m_drawState < 0) return;
  if (m_drawState < CONTROLBARARROWTRANSITION_BEGIN_FADE) {
    Int yPos = m_pos.y + m_incrementPos.y * m_drawState;
    TheDisplay->drawImage(m_arrowImage, m_pos.x, yPos, m_pos.x + m_size.x,
                          yPos + m_size.y);

  } else {
    Int alpha = (1 - (m_fadePercent *
                      (m_drawState - CONTROLBARARROWTRANSITION_BEGIN_FADE))) *
                255;
    if (alpha > 255) alpha = 255;
    Int yPos =
        m_pos.y + m_incrementPos.y * (CONTROLBARARROWTRANSITION_BEGIN_FADE - 1);

    TheDisplay->drawImage(m_arrowImage, m_pos.x, yPos, m_pos.x + m_size.x,
                          yPos + m_size.y, GameMakeColor(255, 255, 255, alpha));
  }
}
...
FullFadeTransition::~FullFadeTransition(void) { m_win = NULL; }
...
void FullFadeTransition::update(Int frame) {
  ...
  if (frame < FULLFADETRANSITION_START || frame > FULLFADETRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE, ("FullFadeTransition::update - Frame is out of "
                              "the range the this update can handle %d",
                              frame));
    return;
  }
...
void FullFadeTransition::draw(void) {
  ...
  TheDisplay->drawFillRect(m_pos.x, m_pos.y, m_size.x, m_size.y,
                           GameMakeColor(0, 0, 0, alpha));
  TheDisplay->drawOpenRect(m_pos.x, m_pos.y, m_size.x, m_size.y, 1.0f,
                           GameMakeColor(255, 190, 0, alpha));
}

void FullFadeTransition::skip(void) { update(FULLFADETRANSITION_END); }
...
TextOnFrameTransition::~TextOnFrameTransition(void) { m_win = NULL; }
...
void TextOnFrameTransition::update(Int frame) {
  if (frame < TEXTONFRAMETRANSITION_START ||
      frame > TEXTONFRAMETRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE, ("TextOnFrameTransition::update - Frame is out of "
                              "the range the this update can handle %d",
                              frame));
    return;
  }
...
void TextOnFrameTransition::skip(void) {
  if (!m_isFinished) update(TEXTONFRAMETRANSITION_END);
}
...
ReverseSoundTransition::~ReverseSoundTransition(void) { m_win = NULL; }
...
void ReverseSoundTransition::update(Int frame) {
  if (frame < REVERSESOUNDTRANSITION_START ||
      frame > REVERSESOUNDTRANSITION_END) {
    DEBUG_ASSERTCRASH(FALSE, ("ReverseSoundTransition::update - Frame is out "
                              "of the range the this update can handle %d",
                              frame));
    return;
  }
...
void ReverseSoundTransition::skip(void) {
  if (!m_isFinished) update(REVERSESOUNDTRANSITION_END);
}
...
void PushButtonImageDrawThree(GameWindow *window, Int alpha) {
  ...
  if (centerWidth <= 0) {
    ...
    for (i = 0; i < pieces; i++) {
      ...
      TheDisplay->drawImage(centerImage, start.x, start.y, end.x, end.y, color);
