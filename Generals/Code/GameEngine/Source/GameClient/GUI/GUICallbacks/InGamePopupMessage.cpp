...
void InGamePopupMessageInit(WindowLayout *layout, void *userData) {
  ...
  pause = pMData->pause;
  if (pMData->pause) TheWindowManager->winSetModal(parent);
