...
void PopupCommunicatorInit(WindowLayout *layout, void *userData) {
  ...
  NameKeyType parentID =
      TheNameKeyGenerator->nameToKey("PopupCommunicator.wnd:PopupCommunicator");
  ...
  buttonOkID = TheNameKeyGenerator->nameToKey(
      AsciiString("PopupCommunicator.wnd:ButtonOk"));
...
//-------------------------------------------------------------------------------------------------
WindowMsgHandledType PopupCommunicatorSystem(GameWindow *window,
                                             UnsignedInt msg,
                                             WindowMsgData mData1,
                                             WindowMsgData mData2) {
  switch (msg) {
