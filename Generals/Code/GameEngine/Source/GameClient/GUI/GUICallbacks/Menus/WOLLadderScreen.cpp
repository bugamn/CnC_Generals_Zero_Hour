...
void WOLLadderScreenInit(WindowLayout *layout, void *userData) {
  ...
  parentWindowID = TheNameKeyGenerator->nameToKey(
      AsciiString("WOLLadderScreen.wnd:LadderParent"));
  buttonBackID = TheNameKeyGenerator->nameToKey(
      AsciiString("WOLLadderScreen.wnd:ButtonBack"));
  windowLadderID = TheNameKeyGenerator->nameToKey(
      AsciiString("WOLLadderScreen.wnd:WindowLadder"));
