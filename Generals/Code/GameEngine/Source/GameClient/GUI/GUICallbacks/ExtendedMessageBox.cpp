...
// /////////////////////////////////////////////////////////////////// Author:
// Matt Campbell, January 2003 Description: We go quiet in 1 day, gold in 15.
// Poor time to rewrite message boxes, so
...
WindowMsgHandledType ExtendedMessageBoxSystem(GameWindow *window,
                                              UnsignedInt msg,
...
//-------------------------------------------------------------------------------------------------
static GameWindow *gogoExMessageBox(
  ...
  GameWindow *parent = TheWindowManager->winCreateFromScript(
      AsciiString("Menus/MessageBox.wnd"));
  ...
  NameKeyType buttonOkID =
      TheNameKeyGenerator->nameToKey(AsciiString("MessageBox.wnd:ButtonOk"));
  GameWindow *buttonOk =
      TheWindowManager->winGetWindowFromId(parent, buttonOkID);
  buttonOk->winGetPosition(&buttonX[0], &buttonY[0]);

  NameKeyType buttonYesID =
      TheNameKeyGenerator->nameToKey(AsciiString("MessageBox.wnd:ButtonYes"));
  ...
  NameKeyType buttonNoID =
      TheNameKeyGenerator->nameToKey(AsciiString("MessageBox.wnd:ButtonNo"));
  GameWindow *buttonNo =
  ...
  NameKeyType buttonCancelID = TheNameKeyGenerator->nameToKey(
  ...
  NameKeyType staticTextTitleID = TheNameKeyGenerator->nameToKey(
      AsciiString("MessageBox.wnd:StaticTextTitle"));
  ...
  NameKeyType staticTextMessageID = TheNameKeyGenerator->nameToKey(
      AsciiString("MessageBox.wnd:StaticTextMessage"));
...
GameWindow *ExMessageBoxYesNo(UnicodeString titleString,
                              UnicodeString bodyString, void *userData,
                              MessageBoxFunc yesCallback,
                              MessageBoxFunc noCallback) {
  return gogoExMessageBox(-1, -1, -1, -1, MSG_BOX_NO | MSG_BOX_YES, titleString,
                          bodyString, userData, yesCallback, noCallback, NULL,
                          NULL);
}

GameWindow *ExMessageBoxYesNoCancel(UnicodeString titleString,
                                    UnicodeString bodyString, void *userData,
                                    MessageBoxFunc yesCallback,
                                    MessageBoxFunc noCallback,
                                    MessageBoxFunc cancelCallback) {
  return gogoExMessageBox(
      -1, -1, -1, -1, MSG_BOX_NO | MSG_BOX_YES | MSG_BOX_CANCEL, titleString,
      bodyString, userData, yesCallback, noCallback, NULL, cancelCallback);
}

GameWindow *ExMessageBoxOkCancel(UnicodeString titleString,
                                 UnicodeString bodyString, void *userData,
                                 MessageBoxFunc okCallback,
                                 MessageBoxFunc cancelCallback) {
  return gogoExMessageBox(-1, -1, -1, -1, MSG_BOX_OK | MSG_BOX_CANCEL,
                          titleString, bodyString, userData, NULL, NULL,
                          okCallback, cancelCallback);
}

GameWindow *ExMessageBoxOk(UnicodeString titleString, UnicodeString bodyString,
                           void *userData, MessageBoxFunc okCallback) {
  return gogoExMessageBox(-1, -1, -1, -1, MSG_BOX_OK, titleString, bodyString,
                          userData, NULL, NULL, okCallback, NULL);
}

GameWindow *ExMessageBoxCancel(UnicodeString titleString,
                               UnicodeString bodyString, void *userData,
                               MessageBoxFunc cancelCallback) {
  return gogoExMessageBox(-1, -1, -1, -1, MSG_BOX_CANCEL, titleString,
                          bodyString, userData, NULL, NULL, NULL,
                          cancelCallback);
}
  ...
  switch (msg) {
    ...
    case GBM_SELECTED: {
      ...
      static NameKeyType buttonCancelID = TheNameKeyGenerator->nameToKey(
          AsciiString("MessageBox.wnd:ButtonCancel"));
      WindowExMessageBoxData *MsgBoxCallbacks =
          (WindowExMessageBoxData *)window->winGetUserData();
      ...
      if (ret == MB_RETURN_CLOSE) TheWindowManager->winDestroy(window);
