...
void View::reset(void) {
  // Only fixing the reported bug.  Who knows what side effects resetting the
  // rest could have.
  m_zoomLimited = TRUE;
}
 ...
 */
void View::setAngle(Real angle) { m_angle = angle; }
...
//-------------------------------------------------------------------------------------------------
/** project the 4 corners of this view into the world and return each point as a
   parameter, the world points are at the requested Z */
//-------------------------------------------------------------------------------------------------
